...
const SECURITY_CONTEXT: SidebarInfoSubgroupTemplate = { // 2025-08-01
  text: "From Linux Primitives to Kubernetes Security Contexts",
  collapsible: true,
  icon: 'iconfont icon-k8s',
  subPath: 'security-contexts',
  children: [
    'README'
    // TODO: 페이지 생성
  ]
...
export const template: SidebarInfoTemplate = {
  name: 'learnkube.com',
  faviconPath: 'https://static.learnkube.com/f7e5160d4744cf05c46161170b5c11c9.svg',
  linksMap: new Map([
    [
    "java-spring", [
      "scaling-spring-boot-microservices", // 2019-11-15
