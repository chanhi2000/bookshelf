...
import { template as TEMPLATE_FRONTENDMASTER } from './blog.master.dev';
...
import { template as TEMPLATE_ODD_BIRD } from './oddbird.net';
...
import { template as TEMPLATE_WEB_DEV } from './web.dev';
...
export const articleSidebars = {
  ...
  oddBird:            (type: string = DEFAULT_KEY_ALL): SidebarGroupOptions => sidebarByTemplate(TEMPLATE_ODD_BIRD, type),
  ...
  webdev:             (type: string = DEFAULT_KEY_ALL): SidebarGroupOptions => sidebarByTemplate(TEMPLATE_WEB_DEV, type),
