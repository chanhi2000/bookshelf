...
This blog post details the technical innovations that went into making Docker containers run natively on Windows and attempts to explain the significance of the achievement. See the companion blog posts on [**how to build your first Windows container**](/docker.com/build-your-first-docker-windows-server-container.md) and the post detailing Docker Inc. and Microsoft’s commercial partnership to support Docker on Windows.
