...
Hjson gives you the freedom to use comments, ditch commas between properties, or create quoteless strings. Apart from the curly braces (`{}`), the [<FontIcon icon="fas fa-globe"/>Hjson syntax](https://hjson.github.io/syntax.html) look like a mix of [**YAML**](/realpython.com/python-yaml.md) and JSON.
