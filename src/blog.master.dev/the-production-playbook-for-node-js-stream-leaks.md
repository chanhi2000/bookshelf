...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/the-production-playbook-for-node-js-stream-leaks.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/9727
---
...
```component VPCard
{
  "title": "The Production Playbook for Node.js Stream Leaks",
  "desc": "Short story: `pipeline()` over `.pipe()` and destroy what you create.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/the-production-playbook-for-node-js-stream-leaks.html",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
