...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/mapping-with-leaflet.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/5055
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/mapping-with-leaflet/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/5055"/>
...
```component VPCard
{
  "title": "Mapping with Leaflet",
  "desc": "Leaflet.js is a free open-source mapping library. We'll look at how to use it to create a basic map with location points of cats up for adoption. ",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/mapping-with-leaflet.html",
  "logo": "https://blog.master.dev/favicon.ico",
