...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/lessons-learned-from-recreating-a-styled-dialog.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/5578
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/lessons-learned-from-recreating-a-styled-dialog/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/5578"/>
...
Welllll, the above isn’t strictly true anymore as I [<VPIcon icon="fas fa-globe"/>learned from Curtis Wilcoxin the comments](https://blog.master.dev/lessons-learned-from-recreating-a-styled-dialog#comment-25883). We can actually use the `popover` syntax to make a button in HTML alone that will open the dialog. That will (sadly) only open the dialog in the non-modal state, but at least it’s a toggle without JavaScript! The good news is that the Invoker Commands API is actually all over this. It’s used like this:
...
```component VPCard
{
  "title": "Lessons Learned from Recreating a Styled Dialog",
  "desc": "Sometimes pretty simple HTML elements have a lot of things to consider and take care of, from interactivity, styling, accessibility, and more.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/lessons-learned-from-recreating-a-styled-dialog.html",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
