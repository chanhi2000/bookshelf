...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/simple-typographic-email-template.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/4210
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/simple-typographic-email-template/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/4210"/>
...
![It looks like this](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/10/clean-html-email-762x1024.png?resize=762%2C1024&ssl=1)
...
![Here’s a selection of screenshots of this email rendering](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/10/Screenshot-2024-10-17-at-10.34.57%E2%80%AFAM.png?resize=869%2C1024&ssl=1)

Those all turned out pretty decent across the board so I’m happy with that. I tend to focus on the extemes.

![So like does Outlook 2007 on Windows look OK?](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/10/Screenshot-2024-10-17-at-10.36.44%E2%80%AFAM.png?resize=742%2C854&ssl=1)

It’s not amazing, but for a 17-year-old email client, I’m going to call that a win. Web Gmail is sort of the other extreme.

![It’s new, and web-based, but also has rendering challenges, so testing that in Firefox on Windows is a good test.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/10/Screenshot-2024-10-17-at-10.41.23%E2%80%AFAM.png?resize=732%2C1010&ssl=1)
...
![Here’s Dark Mode on Android](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/10/full-2-1.png?resize=289%2C1024&ssl=1)

I’ll call that a win.

You’ll find that the Frontend Masters newsletter rolls like this!

![With a red brand color as the links.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/10/Screenshot-2024-10-17-at-10.56.00%E2%80%AFAM.png?resize=861%2C1024&ssl=1)
...
![That looks fine in nice email clients like Apple Mail.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/10/Screenshot-2024-10-17-at-11.02.17%E2%80%AFAM.png?resize=820%2C948&ssl=1)

![But Outlook 2007 and even modern OL Office can’t deal with the layout.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/10/full-1-1.png?resize=1024%2C930&ssl=1)
...
![This is what I got though](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/10/Screenshot-2024-10-17-at-6.41.57%E2%80%AFAM.png?resize=725%2C1024&ssl=1)
...
```component VPCard
{
  "title": "An HTML Email Template with Basic Typography and Dark/Light Modes",
  "desc": "You can keep it chill and just use HTML email to apply a nice typeface, reign in the line length, use real links, and honor dark mode.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/simple-typographic-email-template.html",
  "logo": "https://blog.master.dev/favicon.ico",
