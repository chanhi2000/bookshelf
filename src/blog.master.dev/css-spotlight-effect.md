...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/css-spotlight-effect.html
prev: /programming/css/articles/README.md
date: 2025-05-26
isOriginal: false
author:
  - name: Amit Sheen
    url: https://blog.master.dev/author/amitsheen/
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/5939
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/css-spotlight-effect/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/5939"/>
...
![Start with a basic spotlight](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/ZNXB782.png?resize=320%2C321&ssl=1)

![Add a pattern using the`background-image`](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/Zqil84_4.png?resize=320%2C321&ssl=1)

![Set the`background-color`to white](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/3.png?resize=320%2C321&ssl=1)

![Apply the`filter`for the gooey effect](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/4.png?resize=320%2C321&ssl=1)

![Remove the white parts using`mix-blend-mode`](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/5.png?resize=320%2C321&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/AuEuovV8.png?resize=320%2C321&ssl=1)
...
```component VPCard
{
  "title": "CSS Spotlight Effect",
  "desc": "We can pass the mouse position from JavaScript to CSS and use it to make unusual and playful effects.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/css-spotlight-effect.html",
  "logo": "https://blog.master.dev/favicon.ico",
