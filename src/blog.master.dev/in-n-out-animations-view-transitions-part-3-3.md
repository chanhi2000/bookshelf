...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/in-n-out-animations-view-transitions-part-3-3.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/10088
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/in-n-out-animations-view-transitions-part-3-3/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/10088"/>
...
```component VPCard
{
  "title": "In-N-Out Animations: View Transitions (Part 3/3)",
  "desc": "View Transitions are of unique help in applying an animation to an element even when you are literally removing it from the DOM. ",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/in-n-out-animations-view-transitions-part-3-3.html",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
