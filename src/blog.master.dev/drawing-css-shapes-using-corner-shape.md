...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/drawing-css-shapes-using-corner-shape.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/6235
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/drawing-css-shapes-using-corner-shape/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/6235"/>

We recently got [<VPIcon icon="fas fa-globe"/>the new`shape()`function](https://blog.master.dev/tag/shape/) for`clip-path`which is a game changer for creating CSS shape. Another cool feature is on the way and will soon be available: `corner-shape`.
...
![A graphic displaying different CSS corner shapes: 'round', 'scoop', 'bevel', 'notch', and 'squircle', each in a purple background with white text.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/06/IqSM2bQw.png?resize=890%2C195&ssl=1)
...
![Diagram illustrating various 'superellipse()' values for corner shapes with labeled corners and arrows indicating direction. Shows how the corner shape changes with different K values.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/06/6tnTLi91.png?resize=777%2C501&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/06/ZeCHx_ws.png?resize=793%2C348&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/06/RtLO8vP1.png?resize=845%2C344&ssl=1)
...
![Five shapes with different corner styles labeled: round, scoop, bevel, notch, and squircle, all displayed on a purple background.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/06/q8rLnLOp.png?resize=905%2C200&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/06/6nJJ3x5a.png?resize=737%2C502&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/06/1rHsNa2J.png?resize=771%2C343&ssl=1)
...
```component VPCard
{
  "title": "Drawing CSS Shapes using corner-shape",
  "desc": "After you've got a `border-radius`, you can control the shape of the corner with `corner-shape`, which unlocks a simpler and more powerful way to make shapes compared to `clip-path()`.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/drawing-css-shapes-using-corner-shape.html",
  "logo": "https://blog.master.dev/favicon.ico",
