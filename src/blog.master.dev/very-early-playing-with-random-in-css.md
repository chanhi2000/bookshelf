...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/very-early-playing-with-random-in-css.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/6931
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/very-early-playing-with-random-in-css/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/6931"/>
...
![[This (<VPIcon icon="fa-brands fa-codepen"/>`chriscoyier`)](https://codepen.io/chriscoyier/pen/nKZdBo?editors=0110) compiled to over 200 lines of CSS.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/08/Screenshot-2025-08-25-at-2.28.37-PM.png?resize=1024%2C337&ssl=1)

But now it’s just like this:

![[Demo (<VPIcon icon="fa-brands fa-codepen"/>`chriscoyier`)](https://codepen.io/editor/chriscoyier/pen/0198d397-5bca-72e8-8249-adeea4529e14/1a093e1a90d947db85ef4fce6fa300da)](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/08/Screenshot-2025-08-25-at-2.29.19-PM.png?resize=1024%2C411&ssl=1)
...
```component VPCard
{
  "title": "Very Early Playing with random() in CSS",
  "desc": "(Only Safari Technical Preview!) Awfully cool `random()` is coming in CSS. The design possibilities are quite cool. ",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/very-early-playing-with-random-in-css.html",
  "logo": "https://blog.master.dev/favicon.ico",
