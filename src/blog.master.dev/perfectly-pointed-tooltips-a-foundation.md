...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/perfectly-pointed-tooltips-a-foundation.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/7514
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/perfectly-pointed-tooltips-a-foundation/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/7514"/>
...
Here is a demo taken from another [**article**](/blog.master.dev/custom-range-slider-using-anchor-positioning-scroll-driven-animations.md) where the anchor is the thumb of a slider and the tooltip is an `<output>` element:
...
![I’ve created [**an interactive demo**](/css-tip.com/position-area.md) if you want to explore all the different values and understand how alignment works in the context of Anchor Positioning.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/10/1hmIC9A1.png?resize=833%2C622&ssl=1)
...
![A three-part interactive demo showing a tooltip following an anchor element as it is dragged. The tooltip displays the message 'Drag the anchor and I should follow...' with an anchor icon below.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/10/SW5hUi3K.png?resize=1024%2C228&ssl=1)
...
![Three tooltip examples illustrating text that says 'Drag the anchor and I should follow...' with an anchor icon, showcasing dynamic positioning.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/10/aAotEaeC.png?resize=940%2C230&ssl=1)
...
```component VPCard
{
  "title": "Perfectly Pointed Tooltips: A Foundation",
  "desc": "The Anchor Positioning API in CSS is very powerful. This is the beginning of a series where we understand it through the perfect use-case: tooltips.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/perfectly-pointed-tooltips-a-foundation.html",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
