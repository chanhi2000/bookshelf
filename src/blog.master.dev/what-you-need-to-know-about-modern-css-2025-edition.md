...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/what-you-need-to-know-about-modern-css-2025-edition.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/6948
---
...
A `popover` is an attribute you can put on any HTML element that essentially gives it open/close functionality. It will then have JavaScript APIs for opening and closing it. It’s [**similar-but-different to modals**](/blog.master.dev/whats-the-difference-between-htmls-dialog-element-and-popovers.md). Think of them more in the tooltip category, or something that you might want more than one of open sometimes.
...
[<VPIcon icon="fa-brands fa-chrome"/>First you opt-in](https://developer.chrome.com/blog/rfc-customizable-select) then you [**go nuts**](/blog.master.dev/custom-select-that-comes-up-from-the-bottom-on-mobile.md).
...
- The CSS function `random()` is in Safari [**and it’s amazing**](/blog.master.dev/very-early-playing-with-random-in-css.md).
...
- [**Container queries**](/blog.master.dev/what-you-need-to-know-about-modern-css-spring-2024-edition.md#conatiner-queries-size) (and units) are still relatively new and the best thing since media queries in CSS.
- The **[`:has()` pseudo-class**](/blog.master.dev/what-you-need-to-know-about-modern-css-spring-2024-edition.md#the-has-pseudo-selector) is wildly useful for selecting elements where the children exist or are in a particular state.
- Ultra cool modern CSS features like [**View Transitions**](/blog.master.dev/what-you-need-to-know-about-modern-css-spring-2024-edition.md#view-transitions), [**Anchor Positioning**](/blog.master.dev/what-you-need-to-know-about-modern-css-spring-2024-edition.md#anchor-positioning), and [**Scroll-Driven Animations**](/blog.master.dev/what-you-need-to-know-about-modern-css-spring-2024-edition.md#scroll-driven-animations) have all made it to Safari.
...
```component VPCard
{
  "title": "What You Need to Know about Modern CSS (2025 Edition)",
  "desc": "If you thought 2024 was packed with amazing new CSS, well, you're right. But so is 2025 and it keeps looking bright. Check out our list of the best stuff with easy-to-reference examples.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/what-you-need-to-know-about-modern-css-2025-edition.html",
  "logo": "https://blog.master.dev/favicon.ico",
