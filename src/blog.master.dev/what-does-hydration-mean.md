...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/what-does-hydration-mean.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/3769
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/what-does-hydration-mean/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/3769"/>
...
![Screenshot of view source of the SSR React example where the content is properly in the HTML.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/09/CleanShot-2024-09-09-at-06.57.52%402x.png?resize=1024%2C333&ssl=1)
...
If you don’t need any interactivity at all, no. Personally, I like the component model of building sites with JavaScript-based components even if it’s largely just static content. [<VPIcon icon="fas fa-globe"/>Astro](https://astro.build/) excels at that ([<VPIcon icon="fas fa-globe"/>here’s a course](https://master.dev/courses/astro/)), but other frameworks can be configured to not output any JavaScript (thus skipping any hydration process).
...
```component VPCard
{
  "title": "What Does Hydration Mean?",
  "desc": "Hydration refers to JavaScript frameworks making server-side rendered HTML interactive. ",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/what-does-hydration-mean.html",
  "logo": "https://blog.master.dev/favicon.ico",
