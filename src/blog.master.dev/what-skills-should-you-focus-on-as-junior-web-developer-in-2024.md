...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/what-skills-should-you-focus-on-as-junior-web-developer-in-2024.html
prev: /projects/career/articles/README.md
date: 2024-08-26
isOriginal: false
author: Frontend Masters Staff
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/3235
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/what-skills-should-you-focus-on-as-junior-web-developer-in-2024/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/3235"/>
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/08/juniors.png?resize=1024%2C683&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/08/browsers-complex.png?resize=1012%2C1024&ssl=1)
...
Learning what the browser is doing and how to work with it is immensely useful. Your main tool in this endeavor is that browsers DevTools. [DevTools are very worth learning.](https://master.dev/courses/dev-tools/) DevTools allow you to do all sorts of inspection and analysis on a website like:
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/08/Screenshot-2024-08-19-at-8.19.45%E2%80%AFAM.png?resize=1024%2C440&ssl=1)
...
[Complete Intro to Web Development](https://master.dev/courses/web-development-v3/) is free and covers all of this in one course.
...
Layout might be the most important single thing you can learn in CSS, and thanks to grid layout, you’ve got a great tool for it at your fingertips. As [<VPIcon icon="fas fa-globe"/>Miriam Suzanne says](https://blog.master.dev/wp-admin/post.php?post=3235&action=edit), more advanced CSS features can wait, *[learn grid now](https://master.dev/courses/css-grid/)*. Setting up a basic page layout is honestly quite satisfying:
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/08/side-by-side.png?resize=1024%2C232&ssl=1)
...
Even if you learn and use a framework that abstracts aways CSS into HTML like [<VPIcon icon="iconfont icon-tailwindcss"/>Tailwind](https://tailwindcss.com/) (which is probably a smart choice particularly if you’re job hunting — [here’s a course](https://master.dev/courses/tailwind-css/)), the styles are ultimately applied with CSS and so knowing it behooves you.
...
If you’re into web *design*, we’d recommend still being somewhat familiar with JavaScript, and [**here’s our recommendations**](/blog.master.dev/5-things-designers-can-do-with-javascript.md) on what to learn that will serve you sell.

If you find yourself clicking with JavaScript, focusing on it isn’t a bad idea. We have lots of great courses on JavaScript, like a free course on [<VPIcon icon="fas fa-globe"/>getting started with JavaScript](https://master.dev/courses/getting-started-javascript-v2/).

::: info

We have a fantastic learning path covering all the [<VPIcon icon="fas fa-globe"/>essentials of web development](https://master.dev/learn/beginner/) or even a full path to [<VPIcon icon="fas fa-globe"/>become a JavaScript master](https://master.dev/learn/javascript/) if video courses are your thing!
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/08/full-stack.jpg?resize=1024%2C571&ssl=1)

### The job can be a more than half learning conventions

Say you’re a new web developer on the job, and you’re given a ticket to have a button open an informational popup for users to read for extra information. You have a solid grasp of the fundamentals, so you make a Pull Request where you implement this [**as a popover**](/blog.master.dev/popover-api-is-here.md) (e.g. `<div id="extra-information" popover>Extra information.</div>`).
...
1. [<VPIcon icon="iconfont icon-nextjs"/>Next.js](https://nextjs.org/) (React) — [React Learning Path](https://master.dev/learn/react/)
2. [<VPIcon icon="iconfont icon-nuxtjs"/>Nuxt](https://nuxt.com/) (Vue) — [Vue Learning Path](https://master.dev/learn/vue/)
3. [<VPIcon icon="iconfont icon-astro"/>Astro](https://astro.build/) (Multi-framework capable) — [Astro Course](https://master.dev/courses/astro/)
...
- [TypeScript](https://master.dev/learn/typescript/) augments [JavaScript](https://master.dev/learn/javascript/) — [TypeScript Learning Path](https://master.dev/learn/typescript/)
...
There are tools that… help run tools! If you’re using a framework, it’s common that a variety of tooling is already built in. For example Nuxt and Astro run [Vite](https://vitejs.dev/) under the hood, which does all sorts of things like running a server, processing TypeScript, and bundling. Vite is great and [worth learning](https://master.dev/courses/vite/).
...
You could build [<VPIcon icon="fas fa-globe"/>a personal portfolio website](https://master.dev/courses/portfolio-website/) for this. Hosting doesn’t have to be hard or expensive, [**we have a simple guide**](/blog.master.dev/exactly-how-to-deploy-local-files-to-make-a-live-website.md). Leveling up, Jem’s course can walk you through [<VPIcon icon="fas fa-globe"/>setting up your own server from scratch](https://master.dev/courses/fullstack-v3/)

![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/08/build-portfolio.png?resize=1024%2C798&ssl=1)
...
And if you have a Frontend Masters membership, we have a Discord (look under the [<VPIcon icon="fas fa-globe"/>Apps](https://master.dev/my-account/apps/) section of your account for access)

![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/08/people.png?resize=1024%2C345&ssl=1)
...
We’ve been pointing to Frontend Masters courses here a lot, but can you blame us? It’s part of the journey. Our [Beginner Learning Path](https://master.dev/learn/beginner/) is nearly 40 hours, so that’ll keep you busy. It’s literally designed to make you career-ready. And beyond technical skills, we also have a completely free course on [Getting a Developer Job, v3](https://master.dev/courses/getting-a-job-v3/) when you feel like it’s time to hunt for a job!
...
```component VPCard
{
  "title": "What Skills Should You Focus on as Junior Web Developer in 2024?",
  "desc": "These are our recommendations for those of you early in your web developer journey. This is about tech and the real world stuff around it that you'll need.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/what-skills-should-you-focus-on-as-junior-web-developer-in-2024.html",
  "logo": "https://blog.master.dev/favicon.ico",
