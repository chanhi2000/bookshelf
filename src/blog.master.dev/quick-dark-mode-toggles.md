...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/quick-dark-mode-toggles.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/6826
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/quick-dark-mode-toggles/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/6826"/>
...
![Screenshot of Chrome DevTools showing the 'Rendering' tab with options for emulating CSS media feature prefers-color-scheme.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/08/Screenshot-2025-08-21-at-1.16.56-PM.png?resize=1024%2C931&ssl=1)
...
![Screenshot of Chrome DevTools Command Palette with options for emulating CSS prefers-color-scheme.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/08/Screenshot-2025-08-21-at-1.18.01-PM.png?resize=1024%2C530&ssl=1)

Or, use the little paintbrush icon under the **Elements** tab then in the **Styles** section.

![Screenshot of a browser's DevTools showing the Styles panel, with options to toggle between light and dark color schemes.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/08/Screenshot-2025-08-22-at-7.31.51-AM.png?resize=1024%2C410&ssl=1)
...
![Screenshot of a coding environment showing the Chrome DevTools interface with the Console and Rendering tabs open, highlighting options for enabling automatic dark mode and simulating CSS media features.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/08/Screenshot-2025-08-21-at-1.26.22-PM.png?resize=1024%2C612&ssl=1)
...
![Screenshot of Chrome DevTools, showing the Inspector panel with options for toggling dark color scheme simulation for web pages.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/08/Screenshot-2025-08-22-at-7.35.52-AM.png?resize=1024%2C217&ssl=1)
...
![A screenshot of browser developer tools displaying the appearance settings, specifically the color scheme set to dark, under the Elements tab.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/08/CleanShot-2025-08-22-at-07.42.46%402x.png?resize=1024%2C323&ssl=1)
...
![A user interface displaying color mode options for appearance settings, including Light, Dark, and Auto modes.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/08/Screenshot-2025-08-21-at-1.23.38-PM.png?resize=920%2C306&ssl=1)
...
```component VPCard
{
  "title": "Quick Dark Mode Toggles",
  "desc": "All the browsers DevTools have a way of emulating color modes. The are essentially faking the system preference at the application level. Here's where those controls are located and another nice tool. ",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/quick-dark-mode-toggles.html",
  "logo": "https://blog.master.dev/favicon.ico",
