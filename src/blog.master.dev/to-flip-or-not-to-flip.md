...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/to-flip-or-not-to-flip.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/5890
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/to-flip-or-not-to-flip/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/5890"/>
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/Screenshot-2025-05-16-at-7.52.17%E2%80%AFAM.png?resize=1024%2C888&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/Screenshot-2025-05-16-at-7.51.41%E2%80%AFAM.png?resize=1024%2C896&ssl=1)
...
But let’s say you’re *me* (perfect, handsome) and you’ve changed your muscle memory for writing a lot of CSS properties to using [<VPIcon icon="fas fa-globe"/>logical properties](https://master.dev/courses/pro-css/css-reset/?t=460). That is, stuff like `padding-inline-start` instead of `padding-left`, and the like. That, plus using layout like flexbox and grid, will reflow naturally with direction changes. So if you change the direction to `rtl` on *my* site, you get:

![The whole layout flips.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/Screenshot-2025-05-16-at-8.04.20%E2%80%AFAM.png?resize=1024%2C884&ssl=1)
...
```component VPCard
{
  "title": "Is there a Correct Answer? Flipping Layouts When Google Translate Swaps between a Left-to-Right Language and a Right-to-Left Language",
  "desc": "Google Translate doesn't change the `dir` of a site when translating from LTR to RTL... but you could.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/to-flip-or-not-to-flip.html",
  "logo": "https://blog.master.dev/favicon.ico",
