...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/css-counters-in-action.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/7347
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/css-counters-in-action/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/7347"/>
...
![CSS Counters working](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/10/img1.png?resize=284%2C478&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/10/img2.png?resize=554%2C400&ssl=1)
...
![Code snippet of a JavaScript function named readBooks that processes a variable string to manage pagination and filtering for a list of books.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/10/img3.png?resize=1024%2C346&ssl=1)
...
![A visual representation of numbered lines in a code-like format, displaying CSS counters with line numbers I, II, III, and IV next to text lines.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/10/img4.png?resize=294%2C484&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/10/img5.png?resize=444%2C566&ssl=1)
...
```component VPCard
{
  "title": "CSS Counters in Action",
  "desc": "CSS has counter variables (based on matching selectors) that you can output as formatted content or use in calculations. ",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/css-counters-in-action.html",
  "logo": "https://blog.master.dev/favicon.ico",
