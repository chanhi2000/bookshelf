...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/view-transition-list-reordering-with-a-kick-flip.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/6471
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/view-transition-list-reordering-with-a-kick-flip/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/6471"/>
...
```component VPCard
{
  "title": "View Transition List Reordering (with a Kick Flip)",
  "desc": "It's pretty straightforward to animate list items into new positions, but there is a few tricks when the specific one you've chosen to move needs a *different* transition.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/view-transition-list-reordering-with-a-kick-flip.html",
  "logo": "https://blog.master.dev/favicon.ico",
