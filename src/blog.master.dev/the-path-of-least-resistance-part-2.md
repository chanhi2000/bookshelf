...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/the-path-of-least-resistance-part-2.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/6976
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/the-path-of-least-resistance-part-2/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/6976"/>
...
```component VPCard
{
  ...
  "link": "/blog.master.dev/the-path-of-least-resistance-part-1.md",
  "logo": "https://blog.master.dev/favicon.ico",
...
```component VPCard
{
  "title": "The `-path` of Least Resistance (Part 2)",
  "desc": "This time we're looking at offset-path (and friends), which can be used to create movement when animated and benefits from all the same fancy functions that we learned about with clip-path.",
  "link": "/blog.master.dev/the-path-of-least-resistance-part-2.md",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
...
![Illustration of a motion path with labeled starting point, end point, and a movement command to a specific coordinate.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/08/s_C4C4BD9B38FE52C7864331594FF600266A96201CECDAB37CFEF7ECCC3653405A_1756058683788_image.webp?resize=910%2C610&ssl=1)
...
```component VPCard
{
  "title": "The `-path` of Least Resistance (Part 2)",
  "desc": "This time we're looking at offset-path (and friends), which can be used to create movement when animated and benefits from all the same fancy functions that we learned about with clip-path.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/the-path-of-least-resistance-part-2.html",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
