...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/introducing-fly-io.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/4742
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/introducing-fly-io/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/4742"/>
...
If you’d like to go deeper on Docker, our course [<VPIcon icon="fas fa-globe"/>Complete Intro to Containers](https://master.dev/courses/complete-intro-containers-v2/) from Brian Holt is fantastic.
...
![screenshot of a running Next.js app](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/12/img-1-next-app.png?resize=1024%2C764&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/12/img-2-fly-launch-initial.png?resize=1024%2C419&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/12/img-3-default-settings.png?resize=1024%2C751&ssl=1)

For fun, let’s switch to the cheapest option, and change the region to Virginia (what AWS would call us-east-1).

![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/12/img-4-updated-settings.png?resize=1024%2C751&ssl=1)

Hit confirm, and return to your command line. It should finish setting everything up, which should look like this, in part.

![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/12/img-5-cli-finish.png?resize=1024%2C454&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/12/img-6-fly-dashboard.png?resize=1024%2C349&ssl=1)

We can then click that app and see the app’s details

![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/12/img-7-app-in-dashboard.png?resize=1024%2C1018&ssl=1)

And lastly, we can go to the URL listed, and see the app actually running!

![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/12/img-8-app-running.png?resize=1024%2C866&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/12/img-10-fly-pg-created.png?resize=1024%2C381&ssl=1)

![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/12/img-9-fly-postgres-create.png?resize=1024%2C299&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/12/img-11-fly-proxy.png?resize=902%2C122&ssl=1)
...
This post started brushing up against some full-stack topics. If this sparked your interest, be sure to check out the[<VPIcon icon="fas fa-globe"/>entire courseon full-stack engineering](https://master.dev/courses/fullstack-v3/) here on Frontend Masters.
...
```component VPCard
{
  "title": "Introducing Fly.io",
  "desc": "If it can go in a Docker, Fly can host it, and they'll help you with that. Adam Rackis takes a look at the platform and shows off all the things he likes about it.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/introducing-fly-io.html",
  "logo": "https://blog.master.dev/favicon.ico",
