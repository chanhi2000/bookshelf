...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/the-two-button-problem.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/7422
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/the-two-button-problem/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/7422"/>
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/10/IMG_6368.jpeg?resize=768%2C1024&ssl=1)
...
![([<VPIcon icon="fas fa-globe"/>via](https://subiscanoajsdblearning.z13.web.core.windows.net/which-one-is-different-worksheet.html))](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/10/joinPdf_3f0300690d09f12d1940b2475ca2d8d3_page-0069.jpg?resize=791%2C1024&ssl=1)

Ideally, though, we don’t have to think very hard. It should be obvious which one is active.

Again, the problem:

![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/10/Screenshot-2025-10-21-at-1.30.22-PM.png?resize=970%2C462&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/10/Screenshot-2025-10-21-at-3.40.56-PM.png?resize=1024%2C526&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/10/Screenshot-2025-10-21-at-3.43.43-PM.png?resize=1024%2C462&ssl=1)
...
[**We’ve got a recent post on @media queries**](/blog.master.dev/learn-media-queries.md) that goes into lots of situations like this!

This “two button” problem also can come up in the design pattern of “toggles”. Take something like this:

![A “pill” toggle design pattern.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/10/Screenshot-2025-10-21-at-3.49.02-PM.png?resize=714%2C276&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/10/Screenshot-2025-10-21-at-3.52.05-PM.png?resize=738%2C278&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/10/Screenshot-2025-10-21-at-4.06.07-PM.png?resize=772%2C296&ssl=1)
...
```component VPCard
{
  "title": "The Two Button Problem",
  "desc": "When you've got two buttons with two different looks (and no cursor), how do you know which one you're about to activate? You'll need to be careful with the design.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/the-two-button-problem.html",
  "logo": "https://blog.master.dev/favicon.ico",
