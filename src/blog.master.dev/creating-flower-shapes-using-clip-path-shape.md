...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/creating-flower-shapes-using-clip-path-shape.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/5824
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/creating-flower-shapes-using-clip-path-shape/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/5824"/>
...
In[**a previous article**](/blog.master.dev/creating-flower-shapes-using-css-mask-trigonometric-functions.md), we used modern CSS features such as `mask`, trigonometric functions, and CSS variables to create flower-like shapes.
...
```component VPCard
{
  "title": "Creating Flower Shapes using clip-path: shape()",
  "desc": "Use the `arc` command within the `shape()` function we can draw a line that follows a circle from one point to the next, controlling the direction.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/creating-flower-shapes-using-clip-path-shape.html",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
