...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/architecture-through-component-colocation.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/6712
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/architecture-through-component-colocation/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/6712"/>
...
![This is an example of how I’d like to structure a website](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/08/Screenshot-2025-08-09-at-1.19.58-PM.png?resize=488%2C462&ssl=1)
...
![So like this](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/08/Screenshot-2025-08-09-at-10.59.43-AM.png?resize=480%2C546&ssl=1)
...
**Good news:** JavaScript has an answer to that question we just asked, and it’s called [**CSS Module Scripts**](/web.dev/css-module-scripts.md).
...
```component VPCard
{
  "title": "A Nice Vanilla App Archicture Using Web Components and CSS Module Scripts",
  "desc": "CSS module scripts help keep the dream of co-locating files that all relate to a component, without needing a bundler. ",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/architecture-through-component-colocation.html",
  "logo": "https://blog.master.dev/favicon.ico",
