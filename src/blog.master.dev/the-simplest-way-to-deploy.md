...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/the-simplest-way-to-deploy.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/5784
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/the-simplest-way-to-deploy/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/5784"/>

Let’s say you’ve got a set of static files (HTML, CSS, JavaScript, images, etc) that build your website. Perhaps it’s your portfolio website, thanks to having taken Jen Kramer’s course [<VPIcon icon="fas fa-globe"/>Web Development Project: Personal Portfolio Website](https://master.dev/courses/portfolio-website/), for example, but it could be anything.

![A file directory labeled 'portfolio' showing three files: <VPIcon icon="fa-brands fa-html5"/>`index.html`, <VPIcon icon="fa-brands fa-js"/>`script.js`, and <VPIcon icon="fa-brands fa-css3-alt"/>`style.css`, with their sizes and types displayed.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/Screenshot-2025-05-20-at-2.46.02%E2%80%AFPM.png?resize=1024%2C622&ssl=1)

Hey, what do you know, I’ve got some static files that make a nice personal portfolio page right here.

We’ve covered [**the very fastest way**](/blog.master.dev/exactly-how-to-deploy-local-files-to-make-a-live-website.md) to get those files turned into a deployed website on the internet already, using [<VPIcon icon="fas fa-globe"/>Netlify’s tool](https://app.netlify.com/drop). That totally works, but we can take things a little further to make things easier on our future selves.
...
```component VPCard
{
  ...
  "link": "/blog.master.dev/exactly-how-to-deploy-local-files-to-make-a-live-website.md",
  "logo": "https://blog.master.dev/favicon.ico",
...
```component VPCard
{
  "title": "The Simplest Way to Deploy Your Own Updatable Portfolio Site",
  "desc": "For the true beginners out there! We'll put the files in a GitHub repo and connect it to Netlify to host it.",
  "link": "/blog.master.dev/the-simplest-way-to-deploy.md",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/blog.master.dev/deploy-a-site-with-a-build-process-a-custom-domain-name.md",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
...
![GitHub sign-up page showing fields for email, password, username, country/region, and email preferences, with a dark background and cartoonish character icons.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/Screenshot-2025-05-26-at-10.15.42%E2%80%AFAM.png?resize=1024%2C725&ssl=1)
...
We’re baby-steppin’ here, and I think it will be easier for us to use [<VPIcon icon="iconfont icon-github"/>the official GitHub app](https://github.com/apps/desktop) than it will be to use what developers call “the command line” to work with Git (but [<VPIcon icon="fas fa-globe"/>someday you can level up](https://master.dev/courses/everything-git/)).

![Screenshot of the GitHub Desktop application showcasing the interface with an emphasis on simplifying the Git workflow.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/Screenshot-2025-05-26-at-10.17.15%E2%80%AFAM.png?resize=1024%2C968&ssl=1)

It’s free.

Honestly, I’ve been using Git for a hot long while and I still use GUI apps like this ([**literally this**](/blog.master.dev/tower-vs-github-desktop.md)) to work with Git as I prefer the visual nature of it. This is true of many of the talented developers I work with, who are are very capable of command line usage as well.
...
![Screenshot of the GitHub interface for creating a new repository, featuring fields for repository name, description, and options for initializing and licensing.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/Screenshot-2025-05-26-at-10.21.12%E2%80%AFAM.png?resize=833%2C1024&ssl=1)
...
![Screenshot of a GitHub repository page showcasing the options for setting up the repository in GitHub Desktop.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/CleanShot-2025-05-26-at-10.24.09%402x.png?resize=1024%2C972&ssl=1)

![Screenshot of the GitHub Desktop app showing the 'Clone a Repository' dialog, with fields for the repository URL and local path.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/Screenshot-2025-05-26-at-10.24.41%E2%80%AFAM.png?resize=1024%2C672&ssl=1)
...
![Screenshot of the GitHub Desktop application showing the first commit in a repository named 'my-portfolio', with a list of changed files including index.html, script.js, and style.css.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/Screenshot-2025-05-26-at-10.30.54%E2%80%AFAM.png?resize=1024%2C737&ssl=1)

After you’ve done that, you’ll see the files you “pushed” up right on GitHub.com in your repo URL:

![Screenshot of a GitHub repository showing a personal portfolio project with files including index.html, script.js, and style.css, along with commit history and repository details.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/Screenshot-2025-05-26-at-10.32.40%E2%80%AFAM.png?resize=1024%2C832&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/Screenshot-2025-05-28-at-6.47.16%E2%80%AFAM.png?resize=658%2C770&ssl=1)

![Then select GitHub as that’s where our project lives.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/Screenshot-2025-05-28-at-6.48.28%E2%80%AFAM-1.png?resize=1024%2C322&ssl=1)

![You may need to grant Netlify permissions on GitHub](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/Screenshot-2025-05-28-at-6.50.18%E2%80%AFAM.png?resize=643%2C1024&ssl=1)

![Once Netlify is authorized, you’ll see a list of your repos. Find the porfolio one we’re working with and click it](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/Screenshot-2025-05-28-at-6.50.44%E2%80%AFAM.png?resize=1024%2C433&ssl=1)
...
![Maybe a few minutes at worst.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/Screenshot-2025-05-28-at-7.02.23%E2%80%AFAM.png?resize=1024%2C681&ssl=1)

![Then it will be live!](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/Screenshot-2025-05-28-at-7.12.56%E2%80%AFAM.png?resize=966%2C804&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/Screenshot-2025-05-28-at-7.15.25%E2%80%AFAM.png?resize=1024%2C676&ssl=1)
...
![Screenshot of a GitHub Desktop interface showing changes in HTML and CSS files, highlighting modifications to the text 'Frontend Developer' to 'Front-End Dev' with a commit message field.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/Screenshot-2025-05-28-at-7.24.26%E2%80%AFAM.png?resize=1024%2C737&ssl=1)

![Screenshot of a portfolio website featuring the text 'Hi, I'm Chris Front-End Dev' with a pink button labeled 'Contact' and navigation links.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/Screenshot-2025-05-28-at-7.26.58%E2%80%AFAM.png?resize=1024%2C662&ssl=1)
...
```component VPCard
{
  "title": "The Simplest Way to Deploy Your Own Updatable Portfolio Site",
  "desc": "For the true beginners out there! We'll put the files in a GitHub repo and connect it to Netlify to host it.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/the-simplest-way-to-deploy.html",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
