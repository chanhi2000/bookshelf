...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/writing-to-the-clipboard-in-javascript.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/3629
---
...
<div class="example">
  <p>
    ...
    <a href="https://blog.master.dev/">Master.dev blog</a>
  </p>
</div>
```
...
```component VPCard
{
  "title": "Writing to the Clipboard in JavaScript",
  "desc": "The most basic use case, writing a bit of text to the user's clipboard, is mercifully easy. But there is plenty more to know. Did you know writing image data to the clipboard ONLY works with PNG?",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/writing-to-the-clipboard-in-javascript.html",
  "logo": "https://blog.master.dev/favicon.ico",
