...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/building-a-blog-in-tanstack-part-2-of-2.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/9365
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/building-a-blog-in-tanstack-part-2-of-2/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/9365"/>
...
```component VPCard
{
  "title": "Building a Blog in TanStack (Part 2 of 2)",
  "desc": "A blog is a perfect use case for pre-rendering, so that the static build files can render all on their own. TanStack Start can even help with the server functions via middleware.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/building-a-blog-in-tanstack-part-2-of-2.html",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
