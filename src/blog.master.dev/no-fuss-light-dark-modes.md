...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/no-fuss-light-dark-modes.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/4412
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/no-fuss-light-dark-modes/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/4412"/>
...
(Or whatever is controlling what `prefers-color-scheme` is returning in your browser. I use the browser Arc sometimes and it’s Light/Dark modes override what is set in my System Preferences. It [**can get confusing**](/blog.master.dev/why-is-this-thing-in-dark-mode.md).)
...
I kinda like approach of just changing same-named `--custom-properties` myself, but there are alternatives. For instance you could use named colors (e.g. `--my-gray-8`) then use the [**now well-supported `light-dark()` function**](/blog.master.dev/dark-and-light.md) to do something like:
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/11/IMG_0320.jpg?resize=1024%2C813&ssl=1)
...
```component VPCard
{
  "title": "No Fuss Light/Dark Modes",
  "desc": "One approach to color modes it to do it all in CSS with prefers-color-scheme media queries and/or the light-dark() function. A user toggle can be a future improvement.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/no-fuss-light-dark-modes.html",
  "logo": "https://blog.master.dev/favicon.ico",
