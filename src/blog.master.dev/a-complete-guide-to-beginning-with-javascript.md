...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/a-complete-guide-to-beginning-with-javascript.html
prev: /programming/js/articles/README.md
date: 2024-09-04
isOriginal: false
author: Cody Lindley
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/3539
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/a-complete-guide-to-beginning-with-javascript/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/3539"/>
...
- A basic understanding of the [<VPIcon icon="fas fa-globe"/>internet](https://internetfundamentals.com/), web browsers, [<VPIcon icon="fas fa-globe"/>HTML](https://master.dev/bootcamp/introduction-html/) (i.e. web pages), and [<VPIcon icon="fas fa-globe"/>CSS](https://master.dev/bootcamp/introduction-css/).
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/09/javascript-serve-node.png?resize=754%2C273&ssl=1)

Running the command will start the Node.js application and server the results to a browser view (i.e., “Hello World”).

![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/09/javascript-node-helloworld.png?resize=678%2C261&ssl=1)
...
- A JavaScript runtime (e.g., [<VPIcon icon="fas fa-globe"/>web pages](https://master.dev/bootcamp/introduction-html/), [<VPIcon icon="fas fa-globe"/>JSFiddle](https://jsfiddle.net/), or [<VPIcon icon="fas fa-globe"/>Node.js](https://master.dev/courses/node-js-v2/))
...
- [Learn JavaScript](https://master.dev/bootcamp/introduction-javascript/) \[free\]
- [Getting Started with JavaScript, v2](https://master.dev/courses/getting-started-javascript-v2/) \[free\]
- [Complete JavaScript Learning Path](https://master.dev/learn/javascript/) \[$\]
  - [JavaScript: From First Steps to Professional](https://master.dev/courses/javascript-first-steps/) \[$\]
  - [JavaScript: The Hard Parts](https://master.dev/courses/javascript-hard-parts-v2/) \[$\]
  - [Deep JavaScript Foundations, v3](https://master.dev/courses/deep-javascript-v3/) \[$\]
  - [JavaScript: The Recent Parts](https://master.dev/courses/js-recent-parts/) \[$\]
...
- Video Course: [The Hard Parts of Object Oriented JavaScript](https://master.dev/courses/object-oriented-js/) \[$\]
- Reading Material: [The Principles of Object-Oriented JavaScript 1st Edition](https://nostarch.com/oojs) \[$\]

#### Functional Programming with JavaScript

- Video Course: [Functional JavaScript First Steps](https://master.dev/courses/functional-first-steps/) \[$\]
- [The Hard Parts of Functional JavaScript](https://master.dev/courses/functional-js-fundamentals/) \[$\]

#### JavaScript Async/Promises

- Video Course: [JavaScript: The New Hard Parts](https://master.dev/courses/javascript-new-hard-parts/) \[$\]
...
- [Chapter 9 : Using ES2015 Modules Today](https://master.dev/guides/javascript-enlightenment/#9) \[free\]
- [Chapter 10 : Writing ES2015 Module Syntax](https://master.dev/guides/javascript-enlightenment/#10) \[free\] 
...
Make sure to checkout the [learning path on JavaScript](https://master.dev/learn/javascript/) if you’re interested in learning JavaScript in the browser, or the [learning path on Node.js](https://master.dev/learn/node-js/) if you want to use JavaScript on the server.
...
```component VPCard
{
  "title": "A Complete Guide to Beginning with JavaScript",
  "desc": "This guide serves as an introduction to learning JavaScript, covering necessary prerequisite knowledge and addressing common obstacles. It highlights JavaScript’s origins, essential concepts, and practical applications across different environments.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/a-complete-guide-to-beginning-with-javascript.html",
  "logo": "https://blog.master.dev/favicon.ico",
