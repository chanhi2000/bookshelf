...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/drizzle-database-migrations.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/4692
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/drizzle-database-migrations/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/4692"/>
...
Wanna see more real-world use cases of Drizzle in action? Check out Scott Moss’ course [<VPIcon icon="fas fa-globe"/>Intermediate Next.js](https://master.dev/courses/intermediate-next-js/) which uses it and gets into it when the project gets into data fetching needs.
...
![Drizzle pull](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/12/drizzle-pull.png?resize=1024%2C438&ssl=1)
...
![Drizzle pull again](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/12/drizzle-pull-2-2.png?resize=1024%2C536&ssl=1)

We can now see our schema updates in the git diffs:

![Drizzle pull changes](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/12/drizzle-pull-diffs.png?resize=1024%2C427&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/12/drizzle-update-schema.png?resize=1024%2C673&ssl=1)

And now we’ll run`npx drizzle-kit generate` and you should see:

![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/12/drizzle-generate-2-1.png?resize=1024%2C349&ssl=1)
...
```component VPCard
{
  "title": "Drizzle Database Migrations",
  "desc": "Drizzle ORM is a powerful object-relational mapper that combines SQL capabilities with a strongly typed API, enabling complex queries. Here we'll look at using it's ability to help with migrations, both code-first and database-first.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/drizzle-database-migrations.html",
  "logo": "https://blog.master.dev/favicon.ico",
