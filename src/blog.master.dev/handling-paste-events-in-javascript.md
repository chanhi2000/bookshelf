...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/handling-paste-events-in-javascript.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/4153
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/handling-paste-events-in-javascript/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/4153"/>

Welcome to the third and final post in the series. In the[**first article**](/blog.master.dev/reading-from-the-clipboard-in-javascript.md), I explained how JavaScript can read from the user’s clipboard. In the[**last article**](/blog.master.dev/writing-to-the-clipboard-in-javascript.md), I explained the opposite, writing to the user’s clipboard. Now I’m going to demonstrate how to add basic “paste event” handling in your web app. Luckily, much of what we learned in the past two articles will come in handy as the ‘shape’ of the data will be the same.
...
For ‘plain/text’, you see what I think you would expect. If you go to a random web page, lets say the[**first article**](/blog.master.dev/reading-from-the-clipboard-in-javascript.md)in this series, and select from the title to the first paragraph:
...
```component VPCard
{
  "title": "Handling Paste Events in JavaScript",
  "desc": "This concludes our three-part series on working with clipboard data. With pasting, we have some control over the type of data we want to use.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/handling-paste-events-in-javascript.html",
  "logo": "https://blog.master.dev/favicon.ico",
