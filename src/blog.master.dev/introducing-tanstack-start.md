...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/introducing-tanstack-start.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/4810
---
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/12/csr-perf-flow.png?resize=772%2C874&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/12/csr-user.png?resize=684%2C498&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/12/ssr-user.png?resize=796%2C506&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/12/extra-data.png?resize=724%2C800&ssl=1)
...
In TanStack, we do have loaders. These are defined by TanStack Router. I wrote [**a three-part series on Routerhere**](/blog.master.dev/introducing-tanstack-router.md). If you haven’t read that, and aren’t familiar with Router, give it a quick look.
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/12/tasks-page.png?resize=671%2C1024&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/12/streaming-tasks.png?resize=692%2C662&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/12/streaming-tasks-finish.png?resize=754%2C764&ssl=1)
...
```component VPCard
{
  "title": "Introducing TanStack Start",
  "desc": "TanStack Start enhances the TanStack Router by adding a server layer that improves performance through server-side rendering (SSR) and isomorphic loaders.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/introducing-tanstack-start.html",
  "logo": "https://blog.master.dev/favicon.ico",
