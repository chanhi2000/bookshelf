...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/the-deep-card-conundrum.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/7957
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/the-deep-card-conundrum/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/7957"/>
...
![Comparison of overflow properties in CSS: left shows 'overflow: visible;' with layered rectangles, right shows 'overflow: clip;' with clipped edges.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/12/t0LtCaNQ.png?resize=1024%2C567&ssl=1)
...
![A textured blackboard covered with various mathematical equations, diagrams, and symbols, creating a complex academic backdrop.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/12/Rw8ilzFF.png?resize=1024%2C512&ssl=1)
...
![A screenshot of a messaging app conversation featuring a user's message expressing excitement about a discovery.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/12/image.png?resize=602%2C230&ssl=1)
...
```component VPCard
{
  "title": "The Deep Card Conundrum",
  "desc": "What if you could make a card like a 3D portal, with layers of depth? You probably should just click to see, it's a very compelling look.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/the-deep-card-conundrum.html",
  "logo": "https://blog.master.dev/favicon.ico",
