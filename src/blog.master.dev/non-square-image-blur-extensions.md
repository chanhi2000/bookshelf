...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/non-square-image-blur-extensions.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/7855
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/non-square-image-blur-extensions/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/7855"/>
...
It’s a CSS feature I’ve [**talked about before**](/blog.master.dev/grainy-gradients.md) as it allows us to apply a filter *only* to the `background` of an element, for example making a card’s gradient `background` grainy without affecting its text content.
...
```component VPCard
{
  "title": "Non-Square Image Blur Extensions",
  "desc": "I recently came across this CodePen demo by Vivi Tseng, which creates the blur extension effect by placing a square div with a blur() beneath the img element and I couldn’t help but think a simpler solution should be possible with a single img element and minimal CSS. So let’s first take a look at […]",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/non-square-image-blur-extensions.html",
  "logo": "https://blog.master.dev/favicon.ico",
