...
head:
  - - meta:
    ...
    - property: og:description
      content: "9 / 16"
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/9-16.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/4259
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/9-16/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/4259"/>
...
That’s [**a light-DOM-only web component**](/blog.master.dev/light-dom-only.md) that just “enhances” otherwise normal HTML. Perhaps it’s not bursting with usefulness, but it was useful to me.
...
```component VPCard
{
  "title": "9 / 16",
  "desc": "The other day I needed to quickly see pixel dimensions that were exactly in a 9 / 16 aspect ratio. Like: 180 / 320. That’s perfectly in that ratio. You might be able to think of that one in your head, but how about 351 / 624? That’s harder to think of. And I wanted […]",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/9-16.html",
  "logo": "https://blog.master.dev/favicon.ico",
