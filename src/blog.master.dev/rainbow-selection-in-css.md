...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/rainbow-selection-in-css.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/5194
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/rainbow-selection-in-css/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/5194"/>
...
![Geoff Grahams website with the first few words of a paragraph selected. The selected text has an orange background color, just like the border of the whole site.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/02/Screenshot-2025-02-14-at-7.30.26%E2%80%AFAM.png?resize=1024%2C387&ssl=1)
...
![Lit documentation site with 5 paragraphs of text selected, each with slightly different hues of greens and blues as backgrounds.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/02/lit.png?resize=1024%2C895&ssl=1)
...
![No dice on iOS But it seems to work everywhere else.](https://blog.master.dev/wp-content/uploads/2025/02/Screenshot-2025-02-14-at-7.54.12 AM.png)
...
```component VPCard
{
  "title": "Rainbow Selection in CSS",
  "desc": "::selection is cool, but scoping it to selectors like :nth-child(5n+2) is even more fun, especially on a love filled ay like Valentine's Day.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/rainbow-selection-in-css.html",
  "logo": "https://blog.master.dev/favicon.ico",
