...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/super-simple-full-bleed-breakout-styles.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/7560
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/super-simple-full-bleed-breakout-styles/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/7560"/>
...
Another thing to note is that there may be cases where we need another container somewhere in between. In that case, we can still access the `content-box` width of the `html` as detailed in [**a previous article**](/blog.master.dev/using-container-query-units-relative-to-an-outer-container.md):
...
We can also have multiple layers of gradients, maybe even blended, maybe even with a `filter` making them [**grainy**](/blog.master.dev/grainy-gradients.md) (something that would help with the visible banding noticed in the `border-image` method examples) or creating a [**halftone pattern**](/blog.master.dev/pure-css-halftone-effect-in-3-declarations.md).
...
```component VPCard
{
  "title": "Super Simple Full-Bleed & Breakout Styles",
  "desc": "Having a width-limited centered column of content is common and good, but what do you do when you need to break out? It's not hard these days, but it does depend on the situation.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/super-simple-full-bleed-breakout-styles.html",
  "logo": "https://blog.master.dev/favicon.ico",
