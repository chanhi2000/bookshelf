...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/simulating-crop-marks.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/8246
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/simulating-crop-marks/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/8246"/>
...
![Screenshot of Adobe InDesign 2026 interface showing export settings for PDF, including options for printer's marks like crop marks, bleed marks, registration marks, and color bars.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/01/CleanShot-2026-01-12-at-16.06.35%402x.png?resize=1024%2C531&ssl=1)

Then the PDF will be a bit bigger than the designed sheet size and have these marks:

![A screenshot of a PDF document showing crop marks in the corner and a large pink shape filling the page.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/01/CleanShot-2026-01-12-at-16.07.41%402x.png?resize=1024%2C695&ssl=1)
...
![A cutting machine used in print shops, labeled 'BAUM-PM55', with a steel cutting blade and control panel.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/01/40945-Baum_PM55A_Paper_Cutter_1001180313001.jpg?resize=900%2C599&ssl=1)

::: note

Have you ever heard the term **“bleed”** in web design?

![For example…](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/01/Screenshot-2026-01-12-at-4.15.36-PM.png?resize=940%2C1024&ssl=1)
...
![Diagram illustrating crop marks, bleed, slug, page edge (trim), and margins in print design.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/01/160359937581220.jpg?resize=1024%2C576&ssl=1)
...
```component VPCard
{
  "title": "Simulating Crop Marks",
  "desc": "Crop marks are an idea that comes from the print design world. Design in the bleed area will be cut away by giant cutter machines, and that bleed area is designated by the crop marks. We can do it on the web too, just for kicks.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/simulating-crop-marks.html",
  "logo": "https://blog.master.dev/favicon.ico",
