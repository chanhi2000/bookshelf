...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/move-modal-in-on-a-shape.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/5917
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/move-modal-in-on-a-shape/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/5917"/>
...
[**I only just learned**](/blog.master.dev/lessons-learned-from-recreating-a-styled-dialog.md#no-invokers-yes-invokers) you can open a modal (in the proper “modal” state) without any JavaScript using invokers.
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/shape-movement.png?resize=1024%2C773&ssl=1)
...
```component VPCard
{
  "title": "Move Modal in on a… shape()",
  "desc": "Got an old ",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/move-modal-in-on-a-shape.html",
  "logo": "https://blog.master.dev/favicon.ico",
