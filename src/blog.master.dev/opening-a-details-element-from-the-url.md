...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/opening-a-details-element-from-the-url.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/7019
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/opening-a-details-element-from-the-url/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/7019"/>
...
```component VPCard
{
  "title": "Opening a Details Element from the URL",
  "desc": "If the #hash in the URL matches the ID of an element *inside* a  element, it'll open. No other fancy code required.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/opening-a-details-element-from-the-url.html",
  "logo": "https://blog.master.dev/favicon.ico",
