...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/backgrounds-for-the-box-model-and-why-it-can-be-useful.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/3716
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/backgrounds-for-the-box-model-and-why-it-can-be-useful/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/3716"/>
...
![Box Model in Chrome DevTools](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/09/box-model.png?resize=594%2C366&ssl=1)
...
```component VPCard
{
  "title": "Backgrounds for the Box Model (and why it can be useful)",
  "desc": "You can limit how far the background-image of an element applies by using background-clip. That means you can apply *different* backgrounds to, say, the padding and border.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/backgrounds-for-the-box-model-and-why-it-can-be-useful.html",
  "logo": "https://blog.master.dev/favicon.ico",
