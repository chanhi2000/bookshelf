...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/infinite-marquee-animation-using-modern-css.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/6673
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/infinite-marquee-animation-using-modern-css/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/6673"/>
...
To overcome the limitation of `path()`, we are going to use [**the new `shape()` function**](/blog.master.dev/shape-a-new-powerful-drawing-syntax-in-css.md)! Here is a quote from [<VPIcon icon="fas fa-globe"/>the specification](https://drafts.csswg.org/css-shapes-1/#shape-function):
...
![An animated marquee with text that moves horizontally across a container, showcasing a modern CSS implementation for infinite scrolling images or text.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/08/GsbSeQsh.png?resize=577%2C258&ssl=1)
...
```component VPCard
{
  "title": "Infinite Marquee Animation using Modern CSS",
  "desc": "A row of logos that animate forever perfectly and don't have any duplicated HTML or JavaScript at all is quite a trick. Thanks modern CSS! ",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/infinite-marquee-animation-using-modern-css.html",
  "logo": "https://blog.master.dev/favicon.ico",
