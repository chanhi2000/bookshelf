...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/image-gallery-with-popovers-and-aim-anchor-interpolated-morph.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/8857
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/image-gallery-with-popovers-and-aim-anchor-interpolated-morph/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/8857"/>
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/03/Screenshot-2026-03-19-at-9.13.24-AM.png?resize=1024%2C878&ssl=1)
...
```component VPCard
{
  "title": "Image Gallery with Popovers and AIM (Anchor-Interpolated Morph)",
  "desc": "An image gallery is a nice example of AIM, where the larger version of an image can ",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/image-gallery-with-popovers-and-aim-anchor-interpolated-morph.html",
  "logo": "https://blog.master.dev/favicon.ico",
