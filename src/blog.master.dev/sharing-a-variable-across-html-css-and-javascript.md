...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/sharing-a-variable-across-html-css-and-javascript.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/4908
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/sharing-a-variable-across-html-css-and-javascript/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/4908"/>
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/01/CleanShot-2025-01-08-at-07.18.41%402x.png?resize=1024%2C517&ssl=1)
...
```component VPCard
{
  "title": "Sharing a Variable Across HTML, CSS, and JavaScript",
  "desc": "Set a variable in Pug, then create an inline script which sets that variable for using in JavaScript and use setProperty to pass it to CSS.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/sharing-a-variable-across-html-css-and-javascript.html",
  "logo": "https://blog.master.dev/favicon.ico",
