...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/anchored-menus-and-a-lesson-in-scoping.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/8550
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/anchored-menus-and-a-lesson-in-scoping/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/8550"/>

I had this (bad) idea.

It’s related to [**popovers and anchor-positioned menus**](/blog.master.dev/popover-context-menus-with-anchor-positioning.md). I love this pairing: with only HTML and CSS we can make a button that opens/closes anything we want. A tooltip or a menu is a wonderful use-case.
...
I’m totally adding [<VPIcon icon="fas fa-globe"/>this](https://matuzo.at/blog/2026/better-defaults-for-popovers) to [**my reset stylesheet**](/blog.master.dev/the-coyier-css-starter.md). (And I like how Manuel is down with the perfect fallbacks for anchors, `position-try-fallbacks: flip-block, flip-inline, flip-block flip-inline;`, which [**we also came to here**](/blog.master.dev/popover-context-menus-with-anchor-positioning.md#the-most-useful-position-try-incantationå).)
...
```component VPCard
{
  "title": "Anchored Menus and a Lesson in Scoping",
  "desc": "Turns out `anchor-scope` is pretty darn useful for button/menu setups that will appear multiple times on the same page.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/anchored-menus-and-a-lesson-in-scoping.html",
  "logo": "https://blog.master.dev/favicon.ico",
