...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/lets-play-with-gap-decorations.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/10210
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/lets-play-with-gap-decorations/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/10210"/>
...
```component VPCard
{
  "title": "Let’s Play With Gap Decorations!",
  "desc": "The `rule` (and friends) CSS property allows us to draw markers (like borders) in the gaps between columns and rows (and flex items!)",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/lets-play-with-gap-decorations.html",
  "logo": "https://blog.master.dev/favicon.ico",
