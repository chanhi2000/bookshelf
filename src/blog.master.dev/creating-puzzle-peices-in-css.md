...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/creating-puzzle-peices-in-css.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/9168
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/creating-puzzle-peices-in-css/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/9168"/>
...
```component VPCard
{
  "title": "Let’s Get Puzzled!",
  "desc": "We can make puzzle pieces in CSS thanks to the amazing clip-path: shape(). Here, Amit takes it further by making a whole grid of them with matched edges and content inside.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/creating-puzzle-peices-in-css.html",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
