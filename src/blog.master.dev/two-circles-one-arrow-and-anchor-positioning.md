...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/two-circles-one-arrow-and-anchor-positioning.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/9033
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/two-circles-one-arrow-and-anchor-positioning/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/9033"/>

In a previous series of articles, we studied a classic use case of anchor positioning: [**Tooltips**](/blog.master.dev/perfectly-pointed-tooltips-a-foundation.md). In this article, we will explore a less common use case that is a great example of the power of this new feature and modern CSS in general.
...
![Three sets of colored circles and lines with labels: 'Good' in green, 'not bad' in gray, and 'Ugly!' in red.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/03/DeesSK9Q.png?resize=1001%2C271&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/03/O5sLWpZ.png?resize=597%2C491&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/03/BWUV4G12.png?resize=443%2C373&ssl=1)
...
![A graphic illustrating a horizontal arrow shape labeled 'before' with dimensions of 254.6 x 52 pixels.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/03/O1VQISTQ.png?resize=496%2C171&ssl=1)

The next step is to rotate the arrow so that it points to the first circle:

![Diagram comparing two geometric shapes, with the left side showing a diagonal line between two circles and the right side illustrating dimensions labeled as height, width, and angle.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/03/O4OoDHhg.png?resize=1016%2C382&ssl=1)
...
![A graphic illustrating two overlapping circles, one in light blue and one in light orange, connected by a translucent arrow with a directional indicator, alongside a label displaying dimensions.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/03/d55_ybqM.png?resize=646%2C336&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/03/ozZ8IJf3.png?resize=759%2C261&ssl=1)
...
In this demo, I am relying on a trick I am detailing in a previous article that I highly recommend you read: [**How to Get the Width/Height of Any Element in Only CSS**](/blog.master.dev/how-to-get-the-width-height-of-any-element-in-only-css.md).
...
```component VPCard
{
  "title": "Two Circles, One Arrow, and Anchor Positioning",
  "desc": "Drawing an line with arrows pointing to the center of two arbitrary elements measuring and displaying the distance between them doesn't seem like it would be possible in CSS alone... but... ",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/two-circles-one-arrow-and-anchor-positioning.html",
  "logo": "https://blog.master.dev/favicon.ico",
