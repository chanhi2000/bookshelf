...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/1fr-1fr-vs-auto-auto-vs-50-50.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/6058
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/1fr-1fr-vs-auto-auto-vs-50-50/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/6058"/>
...
![A grid layout showcasing three different configurations: two columns with '50% 50%' width, two columns with 'auto auto', and two columns with '1fr 1fr', each containing minimal text.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/06/Screenshot-2025-06-11-at-4.26.35%E2%80%AFAM.png?resize=1004%2C686&ssl=1)
...
![A comparison of three grid layouts, showcasing the use of different CSS properties for column widths: 50% 50%, auto auto, and 1fr 1fr, with sample text dimensions. The extra text in the first column has forced the auto column to be a bit wider than the 2nd column.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/06/Screenshot-2025-06-11-at-4.35.04%E2%80%AFAM.png?resize=701%2C1024&ssl=1)
...
![Screenshot comparing three grid layouts: '50% 50%', 'auto auto', and '1fr 1fr', each displaying an image of a daisy with minimal text on the right.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/06/Screenshot-2025-06-11-at-4.42.29%E2%80%AFAM.png?resize=726%2C1024&ssl=1)
...
![Screenshot showcasing three different grid layouts with two equal width columns labeled '50% 50%', 'auto auto', and '1fr 1fr'. Each layout includes an image of a flower and text indicating 'Very little text'.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/06/Screenshot-2025-06-11-at-4.45.51%E2%80%AFAM.png?resize=786%2C1024&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/06/Screenshot-2025-06-11-at-4.56.49%E2%80%AFAM.png?resize=1024%2C603&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/06/Screenshot-2025-06-11-at-4.59.44%E2%80%AFAM.png?resize=1024%2C250&ssl=1)
...
```component VPCard
{
  "title": "1fr 1fr vs auto auto vs 50% 50%",
  "desc": "There are several different ways to do equal width columns. But some are, uh, more equal than others.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/1fr-1fr-vs-auto-auto-vs-50-50.html",
  "logo": "https://blog.master.dev/favicon.ico",
