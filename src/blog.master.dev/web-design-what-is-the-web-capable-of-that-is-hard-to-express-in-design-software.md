...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/web-design-what-is-the-web-capable-of-that-is-hard-to-express-in-design-software.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/6030
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/web-design-what-is-the-web-capable-of-that-is-hard-to-express-in-design-software/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/6030"/>
...
![I don’t find `:active` states particularity common, likely because design software doesn’t care to prompt you into state-based design.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/08/states.png?resize=734%2C377&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/08/Screenshot-2025-08-15-at-11.31.15-AM.png?resize=1024%2C384&ssl=1)
...
![This can and does work fine sometimes.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/08/Screenshot-2025-08-15-at-11.34.57-AM.png?resize=1024%2C766&ssl=1)
...
What about translation? That’s a big one as [**sites are translated whether or not you deal with it**](/blog.master.dev/to-flip-or-not-to-flip.md). Can languages that translate with generally more characters than the original language find enough room?
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/08/Screenshot-2025-08-18-at-10.31.57-AM.png?resize=698%2C588&ssl=1)
...
```component VPCard
{
  "title": "Web Design: What is the web capable of that is hard to express in design software?",
  "desc": "The web platform has a heaping helping of more design capability built into it than any design software does.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/web-design-what-is-the-web-capable-of-that-is-hard-to-express-in-design-software.html",
  "logo": "https://blog.master.dev/favicon.ico",
