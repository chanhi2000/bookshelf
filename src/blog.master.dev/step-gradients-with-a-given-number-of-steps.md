...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/step-gradients-with-a-given-number-of-steps.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/6338
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/step-gradients-with-a-given-number-of-steps/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/6338"/>
...
Finally, we could make the gradients grainy. But the approach discussed in [**a previous article**](/blog.master.dev/grainy-gradients.md) is likely not what we’re going for.
...
This is the path taken by the sunburst demo below, which was created taking inspiration from the heading image of [**an earlier post here**](/blog.master.dev/css-bursts-with-conic-gradients.md):
...
```component VPCard
{
  "title": "Step Gradients with a Given Number of Steps",
  "desc": "A deep dive into producing an interpolated ",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/step-gradients-with-a-given-number-of-steps.html",
  "logo": "https://blog.master.dev/favicon.ico",
