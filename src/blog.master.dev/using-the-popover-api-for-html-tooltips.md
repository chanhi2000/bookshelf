...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/using-the-popover-api-for-html-tooltips.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/2027
---
...
2. [**Footnotes Progressively Enhanced to Popovers**](/blog.master.dev/footnotes-progressively-enhanced-to-popovers.md)
3. [**Popovers Work Pretty Nicely as Slide-Out Drawers**](/blog.master.dev/popovers-work-pretty-nicely-as-slide-out-drawers.md)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/05/Screenshot-2024-05-06-at-8.30.13%E2%80%AFAM.png?resize=1024%2C265&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/05/Screenshot-2024-05-06-at-8.33.46%E2%80%AFAM.png?resize=1024%2C921&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/05/Screenshot-2024-05-06-at-8.47.28%E2%80%AFAM.png?resize=1024%2C858&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/05/Screenshot-2024-05-06-at-8.48.54%E2%80%AFAM.png?resize=1024%2C937&ssl=1)
...
```component VPCard
{
  "title": "Using the Popover API for HTML Tooltips",
  "desc": "We can *mostly* use HTML alone for this API. But here, we'll use CSS to style the ",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/using-the-popover-api-for-html-tooltips.html",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
