...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/shadow-dom-focus-delegation-getting-delegatesfocus-right.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/9073
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/shadow-dom-focus-delegation-getting-delegatesfocus-right/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/9073"/>
...
![clicking anywhere on host forwards focus to first focusable element inside the shadow dom](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/03/562538168-c11d6a9a-c78b-4e68-b00d-d9a8e85a73b7.png?resize=566%2C542&ssl=1)
...
![The host element matches both the `:focus` and `:focus-within` CSS pseudo-classes whenever an internal element is focused](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/03/562541586-204b3b21-acd8-4cac-9c1b-bbdbae2127f3.png?resize=566%2C464&ssl=1)
...
![Comparison of focus behavior in two scenarios: one using tabindex='0' showing two tab stops, and the other using delegatesFocus only showing one tab stop.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/03/562546388-b9945e92-680e-48d7-8691-aa83b7358c7a.png?resize=1024%2C843&ssl=1)
...
```component VPCard
{
  "title": "Shadow DOM Focus Delegation: Getting delegatesFocus Right",
  "desc": "You don't necessarily have to do focus handling yourself with shadow DOM web components. For simple wrapper components, there is an easier (and better) way.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/shadow-dom-focus-delegation-getting-delegatesfocus-right.html",
  "logo": "https://blog.master.dev/favicon.ico",
