...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/exactly-how-to-deploy-local-files-to-make-a-live-website.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/2018
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/exactly-how-to-deploy-local-files-to-make-a-live-website/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/2018"/>
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/05/Screenshot-2024-05-15-at-3.40.14%E2%80%AFPM.png?resize=1024%2C840&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/05/live-website-1.jpg?resize=1024%2C683&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/05/folder.png?resize=814%2C1024&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/05/Screenshot-2024-05-16-at-3.53.45%E2%80%AFPM.png?resize=1024%2C733&ssl=1)
...
```component VPCard
{
  "title": "Exactly How to Deploy Local Files to Make a Live Website",
  "desc": "A very basic step-by-step guide of exactly how to do it for static files like .html, .css, and .js files. ",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/exactly-how-to-deploy-local-files-to-make-a-live-website.html",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
