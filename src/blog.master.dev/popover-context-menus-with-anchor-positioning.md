...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/popover-context-menus-with-anchor-positioning.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/8194
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/popover-context-menus-with-anchor-positioning/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/8194"/>
...
We’ll use a `<button>` to toggle the menu (duh!) and put the attributes on it to set up an [**invoker**](/blog.master.dev/menus-toasts-and-more.md). Invokers are super cool, allowing us to open/close the menu without any JavaScript at all. Just these declarative instructions will do. The `interestfor` attribute is extra-new, allowing [**`popover="hint"`**](/blog.master.dev/what-is-popoverhint.md) to work meaning we can even open the popover on hover/focus (which is kinda amazing that it can be done in HTML alone).
...
```component VPCard
{
  "title": "Popover Context Menus with Anchor Positioning",
  "desc": "A context menu is like a tooltip in that it opens right next to the the thing that opened it. Here, we animate the opening and ensure it opens somewhere where it doesn't get cut off.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/popover-context-menus-with-anchor-positioning.html",
  "logo": "https://blog.master.dev/favicon.ico",
