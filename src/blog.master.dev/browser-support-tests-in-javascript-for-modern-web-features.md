...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/browser-support-tests-in-javascript-for-modern-web-features.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/2865
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/browser-support-tests-in-javascript-for-modern-web-features"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/2865"/>
...
```component VPCard
{
  "title": "Browser Support Tests in JavaScript for Modern Web Features",
  "desc": "Sometimes it's good to know when a browser feature is supported or not so you can do something. Perhaps load a polyfill or just choose a slightly different approach. This post looks at newish features in browsers and shows the test.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/browser-support-tests-in-javascript-for-modern-web-features.html",
  "logo": "https://blog.master.dev/favicon.ico",
