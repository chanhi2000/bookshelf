...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/form-associated-custom-elements-in-practice.html
prev: /programming/js-lit/articles/README.md
date: 2026-03-11
isOriginal: false
author:
  - name: Rob Levin
    url: https://blog.master.dev/author/roblevin/
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/8896
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/form-associated-custom-elements-in-practice/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/8896"/>

I was well over three-quarters of the way through [**rewriting the AgnosticUI components in Lit**](/blog.master.dev/post-mortem-rewriting-agnosticui-with-lit-web-components.md) when I realized I had a massive blind spot. My `<ag-input>` looked solid and fired events correctly, but it lacked [<VPIcon icon="fa-brands fa-firefox"/>Form-Associated Custom Element](https://developer.mozilla.org/en-US/docs/Web/API/ElementInternals) (FACE) support. This meant it was essentially invisible to native `<form>` submissions.
...
![Comparison of native input and custom element in a form, showing how the native input correctly captures the value 'hello' in FormData, while the custom element results in empty FormData.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/03/558955386-ada204cb-7ec0-43b2-824a-755a29a558cc.png?resize=1024%2C626&ssl=1)
...
![Diagram illustrating two steps of using formAssociated in a web development context. Step 1 explains registering the element with the browser, while Step 2 outlines attaching internal methods for form control behavior.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/03/558964092-d9736006-52f1-4252-acca-39f9e71a56c4.png?resize=1024%2C484&ssl=1)
...
![Diagram comparing two validation strategies in a web component context: 'Strategy 1: Delegate' showing how to manage validity with a host element and shadow DOM, and 'Strategy 2: Direct' illustrating direct validation handling without delegation.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/03/558976906-b27cb5aa-c8a6-41d0-86f1-c29f06ec520f.png?resize=1024%2C381&ssl=1)
...
```component VPCard
{
  "title": "Form-Associated Custom Elements in Practice",
  "desc": "When you make a Web Component for a form element, you've got a bit of extra work to do to make sure they participate on the form in expected ways.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/form-associated-custom-elements-in-practice.html",
  "logo": "https://blog.master.dev/favicon.ico",
