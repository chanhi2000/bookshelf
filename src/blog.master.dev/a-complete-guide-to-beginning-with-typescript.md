...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/a-complete-guide-to-beginning-with-typescript.html
prev: /programming/ts/articles/README.md
date: 2024-09-06
isOriginal: false
author: Cody Lindley
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/3728
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/a-complete-guide-to-beginning-with-typescript/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/3728"/>
...
- [TypeScript Fundamentals, v4](https://master.dev/courses/typescript-v4/)\[$\]
...
- [TypeScript Learning Path](https://master.dev/learn/typescript/)
  - [Intermediate TypeScript, v2](https://master.dev/courses/intermediate-typescript-v2/)\[$\]
  - [Making TypeScript Stick](https://master.dev/courses/typescript-practice/)\[$\]
...
- [React and TypeScript, v2](https://master.dev/courses/react-typescript-v2/)\[$\]
- [Enterprise TypeScript](https://master.dev/courses/enterprise-typescript/)\[$\]
- [JavaScript and TypeScript Monorepos](https://master.dev/courses/monorepos/)\[$\]
...
![You should be looking at something similar to this](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/09/typescript-stackblitz.png?resize=1024%2C456&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/09/typescript-simple.png?resize=1024%2C489&ssl=1)
...
![Note that both the code editor (red squiggly line under “count”) and the “tsc” CLI tool are reporting a TypeScript error.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/09/typescript-error-1024x566.png?resize=1024%2C566&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/09/incorrect-type-error-1024x309.png?resize=1024%2C309&ssl=1)
...
Make sure to check out the[<VPIcon icon="fas fa-globe"/>learning path on TypeScript](https://master.dev/learn/typescript/).
...
```component VPCard
{
  "title": "A Complete Guide to Beginning with TypeScript",
  "desc": "",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/a-complete-guide-to-beginning-with-typescript.html",
  "logo": "https://blog.master.dev/favicon.ico",
