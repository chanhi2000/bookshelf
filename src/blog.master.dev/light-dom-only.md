...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/light-dom-only.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/166
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/light-dom-only/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/166"/>
...
```component VPCard
{
  "title": "Light-DOM-Only Web Components are Sweet",
  "desc": "First: the Light DOM is just… the regular DOM. When people talk about native Web Components, the Shadow DOM comes up a lot. I have extremely mixed feelings about the Shadow DOM. On one hand, it’s a powerful scoping tool. For example, CSS applied inside the Shadow DOM doesn’t “leak” outside, meaning you can be […]",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/light-dom-only.html",
  "logo": "https://blog.master.dev/favicon.ico",
