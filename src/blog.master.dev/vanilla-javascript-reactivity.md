...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/vanilla-javascript-reactivity.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/40
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/vanilla-javascript-reactivity/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/40"/>
...
1. [**Writing a TodoMVC App with Modern Vanilla JavaScript**](/blog.master.dev/vanilla-javascript-todomvc.md)
...
3. [**Patterns for Memory Efficient DOM Manipulation with Modern Vanilla JavaScript**](/blog.master.dev/patterns-for-memory-efficient-dom-manipulation.md)
...
Hat tip Ryan Carniato’s [<VPIcon icon="fas fa-globe"/>Reactivity with SolidJS course](https://master.dev/courses/reactivity-solidjs/).
...
See examples of other approaches in the [Vanilla TodoMVC repo (<VPIcon icon="iconfont icon-github"/>`1Marc/modern-todomvc-vanillajs`)](https://github.com/1Marc/modern-todomvc-vanillajs) and associated [**Vanilla TodoMVC article**](/blog.master.dev/vanilla-javascript-todomvc.md).
...
Next, check out the [<VPIcon icon="fas fa-globe"/>JavaScript Learning Path](https://master.dev/learn/javascript/) and learn JavaScript deeply from awesome instructors like Anjana Vakil, Will Sentance and Kyle Simpson! Or dive right into the most loved course on the platform, [<VPIcon icon="fas fa-globe"/>JavaScript: The Hard Parts](https://master.dev/courses/javascript-hard-parts-v2/)!
...
```component VPCard
{
  "title": "Patterns for Reactivity with Modern Vanilla JavaScript",
  "desc": "“Reactivity” is how systems react to changes in data. There are many types of reactivity, but for this article, reactivity is when data changes, you do things.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/vanilla-javascript-reactivity.html",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
