...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/how-to-scope-css-now-that-its-baseline.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/8146
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/how-to-scope-css-now-that-its-baseline/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/8146"/>
...
- No external resource to download (even if you load CSS asynchronously to stop it from render-blocking, which risks [**Cumulative Layout Shift**](/web.dev/cls.md) anyway, external resources must be downloaded in full before they can be rendered, which isn’t ideal)
...
```component VPCard
{
  "title": "How to @scope CSS Now That It’s Baseline",
  "desc": "There is a way to declare a scope on a specific selector, a specific selector *down to* another selector, or with no ",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/how-to-scope-css-now-that-its-baseline.html",
  "logo": "https://blog.master.dev/favicon.ico",
