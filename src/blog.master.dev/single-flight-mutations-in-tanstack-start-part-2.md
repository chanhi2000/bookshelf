...
description: "Article(s) > Single Flight Mutations in TanStack Start: Part 2"
...
head:
  - - meta:
    - property: og:title
      content: "Article(s) > Single Flight Mutations in TanStack Start: Part 2"
    - property: og:description
      content: "Single Flight Mutations in TanStack Start: Part 2"
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/single-flight-mutations-in-tanstack-start-part-2.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/8384
---
...
<SiteInfo
  name="Single Flight Mutations in TanStack Start: Part 2"
  ...
  url="https://blog.master.dev/single-flight-mutations-in-tanstack-start-part-2/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/8384"/>

[**In part 1**](/blog.master.dev/single-flight-mutations-in-tanstack-start-part-1.md), we talked about how single flight mutations allow you to update data, and re-fetch all the relevant updated data for the UI, all in just one roundtrip across the network.
...
If you’ve never touched TanStack’s middleware before and are feeling overwhelmed, my [**middleware post**](/blog.master.dev/introducing-tanstack-start-middleware.md) might be a good introduction.
...
![A code snippet showing a function handleSaveFinal, where an input value is being saved and a runSave function is called with an object containing id and name properties.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/01/img8.png?resize=1024%2C272&ssl=1)
...
export function refetchedQueryOptions<TFn extends AnyAsyncFn>( queryKey: QueryKey,
  serverFn: ServerFnWithArgs<TFn>,
  arg: Parameters<TFn>[0]["data"], ): RefetchQueryOptions<Awaited<ReturnType<TFn>>>;
export function refetchedQueryOptions<TFn extends AnyAsyncFn>( queryKey: QueryKey,
  serverFn: ValidateServerFunction<TFn, ServerFnWithoutArgs<TFn>>, ): RefetchQueryOptions<Awaited<ReturnType<TFn>>>;
export function refetchedQueryOptions<TFn extends AnyAsyncFn>( queryKey: QueryKey,
...
```component VPCard
{
  "title": "Single Flight Mutations in TanStack Start: Part 2",
  "desc": "This post introduces a middleware approach that allows efficient data refetching. The middleware enables the attachment of query keys and server functions, enhancing scalability and flexibility.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/single-flight-mutations-in-tanstack-start-part-2.html",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
