...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/why-is-this-thing-in-dark-mode.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/2907
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/why-is-this-thing-in-dark-mode/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/2907"/>
...
![Email in “Dark Mode” in Front](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/07/dark-email.png?resize=1019%2C1024&ssl=1)

![Email in “Light Mode” in Front](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/07/light-email.png?resize=1016%2C1024&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/07/CleanShot-2024-07-03-at-10.45.32%402x.png?resize=1024%2C765&ssl=1)
...
![That selected option on the left is “Automatic Appearance” which is what some things call “System” meaning match what the OS is doing.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/07/CleanShot-2024-07-03-at-10.48.29%402x.png?resize=731%2C1024&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/07/Screenshot-2024-07-03-at-10.52.44%E2%80%AFAM.png?resize=954%2C446&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/07/CleanShot-2024-07-03-at-10.51.22%402x.png?resize=780%2C870&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/07/CleanShot-2024-07-03-at-10.54.51%402x.png?resize=1024%2C571&ssl=1)
...
```component VPCard
{
  "title": "Why is this thing in Dark Mode?",
  "desc": "The website has the most control, since that's what applies the CSS. But browsers also have a Dark/Light/System setting, and that can fall through to the OS/Device.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/why-is-this-thing-in-dark-mode.html",
  "logo": "https://blog.master.dev/favicon.ico",
