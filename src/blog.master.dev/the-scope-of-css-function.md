...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/the-scope-of-css-function.html
prev: /programming/css/articles/README.md
date: 2026-06-16
isOriginal: false
author:
  - name: Jane Ori
    url: https://blog.master.dev/author/janeori/
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/9932
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/the-scope-of-css-function/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/9932"/>

We’re going to walk through some advanced patterns for using `@function` in CSS in this article that help you deliver awesome DX to your component or library users. You’ll need [**an understanding of CSS function foundations and limitations**](/blog.master.dev/the-fundamentals-and-dev-experience-of-css-function.md) to follow along with the gold here.
...
```component VPCard
{
  ...
  "link": "/blog.master.dev/the-fundamentals-and-dev-experience-of-css-function.md",
  "logo": "https://blog.master.dev/favicon.ico",
...
```component VPCard
{
  "title": "The Scope of CSS @function",
  "desc": "There are some real advantages to variable scope and evaluation scope that you get with @function in CSS.",
  "link": "/blog.master.dev/the-scope-of-css-function.md",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
...
You do NOT want to simply pass arguments to your functions on the switch board because, as [**detailed in the previous article**](/blog.master.dev/the-fundamentals-and-dev-experience-of-css-function.md#function-arguments), if you call a function that doesn’t have each of those arguments defined, the call will fail without any way to debug it other than just knowing that’s why. This is bad DX. **Portable evaluation scope** instead allows your users to quickly define the function in minimal syntax, without parameters, and just use whichever variables they need.
...
As [**suggested in the previous article**](/blog.master.dev/the-fundamentals-and-dev-experience-of-css-function.md#function-arguments:~:text=initial%20value%20is-,particularly%20useful,-as%20a%20default), using `initial` as the default argument value makes this specific case fairly easy.
...
```component VPCard
{
  "title": "The Scope of CSS @function",
  "desc": "There are some real advantages to variable scope and evaluation scope that you get with @function in CSS.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/the-scope-of-css-function.html",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
