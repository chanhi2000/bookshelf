...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/split-effects-with-no-content-duplication.html
prev: /programming/css/articles/README.md
date: 2024-09-11
isOriginal: false
author: Ana Tudor
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/3782
---
...
![Intermediate result](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/09/a0c487c75678b468-1024x419-1.png?resize=1024%2C419&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/09/4c8d4dd8abb9103b.png?resize=737%2C313&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/09/89629fa5c262b96d.png?resize=1024%2C437&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/09/4ac81ff1e5864e8e.png?resize=1024%2C639&ssl=1)
...
```component VPCard
{
  "title": "Split Effects with no Content Duplication",
  "desc": "The `clip-path` property with the `inset()` shape makes for some cool design opportunities. Here we'll expand on some existing ideas, improving them by not requiring any content duplication.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/split-effects-with-no-content-duplication.html",
  "logo": "https://blog.master.dev/favicon.ico",
