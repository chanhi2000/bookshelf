...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/getting-started-with-cursor.html
prev: /tool/cursor/articles/README.md
date: 2025-09-08
isOriginal: false
author:
  - name: Steve Kinney
    url: https://blog.master.dev/author/stevekinney/
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/7062
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/getting-started-with-cursor/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/7062"/>
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/09/image.png?resize=1024%2C617&ssl=1)
...
If you *really* want to level up with your AI coding skills, you should go from here right to Steve’s course [<VPIcon icon="fas fa-globe"/>Cursor & Claude Code: Professional AI Setup](https://master.dev/courses/pro-ai/).
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/09/image-1.png?resize=902%2C510&ssl=1)
...
```component VPCard
{
  "title": "Getting Started with Cursor",
  "desc": "Cursor is an AI-focused VS Code fork. Here's Steve Kinney with a nice overview of what it offers and how to start getting help out of it right away.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/getting-started-with-cursor.html",
  "logo": "https://blog.master.dev/favicon.ico",
