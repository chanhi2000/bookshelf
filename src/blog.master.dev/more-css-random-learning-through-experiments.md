...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/more-css-random-learning-through-experiments.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/7764
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/more-css-random-learning-through-experiments/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/7764"/>
  
The `random()` function in CSS [<VPIcon icon="fa-brands fa-safari"/>is well-specced](https://webkit.org/blog/17285/rolling-the-dice-with-css-random/) and just so [**damn fun**](/blog.master.dev/very-early-playing-with-random-in-css.md). I had some, ahem, random ideas lately I figured I’d write up.
...
![with border on container](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/Screenshot-2025-11-18-at-10.04.53-AM.png?resize=952%2C998&ssl=1)

![border removed](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/Screenshot-2025-11-18-at-10.05.49-AM.png?resize=1024%2C992&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/Screenshot-2025-11-18-at-10.40.21-AM.png?resize=898%2C516&ssl=1)
...
```component VPCard
{
  "title": "More CSS random() Learning Through Experiments",
  "desc": "There is quite a bit of interesting design possibility with `random()` coming to CSS. It pairs nicely with animation, particularly animation-composition for agumenting those generated values.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/more-css-random-learning-through-experiments.html",
  "logo": "https://blog.master.dev/favicon.ico",
