...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/creating-blob-shapes-using-clip-path-shape.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/5861
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/creating-blob-shapes-using-clip-path-shape/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/5861"/>

After [**the flower shapes**](/blog.master.dev/creating-flower-shapes-using-clip-path-shape.md), let’s move to one of the coolest shapes: the **Blob**! Those distorted wiggly circles that were almost impossible to achieve using CSS. But now, they are possible using the new`shape()`function.
...
```component VPCard
{
  "title": "Creating Blob Shapes using clip-path: shape()",
  "desc": "Blobs! Gooey weird shapes you can fill with any background and even animate. ",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/creating-blob-shapes-using-clip-path-shape.html",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
