...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/we-can-has-it-all.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/442
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/we-can-has-it-all/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/442"/>
...
```component VPCard
{
  "title": "We can :has it all",
  "desc": "I’m still obsessed with how awesome and powerful :has() is in CSS. Ryan Mulligan really drives it home in We can :has it all with a single Pen that offers simple, realistic UI controls for: These are things you can easily imagine on any website, and now handled here entirely without JavaScript at all. Declarations […]",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/we-can-has-it-all.html",
  "logo": "https://blog.master.dev/favicon.ico",
