...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/fine-grained-reactivity-in-svelte-5.html
prev: /programming/js-svelte/articles/README.md
date: 2024-08-14
isOriginal: false
author: Adam Rackis
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/3438
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/fine-grained-reactivity-in-svelte-5"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/3438"/>
...
```component VPCard
{
  ...
  "link": "/blog.master.dev/introducing-svelte-5.md",
  "logo": "https://blog.master.dev/favicon.ico",
...
```component VPCard
{
  ...
  "link": "/blog.master.dev/snippets-in-svelte-5.md",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
...
```component VPCard
{
  "title": "Fine-Grained Reactivity in Svelte 5",
  "desc": "Svelte is already quite lightweight and fast, but Svelte 5 still overs big improvements in fine-grained reactivity, meaning re-rendering as absolutely little as possible. ",
  "link": "/blog.master.dev/fine-grained-reactivity-in-svelte-5.md",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/08/svelte4.png?resize=1024%2C399&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/08/svelte4-updated.png?resize=1024%2C387&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/08/svelte5.png?resize=1024%2C395&ssl=1)

Now let’s change one piece of state, as before. We’ll update the title for Task C, the third one.

![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/08/svelte5-updated.png?resize=1024%2C392&ssl=1)
...
If you closely read my [**first post**](/blog.master.dev/introducing-svelte-5.md#state)on Svelte 5, you might recall that you can’t directly return reactive state from a function, since the state will be read and unwrapped right at the call-site, and won’t be reactive any longer. Normally you’d have to do this:
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/08/svelte5-shallow.png?resize=1024%2C470&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/08/svelte5-shallow-updated.png?resize=1024%2C457&ssl=1)
...
```component VPCard
{
  "title": "Fine-Grained Reactivity in Svelte 5",
  "desc": "Svelte is already quite lightweight and fast, but Svelte 5 still overs big improvements in fine-grained reactivity, meaning re-rendering as absolutely little as possible. ",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/fine-grained-reactivity-in-svelte-5.html",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
