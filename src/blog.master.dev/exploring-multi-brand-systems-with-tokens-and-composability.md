...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/exploring-multi-brand-systems-with-tokens-and-composability.html
prev: /programming/js-vue/articles/README.md
date: 2025-12-19
isOriginal: false
author:
  - name: Adam Sedwick
    url: https://blog.master.dev/author/adam-sedwick/
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/8041
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/exploring-multi-brand-systems-with-tokens-and-composability/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/8041"/>
...
![A card showcasing Red Rocks Park and Amphitheatre with a featured location banner, a vibrant image of a concert, title, description, and a button inviting users to view events.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/12/image6.png?resize=732%2C746&ssl=1)
...
![Card displaying Shedd Aquarium with a featured location banner, an underwater scene, title 'Shedd Aquarium', description 'Look Nature in the Eye.' and a button 'Plan Your Visit'.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/12/image3.png?resize=732%2C746&ssl=1)
...
![A card component showcasing the Shedd Aquarium with a featured location banner, an underwater scene, and a call-to-action button.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/12/image1.png?resize=732%2C746&ssl=1)
...
![A card design showcasing the Shedd Aquarium with a featured location banner, an underwater scene, and a list of available experiences including 'Touch Experiences', 'Animal Encounters', and 'Stringray Feedings'. Below, there is a button labeled 'Plan Your Visit'.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/12/image2.png?resize=732%2C842&ssl=1)
...
![An aerial view of the Adler Planetarium showcasing its unique dome structure and surrounding landscape, featuring a prominent banner reading 'Escape to the Stars'. Below, there is a section displaying the title 'Adler Planetarium' and a list of upcoming events.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/12/image5.png?resize=732%2C942&ssl=1)
...
![Three card components showcasing different featured locations with images, titles, descriptions, and action buttons.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/12/image4.png?resize=1024%2C436&ssl=1)
...
```component VPCard
{
  "title": "Exploring Multi-Brand Systems with Tokens and Composability",
  "desc": "Exploring a Card component made hyper flexible though use of easily changeable custom properties, props, and slots.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/exploring-multi-brand-systems-with-tokens-and-composability.html",
  "logo": "https://blog.master.dev/favicon.ico",
