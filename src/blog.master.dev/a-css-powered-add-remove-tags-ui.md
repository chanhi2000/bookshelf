...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/a-css-powered-add-remove-tags-ui.html
prev: /programming/css/articles/README.md
date: 2024-04-11
isOriginal: false
author: Preethi Sam
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/1650
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/a-css-powered-add-remove-tags-ui/"
  logo="/favicon-16x16.png"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/1650"/>
...
But now, thanks to`:has()`in CSS, we’re not beholden to that structure anymore.[**We can `:has()` it all**](/blog.master.dev/we-can-has-it-all.md), as it is said. Now that these HTML elements have some autonomy, without losing their connection to one another, a lot can be achieved
...
```component VPCard
{
  "title": "A CSS-Powered Add/Remove Tags UI",
  "desc": "Checkboxes and labelsusedto have to be right next to each other to be a potent UI duo. You could do trickery like this:But now, thanks to:has()in CSS, we’re not beholden to that structure anymore.We can :has() it all, as it is said. Now that these HTML elements have some autonomy, without losing their connection to […]",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/a-css-powered-add-remove-tags-ui.html",
