...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/css-n-of-selectors-for-conditional-validation.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/9469
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/css-n-of-selectors-for-conditional-validation/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/9469"/>
...
```component VPCard
{
  "title": "CSS `n of` Selectors for Conditional Validation",
  "desc": ":nth-child supports the keyword `of` in the argument which can be super useful on it's own. Combo that with a :has() selector to do some pretty wild stuff!",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/css-n-of-selectors-for-conditional-validation.html",
  "logo": "https://blog.master.dev/favicon.ico",
