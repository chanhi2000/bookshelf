...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/single-flight-mutations-in-tanstack-start-part-1.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/8334
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/single-flight-mutations-in-tanstack-start-part-1/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/8334"/>
...
If you’re not familiar with these tools, TanStack Router is a client-only SPA framework (see my [**three-part introduction series**](/blog.master.dev/introducing-tanstack-router.md)). TanStack Start is a server layer for Router that enables things like SSR, API routes, and server functions (see my [**introduction for it**](/blog.master.dev/introducing-tanstack-start.md) and [**a post on its middleware feature**](/blog.master.dev/introducing-tanstack-start-middleware.md)).
...
```component VPCard
{
  "title": "Single Flight Mutations in TanStack Start: Part 1",
  "desc": "What if we could mutate data *and* get all the data back we need to properly update the UI in just one network round-trip?",
  "link": "/blog.master.dev/single-flight-mutations-in-tanstack-start-part-1.md",
  "logo": "https://blog.master.dev/favicon.ico",
...
```component VPCard
{
  ...
  "link": "/blog.master.dev/single-flight-mutations-in-tanstack-start-part-2.md",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
...
In my [**post on TanStack Start**](/blog.master.dev/introducing-tanstack-start.md), I included this image, which is how client-driven single-page applications (SPAs) almost always behave.

![A flow diagram illustrating the sequence of actions between a browser and a web server when loading a webpage, highlighting the steps of rendering an empty app shell, loading scripts, requesting data, and finally displaying the full page.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/01/img1.png?ssl=1)
<!-- TODO: mermaid화 -->
...
![Diagram illustrating the sequence of actions in client-driven single-page applications, showing the initial GET request for an HTML document, followed by script file requests, and the transition from page display to interactivity.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/01/img2.png?ssl=1)
<!-- TODO: mermaid화 -->
...
![A flowchart illustrating the interaction between a browser and web server, detailing the process of posting updated data, receiving an update result, requesting updated data, and updating the UI accordingly.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/01/img3.png?resize=1024%2C922&ssl=1)
<!-- TODO: mermaid화 -->
...
![Screenshot of a web application displaying an overview of epics with a list of tasks, including buttons for viewing and editing.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/01/img5.png?resize=830%2C1024&ssl=1)
...
![A user interface displaying a list of epics with their respective task counts, including buttons for viewing and editing each epic.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/01/img6.png?resize=792%2C1024&ssl=1)
...
![Code snippet displaying a loop over result.epicsList with properties of each epic highlighted, showing 'id' and 'name' attributes.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/01/img7.png?resize=1024%2C150&ssl=1)
...
```component VPCard
{
  "title": "Single Flight Mutations in TanStack Start: Part 1",
  "desc": "What if we could mutate data *and* get all the data back we need to properly update the UI in just one network round-trip?",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/single-flight-mutations-in-tanstack-start-part-1.html",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
