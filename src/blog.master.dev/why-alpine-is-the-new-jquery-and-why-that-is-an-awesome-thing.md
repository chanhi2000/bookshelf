...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/why-alpine-is-the-new-jquery-and-why-that-is-an-awesome-thing.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/4338
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/why-alpine-is-the-new-jquery-and-why-that-is-an-awesome-thing/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/4338"/>
...
```component VPCard
{
  "title": "Why Alpine is the new jQuery and Why that is an Awesome Thing",
  "desc": "jQuery for was great and all, but Alpine.js simplifies tasks like data binding and DOM manipulation, providing using a more declarative and clear structure, making it ideal for smaller projects.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/why-alpine-is-the-new-jquery-and-why-that-is-an-awesome-thing.html",
  "logo": "https://blog.master.dev/favicon.ico",
