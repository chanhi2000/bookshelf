...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/the-missing-link-for-web-components.html
prev: /programming/js-storybook/articles/README.md
date: 2026-01-15
isOriginal: false
author:
  - name: Florian Geierstanger
    url: https://blog.master.dev/author/floriangeierstanger/
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/8268
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/the-missing-link-for-web-components/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/8268"/>
...
![Screenshot of a Storybook interface displaying documentation for a custom button component, including sections for attributes and slots.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/01/image6.png?resize=1024%2C726&ssl=1)
...
![A code snippet displaying the render function of a custom button component in a web development context, featuring two button instances with different variant attributes, and documentation about the component's attributes, events, and slots.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/01/image5.png?resize=1024%2C607&ssl=1)

Hitting <kbd>Ctrl</kbd>+<kbd>Space</kbd> shows the available options for the variant attribute.

![Code snippet demonstrating the render function for a button component in a web development context, showcasing options for the 'variant' attribute.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/01/image3.png?resize=1024%2C203&ssl=1)
...
![A screenshot showing the description of a custom button component called 'my-button', including its attributes, properties, and events.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/01/image1.png?resize=848%2C1024&ssl=1)
...
![Error message displayed in a terminal window indicating a validation issue with a web component, specifically that 'tertiary' is not a valid value for the 'variant' attribute.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/01/image4.png?resize=1024%2C273&ssl=1)
...
```component VPCard
{
  "title": "The Missing Link for Web Components",
  "desc": "If your project uses web components of your own making, you could be auto-generating a Custom Elements Manifest that can be ultra-helpful, like powering a VS Code language server. ",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/the-missing-link-for-web-components.html",
  "logo": "https://blog.master.dev/favicon.ico",
