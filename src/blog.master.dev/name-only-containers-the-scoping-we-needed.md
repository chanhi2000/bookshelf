...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/name-only-containers-the-scoping-we-needed.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/9223
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/name-only-containers-the-scoping-we-needed/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/9223"/>

I’ve done my time thinking about scope in CSS. I’ve done it my whole career, and did a presentation on it recently that [**I wrote up in full here**](/blog.master.dev/scope-in-css.md). That was on the heels of [**`@scope` becoming a thing in CSS**](/blog.master.dev/how-to-scope-css-now-that-its-baseline.md), which is, naturally, a part of the scope in CSS story.
...
[**I covered these**](/blog.master.dev/scope-in-css.md) in my talk. They have their uses, but again: *niche*.
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/04/Scope.010.webp?resize=1024%2C576&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2026/04/Screenshot-2026-04-04-at-3.00.51-PM.png?resize=391%2C1024&ssl=1)
...
```component VPCard
{
  ...
  "link": "/blog.master.dev/light-dom-only.md",
  "logo": "https://blog.master.dev/favicon.ico",
...
```component VPCard
{
  ...
  "link": "/blog.master.dev/architecture-through-component-colocation.md",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
...
```component VPCard
{
  "title": "Name-Only Containers: The Scoping We Needed",
  "desc": "If we give a `container-name` to the root of all our unique components, we can scope styles to them with a simple @container query.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/name-only-containers-the-scoping-we-needed.html",
  "logo": "https://blog.master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
