...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/chatgpt-and-old-and-broken-code.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/5808
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/chatgpt-and-old-and-broken-code/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/5808"/>
...
```component VPCard
{
  "title": "ChatGPT and the proliferation of obsolete and broken solutions to problems we hadn’t had for over half a decade before its launch",
  "desc": "It was a lovely day on the internet when someone asked how to CSS animated gradient text like ChatGPT’s “Searching the web” and promptly got an answer saying “Have you tried asking ChatGPT? Here’s what it told me!” - well, maybe not these exact words, but at least it rhymes. Both the question and this […]",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/chatgpt-and-old-and-broken-code.html",
  "logo": "https://blog.master.dev/favicon.ico",
