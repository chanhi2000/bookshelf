...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/blog.master.dev/introducing-zustand.html
...
cover: https://blog.master.dev/wp-json/social-image-generator/v1/image/6584
---
...
<SiteInfo
  ...
  url="https://blog.master.dev/introducing-zustand/"
  logo="https://blog.master.dev/favicon.ico"
  preview="https://blog.master.dev/wp-json/social-image-generator/v1/image/6584"/>
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/07/img1-app.png?resize=1024%2C665&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/07/img2-context-rerender.png?resize=544%2C510&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/07/img3-zustand-default-rerender.png?resize=558%2C460&ssl=1)
...
![Console log showing rendering messages for TasksHeader, TasksBody, and TasksDetailed components.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/07/img4-zustand-optimized.png?resize=558%2C296&ssl=1)
...
```component VPCard
{
  "title": "Introducing Zustand (State Management)",
  "desc": "Zustand is a minimal, but fun and effective state management library which just may improve your render performance.",
  "link": "https://chanhi2000.github.io/bookshelf/blog.master.dev/introducing-zustand.html",
  "logo": "https://blog.master.dev/favicon.ico",
