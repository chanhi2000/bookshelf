...
You can see for yourself [<FontIcon icon="fas fa-globe"/>on CodeSandbox](https://codesandbox.io/s/falling-cookies-2ddlhx?file=/index.html).
...
See for yourself [<FontIcon icon="fas fa-globe"/>on CodeSandbox](https://codesandbox.io/s/quirky-cherry-39qdom?file=/style.css).
