...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/learnkube.com/kubernetes-services-and-load-balancing.html
...
This is what <VPIcon icon="iconfont icon-yaml"/>`frontend-deployment.yaml` looks like:
...
![As soon as the request exits the node, it is intercepted.](https://learnkube.com/a/0647121a494185ba89c8d30f347c0c1f.svg)

@tab (2/4)

![The source IP address is amended again to be the original requester.](https://learnkube.com/a/c3b30b7cd08255df8d7c54fd18fee52f.svg)

@tab (3/4)

![Iptables also help us pretend the traffic comes from a service.](https://learnkube.com/a/570b675617dfab270e92b88d919973c5.svg)

@tab (4/4)

![The traffic finally reaches the original requester.](https://learnkube.com/a/b28a3ae592653c7ac0ee31e574f30e5b.svg)
...
```component VPCard
{
  "title": "Kubernetes networking: service, kube-proxy, load balancing",
  "desc": "This article examines Kubernetes networking, focusing on Services and load balancing. It explains how traffic is routed within the cluster and from external sources.",
  "link": "https://chanhi2000.github.io/bookshelf/learnk8s.com/learnkube.comkubernetes-services-and-load-balancing.html",
  "logo": "https://static.learnkube.com/f7e5160d4744cf05c46161170b5c11c9.svg",
