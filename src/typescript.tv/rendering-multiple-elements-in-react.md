...
description: "Article(s) > Rendering multiple elements in React"
...
head:
  - - meta:
    - property: og:title
      content: "Article(s) > Rendering multiple elements in React"
    - property: og:description
      content: "Rendering multiple elements in React"
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/typescript.tv/rendering-multiple-elements-in-react.html
...
<SiteInfo
  name="Rendering multiple elements in React"
  desc="In this episode of Amir's React with TypeScript course, you will learn how to render multiple elements in React. He will also show you how to create a TypeScript interface to specify known properties of your objects. This tutorial covers topics like creating a React Function component, using Array.map, and  basic data structures in TypeScript."
  url="https://typescript.tv/react/rendering-multiple-elements-in-react"
...
- Make use of [<VPIcon icon="fa-brands fa-firefox"/>Array.map](https://developer.mozilla.org/en/docs/Web/JavaScript/Reference/Global_Objects/Array/map)
...
<VidStack src="youtube/PocpAw3OlcU" />
...
```component VPCard
{
  "title": "Rendering multiple elements in React",
  "desc": "In this episode of Amir's React with TypeScript course, you will learn how to render multiple elements in React. He will also show you how to create a TypeScript interface to specify known properties of your objects. This tutorial covers topics like creating a React Function component, using Array.map, and  basic data structures in TypeScript.",
  "link": "https://chanhi2000.github.io/bookshelf/typescript.tv/rendering-multiple-elements-in-react.html",
  "logo": "https://typescript.tv/_astro/android-chrome-192x192.BhQ8hcWh.png",
