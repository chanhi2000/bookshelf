---
lang: ko-KR
title: How to fix “Function declares an opaque return type, but has no return statements in its body from which to infer an underlying type”
description: Article(s) > How to fix “Function declares an opaque return type, but has no return statements in its body from which to infer an underlying type”
category:
  - Swift
  - SwiftUI
  - Article(s)
...
head:
  - - meta:
    - property: og:title
      content: Article(s) > How to fix “Function declares an opaque return type, but has no return statements in its body from which to infer an underlying type”
...
```component VPCard
{
  ...
  "link": "https://hackingwithswift.com/quick-start/swiftui/how-to-fix-function-declares-an-opaque-return-type-but-has-no-return-statements-in-its-body-from-which-to-infer-an-underlying-type",
  "logo": "https://hackingwithswift.com/favicon.svg",
