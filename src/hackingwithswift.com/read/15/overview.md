...
description: "Article(s) > Project 15: Animation"
category:
  - Swift
  - iOS
  - Article(s)
...
head:
  - - meta:
    - property: og:title
      content: "Article(s) > Project 15: Animation"
    - property: og:description
      content: "Project 15: Animation"
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/hackingwithswift.com/read/15/overview.html
prev: /hackingwithswift.com/read/14/05-wrap-up.md
isOriginal: false
---
...
```component VPCard
{
  ...
  "link": "https://hackingwithswift.com/read/15/overview", 
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(174,10,10,0.2)"
}
```
...
```component VPCard
{
  ...
  "desc": "Setting up",
  "link": "/hackingwithswift.com/read/15/01-setting-up.md",
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(174,10,10,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/hackingwithswift.com/read/15/02-preparing-for-action.md",
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(174,10,10,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/hackingwithswift.com/read/15/03-switch-case-animate-animatewithduration.md",
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(174,10,10,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/hackingwithswift.com/read/15/04-transform-cgaffinetransform.md",
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(174,10,10,0.2)"
}
```
...
```component VPCard
{
  ...
  "desc": "Wrap up",
  "link": "/hackingwithswift.com/read/15/05-wrap-up.md",
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(174,10,10,0.2)"
}
```
