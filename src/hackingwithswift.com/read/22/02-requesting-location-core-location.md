...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/articles/hackingwithswift.com/read/22/02-requesting-location-core-location.html
isOriginal: false
---
...
Open <FontIcon icon="fa-brands fa-swift"/>`ViewController.swift` and add this import alongside UIKit:
