...
description: Article(s) > Vision - free Swift example code
...
head:
  - - meta:
    - property: og:title
      content: Article(s) > Vision - free Swift example code
    - property: og:description
      content: Vision - free Swift example code
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/hackingwithswift.com/example-code/vision/
---
...
```component VPCard
{
  ...
  "desc": "iOS 13.0 introduced a new micro-framework called VisionKit, which is specifically designed to make it possible to scan documents like Notes does. ...",
  "link": "/hackingwithswift.com/example-code/vision/how-to-detect-documents-using-vndocumentcameraviewcontroller.md",
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(174,10,10,0.2)"
}
```
