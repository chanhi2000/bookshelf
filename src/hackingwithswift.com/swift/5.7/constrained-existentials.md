...
description: Article(s) > Constrained existential types
category:
  - Swift
  - Article(s)
tag: 
...
head:
  - - meta:
    - property: og:title
      content: Article(s) > Constrained existential types
    - property: og:description
      content: Constrained existential types
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/hackingwithswift.com/swift/5.7/constrained-existentials.html
isOriginal: false
author:
  - name: Paul Hudson
...
```component VPCard
{
  ...
  "link": "https://hackingwithswift.com/swift/5.7/constrained-existentials", 
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(54,94,226,0.2)"
}
```
...
[SE-0353 (<FontIcon icon="iconfont icon-github"/>`apple/swift-evolution`)](https://github.com/apple/swift-evolution/blob/main/proposals/0353-constrained-existential-types.md) provides the ability to compose [SE-0309 (<FontIcon icon="iconfont icon-github"/>`apple/swift-evolution`)](https://github.com/apple/swift-evolution/blob/main/proposals/0309-unlock-existential-types-for-all-protocols.md) (“Unlock existentials for all protocols”) and [SE-0346 (<FontIcon icon="iconfont icon-github"/>`apple/swift-evolution`)](https://github.com/apple/swift-evolution/blob/main/proposals/0346-light-weight-same-type-syntax.md) (“Lightweight same-type requirements for primary associated types”) to write code such as `any Sequence<String>`.
