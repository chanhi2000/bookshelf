...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/articles/hackingwithswift.com/swift/5.3/float16.html
isOriginal: false
---
...
[SE-0277 (<FontIcon icon="iconfont icon-github"/>`apple/swift-evolution`)](https://github.com/apple/swift-evolution/blob/master/proposals/0277-float16.md) introduced a new half-precision floating point type called `Float16`, which is commonly used in graphics programming and machine learning. 
