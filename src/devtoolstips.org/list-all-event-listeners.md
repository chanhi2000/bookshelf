...
1. Open the **Console** tool, by pressing <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>J</kbd> on <VPIcon icon="fa-brands fa-windows"/>Windows or <VPIcon icon="fa-brands fa-linux"/>Linux, or <kbd>⌘</kbd>+<kbd>Option</kbd>+<kbd>J</kbd> on <VPIcon icon="iconfont icon-macos"/>macOS.
