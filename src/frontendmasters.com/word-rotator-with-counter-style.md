...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/frontendmasters.com/word-rotator-with-counter-style.html
...
cover: https://frontendmasters.com/blog/wp-json/social-image-generator/v1/image/9947
---
...
<SiteInfo
  ...
  url="https://frontendmasters.com/blog/word-rotator-with-counter-style/"
  logo="https://frontendmasters.com/favicon.ico"
  preview="https://frontendmasters.com/blog/wp-json/social-image-generator/v1/image/9947"/>

In [**the last article**](/frontendmasters.com/obscuring-text-with-counter-style.md), we covered a few ways for generating character strings to be used for data obfuscation. We looked at the counter style *systems*: `symbolic`, `alphabetic`, and `numeric`. Now, let’s get into even more uses of `@counter-style` and discover additional systems.
...
```component VPCard
{
  ...
  "link": "/frontendmasters.com/obscuring-text-with-counter-style.md",
  "logo": "https://frontendmasters.com/favicon.ico",
...
```component VPCard
{
  "title": "Word Rotator with @counter-style",
  "desc": "Using @counter-style for tricky visual effects like word rotation and obfuscation.",
  "link": "/frontendmasters.com/word-rotator-with-counter-style.md",
  "logo": "https://frontendmasters.com/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
...
```component VPCard
{
  "title": "Word Rotator with @counter-style",
  "desc": "Using @counter-style for tricky visual effects like word rotation and obfuscation.",
  "link": "https://chanhi2000.github.io/bookshelf/frontendmasters.com/word-rotator-with-counter-style.html",
  "logo": "https://frontendmasters.com/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
