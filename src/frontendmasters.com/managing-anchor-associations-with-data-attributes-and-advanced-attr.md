...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/frontendmasters.com/managing-anchor-associations-with-data-attributes-and-advanced-attr.html
...
cover: https://frontendmasters.com/blog/wp-json/social-image-generator/v1/image/9712
---
...
<SiteInfo
  ...
  url="https://frontendmasters.com/blog/managing-anchor-associations-with-data-attributes-and-advanced-attr/"
  logo="https://frontendmasters.com/favicon.ico"
  preview="https://frontendmasters.com/blog/wp-json/social-image-generator/v1/image/9712"/>
...
To be clear, I mean that every boat looks the same and every anchor looks the same, but each boat needs to be anchored to a specific anchor (think: some kind of reusable, decorative motif that can be anchored to anything). I know, I know, anchors can be [**scoped using `anchor-scope`**](/frontendmasters.com/anchored-menus-and-a-lesson-in-scoping.md), but that’d only work in certain circumstances.
...
```component VPCard
{
  "title": "Managing Anchor Associations With Data Attributes and Advanced attr()",
  "desc": "There is no `anchor` attribute in HTML, it was decided CSS `anchor-name` / `position-anchor` was the way to go. But modern CSS functions can get us there anyway.",
  "link": "https://chanhi2000.github.io/bookshelf/frontendmasters.com/managing-anchor-associations-with-data-attributes-and-advanced-attr.html",
  "logo": "https://frontendmasters.com/favicon.ico",
