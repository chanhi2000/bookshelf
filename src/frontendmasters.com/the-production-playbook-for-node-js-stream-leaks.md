...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/frontendmasters.com/the-production-playbook-for-node-js-stream-leaks.html
...
cover: https://frontendmasters.com/blog/wp-json/social-image-generator/v1/image/9727
---
...
```component VPCard
{
  ...
  "link": "/frontendmasters.com/your-node-js-streams-arent-backpressuring-theyre-silently-eating-your-memory.md",
  "logo": "https://frontendmasters.com/favicon.ico",
...
```component VPCard
{
  "title": "The Production Playbook for Node.js Stream Leaks",
  "desc": "Short story: `pipeline()` over `.pipe()` and destroy what you create.",
  "link": "/frontendmasters.com/the-production-playbook-for-node-js-stream-leaks.md",
  "logo": "https://frontendmasters.com/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
...
![Chrome DevTools heap snapshot showing WritableState retaining majority of heap](https://i0.wp.com/frontendmasters.com/blog/wp-content/uploads/2026/05/devtools-heap-snapshot-writable-state.png?resize=1024%2C666&ssl=1)
...
```component VPCard
{
  "title": "The Production Playbook for Node.js Stream Leaks",
  "desc": "Short story: `pipeline()` over `.pipe()` and destroy what you create.",
  "link": "https://chanhi2000.github.io/bookshelf/frontendmasters.com/the-production-playbook-for-node-js-stream-leaks.html",
  "logo": "https://frontendmasters.com/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
