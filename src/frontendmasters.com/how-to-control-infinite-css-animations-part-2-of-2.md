...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/frontendmasters.com/how-to-control-infinite-css-animations-part-2-of-2.html
...
cover: https://frontendmasters.com/blog/wp-json/social-image-generator/v1/image/9604
---
...
<SiteInfo
  ...
  preview="https://frontendmasters.com/blog/wp-json/social-image-generator/v1/image/9604"/>
...
```component VPCard
{
  ...
  "link": "/frontendmasters.com/how-to-control-infinite-css-animations-part-1-of-2.md",
  "logo": "https://frontendmasters.com/favicon.ico",
...
```component VPCard
{
  "title": "How to Control Infinite CSS Animations (Part 2 of 2)",
  "desc": "This time we get into very smooth starts and stops for infinite animations using CSS. One of the tricks is layering on a transition on top of an animation.",
  "link": "/frontendmasters.com/how-to-control-infinite-css-animations-part-2-of-2.md",
  "logo": "https://frontendmasters.com/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
...
That said, we can still find other alternatives to achieve the same effect. Here is an example using [**the infinite marquee animation**](/frontendmasters.com/infinite-marquee-animation-using-modern-css.md). Hover to start the animation
...
![](https://i0.wp.com/frontendmasters.com/blog/wp-content/uploads/2026/05/s_C6AA43C3C1B478B9638AC2829B138248E95A7DEAE36E24FA8C99B3A572BF120C_1778024165331_image.png?resize=769%2C299&ssl=1)
...
```component VPCard
{
  "title": "How to Control Infinite CSS Animations (Part 2 of 2)",
  "desc": "This time we get into very smooth starts and stops for infinite animations using CSS. One of the tricks is layering on a transition on top of an animation.",
  "link": "https://chanhi2000.github.io/bookshelf/frontendmasters.com/how-to-control-infinite-css-animations-part-2-of-2.html",
  "logo": "https://frontendmasters.com/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
