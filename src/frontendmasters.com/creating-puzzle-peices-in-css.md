...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/frontendmasters.com/creating-puzzle-peices-in-css.html
...
cover: https://frontendmasters.com/blog/wp-json/social-image-generator/v1/image/9168
---
...
<SiteInfo
  ...
  url="https://frontendmasters.com/blog/creating-puzzle-peices-in-css/"
  logo="https://frontendmasters.com/favicon.ico"
  preview="https://frontendmasters.com/blog/wp-json/social-image-generator/v1/image/9168"/>
...
![Image of a puzzle piece with labeled edges and tabs/sockets](https://i0.wp.com/frontendmasters.com/blog/wp-content/uploads/2026/03/e6vSkxqi-1.png?resize=800%2C487&ssl=1)
...
![GIF showing the basic square shape defined by the above path](https://i0.wp.com/frontendmasters.com/blog/wp-content/uploads/2026/04/bFQQP-QP.gif?resize=800%2C450&ssl=1)
...
![GIF showing the curve definition for the top edge with control points](https://i0.wp.com/frontendmasters.com/blog/wp-content/uploads/2026/04/pBardfj4.gif?resize=800%2C450&ssl=1)
...
```component VPCard
{
  "title": "Let’s Get Puzzled!",
  "desc": "We can make puzzle pieces in CSS thanks to the amazing clip-path: shape(). Here, Amit takes it further by making a whole grid of them with matched edges and content inside.",
  "link": "https://chanhi2000.github.io/bookshelf/frontendmasters.com/creating-puzzle-peices-in-css.html",
  "logo": "https://frontendmasters.com/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
