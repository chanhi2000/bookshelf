...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/frontendmasters.com/what-to-know-in-javascript-2026-edition.html
...
cover: https://frontendmasters.com/blog/wp-json/social-image-generator/v1/image/8479
---
...
I get into this in [**A Nice Vanilla App Architecture Using Web Components and CSS Module Scripts**](/frontendmasters.com/architecture-through-component-colocation.md). I just really like how we can keep CSS to CSS files which could live in a folder right next to a JavaScript component.
...
We had a nice [**overview of the whole Vue ecosystem in 2024**](/frontendmasters.com/the-vue-ecosystem-in-2024.md). But as a total Vue outsider, it’s a little hard for me to understand the 2025/2026 scene. Obviously, Evan You is the main dude here, but he’s running [<VPIcon icon="fas fa-globe"/>wVoidZero](https://voidzero.dev/) (“The JavaScript Tooling Company”), which now produces [<VPIcon icon="fas fa-globe"/>wVite+](https://viteplus.dev/), which is *a whole slew* of major projects, like Vite itself, formatting, linting, testing, etc. None of that is Vue-specific, and I gotta imagine it’s hard to focus on Vue itself when all this is going on 🤷‍♀️.
...
It’s on React 19 also, which means `<ViewTransition>` support, which [**we looked at here**](/frontendmasters.com/reacts-viewtransition-element.md).
...
We’ve got [<VPIcon icon="fas fa-globe"/>lots of content getting into the TanStack world](https://frontendmasters.com/blog/tag/tanstack/) from Adam Rackis.
...
[<VPIcon icon="fas fa-globe"/>Signing up for Frontend Masters](https://frontendmasters.com/courses/) is the ticket to those fundamental skills.
...
```component VPCard
{
  "title": "What To Know in JavaScript (2026 Edition)",
  "desc": "An overview of what's new in language features, frameworks, runtimes, build tools, testing, and more.",
  "link": "https://chanhi2000.github.io/bookshelf/frontendmasters.com/what-to-know-in-javascript-2026-edition.html",
  "logo": "https://frontendmasters.com/favicon.ico",
