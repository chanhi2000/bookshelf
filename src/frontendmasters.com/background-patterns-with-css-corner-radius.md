...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/frontendmasters.com/background-patterns-with-css-corner-radius.html
...
cover: https://frontendmasters.com/blog/wp-json/social-image-generator/v1/image/8505
---
...
<SiteInfo
  ...
  url="https://frontendmasters.com/blog/background-patterns-with-css-corner-radius/"
  logo="https://frontendmasters.com/favicon.ico"
  preview="https://frontendmasters.com/blog/wp-json/social-image-generator/v1/image/8505"/>

The `corner-shape` property in CSS can do some neat designs. [**Things like vintage tickets, with corners trimmed inwards**](/frontendmasters.com/drawing-css-shapes-using-corner-shape.md), [<VPIcon icon="fas fa-globe"/>sci-fi corners](https://daverupert.com/2025/07/sci-fi-rectangles-with-corner-shape/), tags, and those types of designs are usually comes to mind when we think of the CSS property `corner-shape`.

There are a variety of nice primitive keywords we get with `corner-shape`, like `round` (the default), `bevel`, `scoop`, `squircle`, and [**the all-powerful `superellipse()`**](/frontendmasters.com/understanding-css-corner-shape-and-the-power-of-the-superellipse.md). It’s actually quite easy to create interesting shapes that can be used for more than corner decorations.

Think patterned backgrounds.

![A grid of various decorative patterns featuring red shapes on a white background, including stars, crosses, and curved designs.](https://i0.wp.com/frontendmasters.com/blog/wp-content/uploads/2026/02/mgdkr_7X.png?resize=1024%2C522&ssl=1)
...
```component VPCard
{
  "title": "Background Patterns with CSS `corner-radius`",
  "desc": "You might need to know this someday: you can style a div, put the div into SVG, then put the SVG in to CSS and use it as a repeating background.",
  "link": "https://chanhi2000.github.io/bookshelf/frontendmasters.com/background-patterns-with-css-corner-radius.html",
  "logo": "https://frontendmasters.com/favicon.ico",
