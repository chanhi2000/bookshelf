...
#### <FontIcon icon="fa-brands fa-dart-lang"/>`search_section.dart`
...
Add this code to <FontIcon icon="fas fa-folder-open"/>`lib/widgets/`<FontIcon icon="fa-brands fa-dart-lang"/>`show_modal.dart`:
