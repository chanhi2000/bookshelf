...
As per the [<FontIcon icon="iconfont icon-oracle"/>official documentation](https://docs.oracle.com/javase/tutorial/java/generics/types.html):
...
Let's connect on [LinkedIn (<FontIcon icon="fa-brands fa-linkedin"/>`abaradwaj`)](https://linkedin.com/in/abaradwaj/).
