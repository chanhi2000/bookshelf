...
If you want to get more into the technical details about Futures, you can check out [<FontIcon icon="fa-brands fa-rust"/>the documentation](https://rust-lang.github.io/async-book/02_execution/01_chapter.html).
...
To install `tokio` in your project, add this line to its <FontIcon icon="iconfont icon-tomml"/>`Cargo.toml`:
...
To install `futures` in your project, add this line to its <FontIcon icon="iconfont icon-tomml"/>`Cargo.toml`:
