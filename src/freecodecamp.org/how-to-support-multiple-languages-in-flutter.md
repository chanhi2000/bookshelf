...
If you would like to read other articles I have written, you can find them [here (<FontIcon icon="iconfont icon-github"/>`TomerPacific/MediumArticles`)](https://github.com/TomerPacific/MediumArticles).
