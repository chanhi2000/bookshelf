...
For more information on Functional Programming: [<FontIcon icon="fa-brands fa-wikipedia-w"/>Functional Programming](https://en.wikipedia.org/wiki/Functional_programming)
