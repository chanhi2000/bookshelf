...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/freecodecamp.org/how-to-work-with-collections-in-go-using-the-standard-library-helpers/
...
For the complete list of string functions consult the [<FontIcon icon="fa-brands fa-golang"/>strings package documentation](https://pkg.go.dev/strings).
...
For the complete list of byte slice functions consult the [<FontIcon icon="fa-brands fa-golang"/>bytes package documentation](https://pkg.go.dev/bytes).
...
Reflection is a deep topic. For more details, see the [<FontIcon icon="fa-brands fa-golang"/>reflect package documentation](https://pkg.go.dev/reflect).
...
```component VPCard
{
  "title": "How to Work with Collections in Go Using the Standard Library Helpers",
  "desc": "In a previous article—Arrays, Slices, and Maps in Go: a Quick Guide to Collection Types—we explored Go's three built-in collection types and how they work under the hood. That gave us the foundation for storing and accessing data efficiently. But in ...",
  "link": "https://chanhi2000.github.io/bookshelf/freecodecamp.org/how-to-work-with-collections-in-go-using-the-standard-library-helpers.html",
  "logo": "https://cdn.freecodecamp.org/universal/favicons/favicon.ico",
