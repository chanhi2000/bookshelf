...
You can learn more about prototypes and inheritance in JavaScript in the following [post](/freecodecamp.org/prototypes-and-inheritance-in-javascript.md) by [Germán Cocca (<FontIcon icon="fa-brands fa-free-code-camp"/>`gercocca`)](https://freecodecamp.org/news/author/gercocca/).
