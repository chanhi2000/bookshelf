...
Instead of providing a brief explanation, I think you should learn it in detail and understand it fully. Read the [<FontIcon icon="fa-brands fa-firefox"/>MDN Docs](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Event_loop) to understand event loop in detail, with the help of diagram.
