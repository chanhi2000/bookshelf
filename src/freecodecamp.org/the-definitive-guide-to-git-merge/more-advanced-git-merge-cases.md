...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/freecodecamp.org/the-definitive-guide-to-git-merge/more-advanced-git-merge-cases.html
date: 2023-04-28
isOriginal: false
author:
  - name: Omer Rosenbaum
...
In this case, John creates the first version of this song in the <FontIcon icon="fas fa-code-branch"/>`main` branch:
...
![The contents of `everyone.md` prior to the first commit<br/><Source: [<FontIcon icon="fa-brands fa-youtube"/>Brief](https://youtu.be/BCNZ5Uxctuk&t=561s)>](https://freecodecamp.org/news/content/images/2023/04/image-273.png)
...
![Introducing "Commit 10"<br/><Source: [<FontIcon icon="fa-brands fa-youtube"/>Brief](https://youtu.be/BCNZ5Uxctuk&t=561s)>](https://freecodecamp.org/news/content/images/2023/04/image-275.png)
...
![Paul added a new verse in the beginning<br/><Source: [<FontIcon icon="fa-brands fa-youtube"/>Brief](https://youtu.be/BCNZ5Uxctuk&t=561s)>](https://freecodecamp.org/news/content/images/2023/04/image-276.png)
...
You can observe Paul's changes, by comparing this branch's state to the state of branch <FontIcon icon="fas fa-code-branch"/>`main`:

```sh
git diff main
```

![The output of `git diff main` from Paul's branch<br/><Source: [<FontIcon icon="fa-brands fa-youtube"/>Brief](https://youtu.be/BCNZ5Uxctuk&t=561s)>](https://freecodecamp.org/news/content/images/2023/04/image-277.png)
...
Now back to <FontIcon icon="fas fa-code-branch"/>`main`...
...
![The output of `git diff main` from John's branch<br/><Source: [<FontIcon icon="fa-brands fa-youtube"/>Brief](https://youtu.be/BCNZ5Uxctuk&t=561s)>](https://freecodecamp.org/news/content/images/2023/04/image-278.png)
...
![The output of `git diff main paul_branch_3`<br/><Source: [<FontIcon icon="fa-brands fa-youtube"/>Brief](https://youtu.be/BCNZ5Uxctuk&t=561s)>](https://freecodecamp.org/news/content/images/2023/04/image-277.png)
...
![Applying the patch failed<br/><Source: [<FontIcon icon="fa-brands fa-youtube"/>Brief](https://youtu.be/BCNZ5Uxctuk&t=561s)>](https://freecodecamp.org/news/content/images/2023/04/image-280.png)
...
Now we can take the patches we generated from the diffs on both branches, and apply them to <FontIcon icon="fas fa-code-branch"/>`main`. Would that work?
...
![The output of `git diff main john_branch_3`<br/><Source: [<FontIcon icon="fa-brands fa-youtube"/>Brief](https://youtu.be/BCNZ5Uxctuk&t=561s)>](https://freecodecamp.org/news/content/images/2023/04/image-278.png)
...
And I want to apply this patch on <FontIcon icon="fas fa-code-branch"/>`main`, so:
...
![The contents of `everyone.md` after applying John's patch<br/><Source: [<FontIcon icon="fa-brands fa-youtube"/>Brief](https://youtu.be/BCNZ5Uxctuk&t=561s)>](https://freecodecamp.org/news/content/images/2023/04/image-282.png)

The line changed as expected. Nice 😎

Now, can Git apply Paul's patch? To remind you, this is the patch:

![The contents of Paul's patch<br/><Source: [<FontIcon icon="fa-brands fa-youtube"/>Brief](https://youtu.be/BCNZ5Uxctuk&t=561s)>](https://freecodecamp.org/news/content/images/2023/04/image-283.png)
...
What you tried to do now, applying Paul's patch on <FontIcon icon="fas fa-code-branch"/>`main` branch after applying John's patch, is the same as being on `john_branch_3`, and attempting to apply the patch, that is:
...
![The contents of `everyone.md` on `paul_branch_3`<br/><Source: [<FontIcon icon="fa-brands fa-youtube"/>Brief](https://youtu.be/BCNZ5Uxctuk&t=561s)>](https://freecodecamp.org/news/content/images/2023/04/image-285.png)

And this is John's patch:

![The contents of John's patch<br/><Source: [<FontIcon icon="fa-brands fa-youtube"/>Brief](https://youtu.be/BCNZ5Uxctuk&t=561s)>](https://freecodecamp.org/news/content/images/2023/04/image-286.png)
...
![Git fails to apply John's patch<br/><Source: [<FontIcon icon="fa-brands fa-youtube"/>Brief](https://youtu.be/BCNZ5Uxctuk&t=561s)>](https://freecodecamp.org/news/content/images/2023/04/image-287.png)
...
![You can get more information by using the `-v` flag<br/><Source: [<FontIcon icon="fa-brands fa-youtube"/>Brief](https://youtu.be/BCNZ5Uxctuk&t=561s)>](https://freecodecamp.org/news/content/images/2023/04/image-288.png)
...
![Applying with `-3` flag succeeds<br/><Source: [<FontIcon icon="fa-brands fa-youtube"/>Brief](https://youtu.be/BCNZ5Uxctuk&t=561s)>](https://freecodecamp.org/news/content/images/2023/04/image-289.png)

And let's consider the result:

![The contents of `everyone.md` after ther merge<br/><Source: [<FontIcon icon="fa-brands fa-youtube"/>Brief](https://youtu.be/BCNZ5Uxctuk&t=561s)>](https://freecodecamp.org/news/content/images/2023/04/image-290.png)
