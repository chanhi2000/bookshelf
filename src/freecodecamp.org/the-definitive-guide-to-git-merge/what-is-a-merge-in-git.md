...
![Commit graph with two pointers<br/><Source: [<FontIcon icon="fa-brands fa-youtube"/>Brief](https://youtu.be/ZS4stBVdDII&)>](https://freecodecamp.org/news/content/images/2023/04/image-140.png)

You see the branch <FontIcon icon="fas fa-code-branch"/>`feature_1`, which points to a commit with the SHA-1 value of `ba0d2`. Of course, as in other posts, I only write the first 5 digits of the SHA-1 value.
