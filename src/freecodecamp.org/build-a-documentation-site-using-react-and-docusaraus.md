...
We can edit to ensure that all the headings show up. To do this, first create a <FontIcon icon="fa-brands fa-markdown"/>`table-of-contents.md`, then paste in the following Markdown:
