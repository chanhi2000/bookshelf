...
Next, create the timer unit file <FontIcon icon="fas fa-folder-open"/>`/etc/systemd/system/`<FontIcon icon="fas fa-file-lines"/>`my-custom-task.timer`. This timer will activate our service every 5 minutes.
