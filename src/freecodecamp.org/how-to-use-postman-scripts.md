...
- The [<FontIcon icon="iconfont icon-postman"/>Postman API client](https://postman.com/downloads/) installed on your computer
...
If you don’t have a backend application setup, I created one that you can clone from GitHub at [<FontIcon icon="iconfont icon-github"/>`orimdominic/freeCodeCamp-postman-api-jwt`](https://github.com/orimdominic/freeCodeCamp-postman-api-jwt).
...
For guides on writing assertion tests for your APIs, check out the [<FontIcon icon="iconfont icon-postman"/>Test API Functionality and Performance in Postman](https://learning.postman.com/docs/tests-and-scripts/test-apis/test-apis/) guide by Postman.
