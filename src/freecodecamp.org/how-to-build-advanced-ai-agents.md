...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/freecodecamp.org/how-to-build-advanced-ai-agents.html
...
Looking to get hands-on with AI? We just posted a comprehensive course on the [<FontIcon icon="fa-brands fa-free-code-camp"/>freeCodeCamp.org](http://freeCodeCamp.org) YouTube channel designed to help you build powerful AI agent applications. Led by Cerebras growth engineer Sarah Chieng alongside industry experts from Exa, LangChain, and LiveKit, this 3-part series is has everything you need to get started with real-world AI use cases.

Cerebras provided a grant to make this course possible. Cerebras creates chips that are built on a custom wafer-sized AI processor and are 20X faster than GPUs. You can get a free Cerebras API key at [<FontIcon icon="fas fa-globe"/>cloud.cerebras.ai?referral_code=freecodecamp](https://cloud.cerebras.ai?referral_code=freecodecamp).
...
<SiteInfo
  ...
  url="https://inference-docs.cerebras.ai/cookbook/agents/build-your-own-perplexity#build-your-own-perplexity-with-exa/"
  logo="https://inference-docs.cerebras.ai/mintlify-assets/_mintlify/favicons/cerebras-inference/FcAuEx9Fi3BOAJGk/_generated/favicon-dark/favicon.ico"
...
Watch the full course on [<FontIcon icon="fa-brands fa-youtube"/>the freeCodeCamp.org YouTube channel](https://youtu.be/B0TJC4lmzEM) (1-hour watch).
...
```component VPCard
{
  "title": "How to Build Advanced AI Agents",
  "desc": "Looking to get hands-on with AI? We just posted a comprehensive course on the freeCodeCamp.org YouTube channel designed to help you build powerful AI agent applications. Led by Cerebras growth engineer Sarah Chieng alongside industry experts from Exa...",
  "link": "https://chanhi2000.github.io/bookshelf/freecodecamp.org/how-to-build-advanced-ai-agents.html",
  "logo": "https://cdn.freecodecamp.org/universal/favicons/favicon.ico",
