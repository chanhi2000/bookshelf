...
Branches are used to isolate your changes from the main codebase (usually called <FontIcon icon="fas fa-code-branch"/>`main` or <FontIcon icon="fas fa-code-branch"/>`master`).
#### - *ull Request (PR)
