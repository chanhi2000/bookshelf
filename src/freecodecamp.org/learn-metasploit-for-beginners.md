...
One of the most commonly used payloads is <FontIcon icon="fas fa-folder-open"/>`windows/meterpreter/reverse_tcp`, which gives you a command shell on the target system.
