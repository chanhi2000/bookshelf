...
I also uploaded a YouTube series covering this post — you are welcome to watch it [<FontIcon icon="fa-brands fa-youtube"/>here](https://youtube.com/playlist?list=PL9lx0DXCC4BNUby5H58y6s2TQVLadV8v7).
...
**Thanks for reading!** If you enjoyed this article, you can read more on this topic on the [<FontIcon icon="fas fa-globe"/>swimm.io blog](http://swimm.io/).
