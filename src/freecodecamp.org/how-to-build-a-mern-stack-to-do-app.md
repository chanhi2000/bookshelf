...
In your backend folder, create a <FontIcon icon="fas fa-file-lines"/>`.env` file and add the following:
...
This <FontIcon icon="iconfont icon-json"/>`package.json` file configures the application by defining:
