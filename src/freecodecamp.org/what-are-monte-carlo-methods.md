...
![Photo by [<FontIcon icon="fas fa-globe"/>veeterzy on Pexels](https://pexels.com/photo/green-leafed-tree-38136/)≈](https://freecodecamp.org/news/content/images/2024/07/2.jpg)
...
![Photo by [<FontIcon icon="fas fa-globe"/>Jonathan Petersson on Pexels](https://pexels.com/photo/photo-of-two-red-dices-965879/)≈](https://freecodecamp.org/news/content/images/2024/07/pexels.jpg)
...
They are based on the mathematical idea of the [<FontIcon icon="fas fa-globe"/>Law of large numbers](https://investopedia.com/terms/l/lawoflargenumbers.asp) in probability theory:

::: info (<FontIcon icon="fas fa-globe"/><code>investopedia.com</code>)
...
Monte Carlo methods, named after the [<FontIcon icon="fas fa-globe"/>Monte Carlo Casino in Monaco](https://montecarlosbm.com/en/casino-monaco/casino-monte-carlo), were coined by mathematicians during the 1940s Manhattan Project.

[<FontIcon icon="fas fa-globe"/>Stanislaw Ulam](https://britannica.com/biography/Stanislaw-Ulam), [<FontIcon icon="fas fa-globe"/>John von Neumann](https://britannica.com/biography/John-von-Neumann), and others were involved in this project, which developed the American nuclear bomb.
...
![Photo from [<FontIcon icon="fas fa-globe"/>Pixabay](https://pexels.com/photo/close-up-photography-of-computer-motherboard-163125/)≈](https://freecodecamp.org/news/content/images/2024/07/circuit.jpg)
...
![Photo from [<FontIcon icon="fas fa-globe"/>Pixabay](https://pexels.com/photo/white-rocket-2159/)≈](https://freecodecamp.org/news/content/images/2024/07/rocket.jpg)
...
![Photo by [<FontIcon icon="fas fa-globe"/>energepic.com](https://pexels.com/photo/close-up-photo-of-monitor-159888/)≈](https://freecodecamp.org/news/content/images/2024/07/finance.jpg)
...
Monte Carlo methods are used to [<FontIcon icon="fas fa-globe"/>simulate](https://quantconnect.com/learning/articles/introduction-to-options/stochastic-processes-and-monte-carlo-method) how good a portfolio is at maximizing returns while minimizing risk under various market conditions.
...
- [<FontIcon icon="iconfont icon-tensorflow"/>TensorFlow](https://tensorflow.org/): Building and training machine learning models
- [<FontIcon icon="iconfont icon-tensorflow"/>TensorFlow Probability](https://tensorflow.org/probability): Probabilistic reasoning and statistical modeling
