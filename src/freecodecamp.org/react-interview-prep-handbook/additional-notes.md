...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/freecodecamp.org/react-interview-prep-handbook/additional-notes.html
date: 2024-10-11
isOriginal: false
author:
  - name: Kunal Nalawade
...
Also, it's helpful to have a few React projects on your resume. Check out the [Master React by Building 25 Projects](/freecodecamp.org/master-react-by-building-25-projects.md).
...
```component VPCard
{
  ...
  "link": "/freecodecamp.org/master-react-by-building-25-projects.md",
  "logo": "https://cdn.freecodecamp.org/universal/favicons/favicon.ico",
  "background": "rgba(10,10,35,0.2)"
}
```
