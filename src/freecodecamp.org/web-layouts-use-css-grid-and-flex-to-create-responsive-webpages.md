...
Check it out on Codepen [here (<FontIcon icon="fa-brands fa-codepen"/>`ophyboamah`)](https://codepen.io/ophyboamah/pen/KKRLoJr).
...
2. Within your project folder, create <FontIcon icon="fa-brands fa-html5"/>`index.html` and <FontIcon icon="fa-brands fa-css3-alt"/>`style.css` files.
3. Create an asset folder to store images.
4. Within your <FontIcon icon="fa-brands fa-html5"/>`index.html` file, create your HTML boilerplate and link your CSS file and font URL within the `<head>` tag.
