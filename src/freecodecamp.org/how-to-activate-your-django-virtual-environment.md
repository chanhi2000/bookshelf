...
This creates a folder called <FontIcon icon="fas fa-folder-open"/>`venv/` in your project directory. That folder contains everything your virtual environment needs.
