...
description: "Article(s) > CSS Framework for Parts Giant"
...
head:
  - - meta:
    - property: og:title
      content: "Article(s) > CSS Framework for Parts Giant"
    - property: og:description
      content: "CSS Framework for Parts Giant"
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/dbushell.com/css-framework-for-partsgiant.html
...
<SiteInfo
  name="CSS Framework for Parts Giant"
  desc="CSS Framework for Parts Giant"
  url="https://dbushell.com/2016/01/04/css-framework-for-partsgiant/"
...
I’ve completed a [**new component library**](/dbushell.com/new-component-library-for-parts-giant.md) project that will replace this work.

:::

## Original Article

[<VPIcon icon="fas fa-globe"/>Parts Giant](https://partsgiant.com/) is a soon to launch e-commerce store based in Michigan, USA.
...
![Parts Giant Designs](https://dbushell.com/images/portfolio/partsgiant-designs.png)
...
I started coding the typographic elements. This is usually a simple task but a vital ingredient. The client gave me freedom to adapt the designs to ensure consistency. I documented each component with HTML examples to show structure and CSS class names. I find a [<VPIcon icon="fas fa-globe"/>BEM](http://csswizardry.com/2015/08/bemit-taking-the-bem-naming-convention-a-step-further/)-like naming convention most usable.

![Button component - Parts Giant CSS Framework](https://dbushell.com/images/portfolio/partsgiant-buttons.png)
...
![Dropdown component - Parts Giant CSS Framework](https://dbushell.com/images/portfolio/partsgiant-dropdowns.png)

![Search component - Parts Giant CSS Framework](https://dbushell.com/images/portfolio/partsgiant-search.png)

The primitive components like the *Button* allowed for rapid development of similar use cases:

![Sorting component - Parts Giant CSS Framework](https://dbushell.com/images/portfolio/partsgiant-sorting.png)

Products are listed across the [<VPIcon icon="fas fa-globe"/>Parts Giant](https://partsgiant.com/) website with varying amounts of content. I created one *Product* component whose children can be added or removed depending on use. The *Stars* and *Rating* sub-components were abstracted for use elsewhere.

![Product component - Parts Giant CSS Framework](https://dbushell.com/images/portfolio/partsgiant-products.png)
...
![Parts Giant Admin Design](https://dbushell.com/images/portfolio/partsgiant-admin.png)
...
![Parts Giant Mobile Design](https://dbushell.com/images/portfolio/partsgiant-mobile.png)
...
I coded each component as a [<VPIcon icon="fa-brands fa-saas"/>Sass](http://sass-lang.com/) include (in separate files) so nothing was duplicated. An update to the *Button* for example would update both the responsive and mobile frameworks.
...
A big decision early on was to decide whether or not to build upon an existing ‘framework’ like [<VPIcon icon="fas fa-globe"/>Bootstrap](http://getbootstrap.com/). As of v3.3.6 Bootstrap’s base CSS is 146KB alone — my final stylesheet was only 1KB larger. Had I built upon Bootstrap it would have been upwards of 250KB. It would also have been near impossible to achieve the 54KB slimline framework I developed for mobile.
...
```component VPCard
{
  "title": "CSS Framework for Parts Giant",
  "desc": "CSS Framework for Parts Giant",
  "link": "https://chanhi2000.github.io/bookshelf/dbushell.com/css-framework-for-partsgiant.html",
  "logo": "https://dbushell.com/assets/icons/favicon.svg",
