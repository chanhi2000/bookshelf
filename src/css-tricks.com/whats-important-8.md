...
Also, do you happen to remember [Temani’s demo (<VPIcon icon="fa-brands fa-codepen" />`t_afif`)](https://codepen.io/t_afif/pen/wBWWKxP) that I shared a few weeks ago? Well, Frontend Masters have published [**the tutorial for that**](/blog.master.dev/two-circles-one-arrow-and-anchor-positioning.md) too!
