...
description: "Article(s) > Using Scroll-Driven Animations for Opposing Scroll Directions"
...
head:
  - - meta:
    - property: og:title
      content: "Article(s) > Using Scroll-Driven Animations for Opposing Scroll Directions"
    - property: og:description
      content: "Using Scroll-Driven Animations for Opposing Scroll Directions"
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/css-tricks.com/scroll-driven-animations-opposing-scroll-directions.html
...
cover: https://i0.wp.com/css-tricks.com/wp-content/uploads/2026/05/opposing-scroll-columns.webp
---
...
<SiteInfo
  name="Using Scroll-Driven Animations for Opposing Scroll Directions"
  desc="Sometimes designers have silly ideas that eventually grow on you. That happened to me with this concept where I had to build columns of items moving in"
  url="https://css-tricks.com/scroll-driven-animations-opposing-scroll-directions"
  logo="https://css-tricks/favicon.svg"
  preview="https://i0.wp.com/css-tricks.com/wp-content/uploads/2026/05/opposing-scroll-columns.webp"/>
...
<CodePen
  link="https://codepen.io/editor/CiTA/pen/019dcdfc-1e41-77c8-afdf-810ebc6f2480"
  title="Opposing scroll effects (desktop) / infinite scroll effect (mobile)"
...
It’s really not as hard as you might think, thanks to modern CSS features, specifically [**scroll-driven animations**](/css-tricks.com/scroll-driven-scroll-triggered-scroll-states-and-view-transitions.md). Not only that, but it’s fun to make, too! Let me show you how I approached it — and maybe you will want to share how you would do it differently.
...
<VidStack src="https://css-tricks.com/wp-content/uploads/2026/05/opposing-scrolling-logos.mov" />
...
![Highlighting the vertical space between the parent container and its child elements.](https://i0.wp.com/css-tricks.com/wp-content/uploads/2026/05/scrolling-parent-column-margin.webp?resize=1937%2C1244&ssl=1)
...
![Highlighting the vertical space between the parent container and its before pseudo element.](https://i0.wp.com/css-tricks.com/wp-content/uploads/2026/05/scrolling-parent-pseudo-margin.webp?resize=1937%2C1244&ssl=1)
...
We can define all that with the [**`flex`**](/css-tricks.com/almanac-properties/flex.md) shorthand property:
...
We have two supported functions here, [**`scroll()`**](/css-tricks.com/almanac-functions/scroll.md) and [**`view()`**](/css-tricks.com/almanac-functions/view.md). They’re related but super different in that `scroll()` runs the animation based on an element’s scroll *position*. The `view()` function is similar, but tracks the element’s progress as it enters and exits the [<VPIcon icon="iconfont icon-w3c"/>scrollport](https://drafts.csswg.org/css-overflow-3/#scrollport) (i.e., the scrollable area of the container it is in).
...
While we’re at it, we should disable the animations to [**respect the user’s settings for reduced motion**](/css-tricks.com/almanac-rules/media.md#prefers-reduced-motion) (and remove the mask, otherwise it might look weird):
...
```component VPCard
{
  "title": "Using Scroll-Driven Animations for Opposing Scroll Directions",
  "desc": "Sometimes designers have silly ideas that eventually grow on you. That happened to me with this concept where I had to build columns of items moving in",
  "link": "https://chanhi2000.github.io/bookshelf/css-tricks.com/scroll-driven-animations-opposing-scroll-directions.html",
  "logo": "https://css-tricks/favicon.svg",
