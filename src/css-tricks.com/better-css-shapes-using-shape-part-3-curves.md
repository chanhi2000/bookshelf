...
If you want a good follow-up to this article, [**I wrote an article for Frontend Masters**](/frontendmasters.com/creating-blob-shapes-using-clip-path-shape.md) where you can create blob shapes using the `curve` command.
