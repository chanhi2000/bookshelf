...
Until the next article, [**I wrote an article for Frontend Masters**](/frontendmasters.com/creating-flower-shapes-using-clip-path-shape.md) where you can create more fancy shapes using the `arc` command that is a good follow-up to this one.
