---
lang: en-US
title: "A Scrollytelling Gift for Mum on Mother’s Day 2026"
description: "Article(s) > A Scrollytelling Gift for Mum on Mother’s Day 2026"
...
head:
  - - meta:
    - property: og:title
      content: "Article(s) > A Scrollytelling Gift for Mum on Mother’s Day 2026"
    - property: og:description
      content: "A Scrollytelling Gift for Mum on Mother’s Day 2026"
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/css-tricks.com/a-scrollytelling-gift-for-mum-on-mothers-day-2026.html
...
cover: https://i0.wp.com/css-tricks.com/wp-content/uploads/2026/05/lee-mothers-day.jpg
---
...
<SiteInfo
  name="A Scrollytelling Gift for Mum on Mother’s Day 2026"
  desc="I will explain how my mum inspired this 2026 Mother’s Day scrollytelling experiment — but also, how she inspired my approach to dev and life."
  url="https://css-tricks.com/a-scrollytelling-gift-for-mum-on-mothers-day-2026"
  logo="https://css-tricks/favicon.svg"
  preview="https://i0.wp.com/css-tricks.com/wp-content/uploads/2026/05/lee-mothers-day.jpg"/>
...
I will explain how my mum inspired this 2026 Mother’s Day scrollytelling experiment — but also, how she inspired my approach to dev and life. Along the way, I’ll discuss some of the tech involved in this virtual Mother’s Day gift. I normally write either [<VPIcon icon="iconfont icon-css-tricks"/>inspirational or technical posts](https://css-tricks.com/author/leemeyer/) — but for Mother’s Day, you’re getting a twofer.

---

## Try the interactive Mother’s Day card

Here’s the CodePen, which uses [<VPIcon icon="fa-brands fa-firefox"/>scroll-snap events](https://developer.mozilla.org/en-US/docs/Web/CSS/Guides/Scroll_snap/Using_scroll_snap_events) and [<VPIcon icon="fa-brands fa-firefox"/>scroll-state queries](https://developer.mozilla.org/en-US/docs/Web/CSS/Guides/Conditional_rules/Container_scroll-state_queries), so it will only work in Chromium-based browsers at the moment.

<CodePen
  user="anon"
  slug-hash="OPbyPXo"
  title="A Scrollytelling Mother's Day Gift 2026"
...
<VidStack src="youtube/gu2cj9zO00s" />
...
When Mum was born, she wasn’t breathing. The staff immersed her in cold water, then hot, then cold water again — [<VPIcon icon="fas fa-globe"/>a so-called remedy at the time based on no science](https://pmc.ncbi.nlm.nih.gov/articles/PMC2672845/). This was the beginning of a larger pattern in her life: She kept surviving not because of the help she received, but despite chaos disguised as help.
...
![Preview of the interactive card. A woman with short brown hair at the right of the frame looking left into the lens of a large camera and standing in the middle of a lush flower garden. In loving memory of Anna Meyer, 1945-2011.](https://i0.wp.com/css-tricks.com/wp-content/uploads/2026/05/lee-mothers-day.jpg?resize=1024%2C765)

---

## Gamifying the experience of knowing my mum

I drew inspiration from Roland Franke’s [deconstructed radial slice transition using scroll-snap events (<VPIcon icon="fa-brands fa-codepen"/>`ROL4ND909`)](https://codepen.io/ROL4ND909/pen/MWMzbog). Roland’s Pen showcases eye-catching, scroll-triggered transitions between landscapes as a figure sits in the foreground watching. This made me think of the patience my mum put into observing the world—but then she’d encapsulate everything in short, interactive stories I could digest as a young child.

I’m symbolizing that experience in my Mother’s Day game with the scroll-triggered [<VPIcon icon="fa-brands fa-youtube"/>time-lapse](https://youtube.com/watch?v=kQM6Q9Axyx0) animation of day to night, stylized with CSS shapes. Using a single scroll gesture, we grasp the gist of an entire day. That experience is like the way my mum could explain a big topic to me in a way that felt like play.

My mum taught me that video games don’t have to be about blowing things up. She once used [<VPIcon icon="fa-brands fa-wikipedia-w"/><VPIcon icon="fa-brands fa-youtube"/>QuickBASIC](https://en.wikipedia.org/wiki/QuickBASIC) to build a photography game long before [<VPIcon icon="fa-brands fa-wikipedia-w"/><VPIcon icon="fa-brands fa-youtube"/>Pokémon Snap](https://en.wikipedia.org/wiki/Pok%C3%A9mon_Snap) existed. I remember passing a shop in the 90s with [<VPIcon icon="fa-brands fa-youtube"/>Armor Alley](https://youtu.be/QHWHCOe4Vbk) playing in demo mode in the window. I was obviously fascinated, but my mum said, “I don’t like it. The helicopter started it,” then she went home and built her photography game for me to play instead.
...
The combination of deterministic scroll-triggered animations with the randomness of the UFOs and text physics is possible using alien technology I’ve not seen used much in the wild: [<VPIcon icon="fa-brands fa-youtube"/><VPIcon icon="fa-brands fa-firefox"/>scroll-snap events](https://developer.mozilla.org/en-US/docs/Web/CSS/Guides/Scroll_snap/Using_scroll_snap_events). This emergent module — available [<VPIcon icon="iconfont icon-caniuse"/>only in Chrome and Opera at the time of writing](https://caniuse.com/wf-scroll-snap-events) — provides a simple JavaScript API so that when we style the page to snap between the day and night scenes, we can trigger behavior that isn’t possible in CSS alone, like the random flight paths of the UFOs, and the [<VPIcon icon="fa-brands fa-youtube"/>Pretext](https://youtu.be/CUAuy5SWJcw)-inspired effect of the UFOs repelling letters as the spaceships fly through the text.

::: note Sidenote

[**Randomness in CSS is coming**](/css-tricks.com/the-importance-of-native-randomness-in-css.md), but it only works in Safari for now.
...
```component VPCard
{
  "title": "A Scrollytelling Gift for Mum on Mother’s Day 2026",
  "desc": "I will explain how my mum inspired this 2026 Mother’s Day scrollytelling experiment — but also, how she inspired my approach to dev and life.",
  "link": "https://chanhi2000.github.io/bookshelf/css-tricks.com/a-scrollytelling-gift-for-mum-on-mothers-day-2026.html",
  "logo": "https://css-tricks/favicon.svg",
