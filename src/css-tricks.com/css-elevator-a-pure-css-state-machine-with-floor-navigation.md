...
Displaying floor numbers elegantly became a joy thanks to [<FontIcon icon="iconfont icon-css-tricks"/>CSS counters](https://css-tricks.com/almanac/functions/c/counters/):
