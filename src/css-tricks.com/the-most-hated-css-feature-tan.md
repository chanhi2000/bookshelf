...
- In fact, Temani is a great source of trigonometric examples! You’ll see `tan()` pop up in many of the things he makes, like [**flower shapes**](/blog.master.dev/creating-flower-shapes-using-css-mask-trigonometric-functions.md) or [**modern breadcrumbs**](/css-tip.com/border-only-breadcrumb.md).
