...
lang: ko-KR
title: Hardware
description: Article(s) > Hardware
...
head:
  - - meta:
    - property: og:title
      content: Article(s) > Hardware
    - property: og:description
      content: Hardware
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/onceupon.github.io/hardware.html
