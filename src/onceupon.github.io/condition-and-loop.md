...
description: Article(s) > Condition and loop
...
head:
  - - meta:
    - property: og:title
      content: Article(s) > Condition and loop
    - property: og:description
      content: Condition and loop
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/onceupon.github.io/condition-and-loop.html
