---
lang: en-US
title: "An Introduction to Queries in MySQL"
description: "Article(s) > An Introduction to Queries in MySQL"
icon: 
category:
  - Data Science
  - MySQL
...
head:
  - - meta:
    - property: og:title
      content: "Article(s) > An Introduction to Queries in MySQL"
    - property: og:description
      content: "An Introduction to Queries in MySQL"
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/digitalocean.com/introduction-to-queries-mysql.html
prev: /data-science/mysql/articles/README.md
date: 2018-10-18
isOriginal: false
author: 
  - name: Mark Drake
    url: https://digitalocean.com/community/users/mdrake
cover: https://community-cdn-digitalocean-com.global.ssl.fastly.net/A1yh18RjS3ZAndXgXZ3ao3J5
---
...
<SiteInfo
  name="An Introduction to Queries in MySQL"
  desc="In this guide, we will discuss the basic syntax of SQL queries as well as some of the more commonly-employed functions and operators. We will also practice m… "
  url="https://digitalocean.com/community/tutorials/introduction-to-queries-mysql"
  logo="https://digitalocean.com/_next/static/media/favicon.594d6067.ico"
  preview="https://community-cdn-digitalocean-com.global.ssl.fastly.net/A1yh18RjS3ZAndXgXZ3ao3J5"/>
...
[<VPIcon icon="iconfont icon-mysql"/>MySQL](https://mysql.com/) is an open-source relational database management system. One of the most widely-deployed SQL-databases, MySQL prioritizes speed, reliability, and usability. It generally follows the ANSI SQL standard, although there are a few cases where MySQL performs operations differently than the recognized standard.
...
- An Ubuntu 18.04 machine with a non-root user with sudo privileges. This can be set up using our [**Initial Server Setup guide for Ubuntu 18.04**](/digitalocean.com/initial-server-setup-with-ubuntu-18-04).
- MySQL installed on the machine. Our guide on [**How to Install MySQL on Ubuntu 18.04**](/digitalocean.com/how-to-install-mysql-on-ubuntu-18-04.md) can help you set this up.
...
If you followed the prerequisite the tutorial on [**Installing MySQL on Ubuntu 18.04**](/digitalocean.com/how-to-install-mysql-on-ubuntu-18-04.md), you may have configured your **root** user to authenticate using a password. In this case, you will connect to the MySQL prompt with the following command:
...
Issuing queries is one of the most commonly-performed tasks within the realm of database management. There are a number of database administration tools, such as [phpMyAdmin](https://phpmyadmin.net/) or [<VPIcon icon="iconfont icon-postgresql"/>pgAdmin](https://pgadmin.org/), that allow you to perform queries and visualize the results, but issuing `SELECT` statements from the command line is still a widely-practiced workflow that can also provide you with greater control.

If you’re new to working with SQL, we encourage you to use our [SQL Cheat Sheet](/digitalocean.com/how-to-manage-sql-database-cheat-sheet) as a reference and to review the [<VPIcon icon="iconfont icon-mysql"/>official MySQL documentation](https://dev.mysql.com/doc/refman/5.7/en/). Additionally, if you’d like to learn more about SQL and relational databases, the following tutorials may be of interest to you:

- [**Understanding SQL And NoSQL Databases And Different Database Models**](/digitalocean.com/understanding-sql-and-nosql-databases-and-different-database-models.md)
- [**How To Create a Multi-Node MySQL Cluster on Ubuntu 18.04**](/digitalocean.com/how-to-create-a-multi-node-mysql-cluster-on-ubuntu-18-04.md)
- [**How To Reset Your MySQL or MariaDB Root Password on Ubuntu 18.04**](/digitalocean.com/how-to-reset-your-mysql-or-mariadb-root-password-on-ubuntu-18-04.md)
...
```component VPCard
{
  "title": "An Introduction to Queries in MySQL",
  "desc": "In this guide, we will discuss the basic syntax of SQL queries as well as some of the more commonly-employed functions and operators. We will also practice m… ",
  "link": "https://chanhi2000.github.io/bookshelf/digitalocean.com/introduction-to-queries-mysql.html",
  "logo": "https://digitalocean.com/_next/static/media/favicon.594d6067.ico",
