...
![<출처: [<VPIcon icon="fas fa-globe"/>mashable](https://mashable.com/article/openai-announcement-gpt4o-voice-assistant)>](https://yozm.wishket.com/media/news/2641/image4.png)
...
![멀티모달 자율주행 아키텍처 <출처: [<VPIcon icon="fas fa-globe"/>카이스트](https://ave.kaist.ac.kr:59676/sub2_2.php)>](https://yozm.wishket.com/media/news/2641/image5.png)
...
![이미지 캡셔닝 모델 <출처: [<VPIcon icon="fas fa-globe"/>analytics vidhya](https://analyticsvidhya.com/blog/2023/06/vision-transformers/)>](https://yozm.wishket.com/media/news/2641/image1.png)
...
![Stable Diffusion을 활용한 이미지 수정 <출처: [<VPIcon icon="fas fa-globe"/>the-decoder](https://the-decoder.com/stable-diffusion-google-shows-new-method-for-more-control/)>](https://yozm.wishket.com/media/news/2641/image2.png)
