...
마지막으로 가볍게 실제 서비스가 REST에서 GraphQL로 전환한 사례도 살펴보겠습니다. 깃허브는 지난 2016년에 GraphQL API를 공개하며, 전환 이유를 공식 [<VPIcon icon="iconfont icon-github"/>블로그 글](https://github.blog/developer-skills/github/the-github-graphql-api/)에서 상세히 설명했습니다.
...
이런 이유로 깃허브는 GraphQL을 도입했고, API 사용성을 크게 올릴 수 있었습니다. 깃허브의 실제 GraphQL API는 [<VPIcon icon="iconfont icon-github"/>공식 문서의 GraphQL API 문서](https://docs.github.com/en/graphql)에서 확인할 수 있죠. GraphQL 모범 사례를 함께 살펴볼 수 있는 가이드도 제공하고 있습니다. GraphQL 도입을 고민하고 있다면, 깃허브의 사례를 잘 살펴보면 도움이 될 것입니다.
