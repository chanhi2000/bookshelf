...
위에서 소개한 원칙은 클린 코드를 수행하는 알려진 많은 방법 중 가장 대표적인 예제였습니다. 더 자세한 내용은 Robert Martin의 Clean Code에 언급된 원칙 [<VPIcon icon="iconfont icon-github"/>요약](https://gist.github.com/wojteklu/73c6914cc446146b8b533c0988cf8d29)을 참고하세요.
