...
![<출처: [<VPIcon icon="fa-brands fa-microsoft"/>마이크로소프트](https://microsoft.github.io/autogen/0.2/docs/Getting-Started)>](https://yozm.wishket.com/media/news/2887/2__3_.png)
...
![현재는 제목 생성기 대신 ‘[<VPIcon icon="fas fa-globe"/>글쓰기 도구 모음’](https://llami.net/chat/lab?service=writing&writing-tab=report)으로 제공되고 있다.](https://yozm.wishket.com/media/news/2887/3__2_.png)
