...
스프링 부트 개발자라면, 대부분 로컬에서 애플리케이션을 코딩하고 실행하며 디버깅하고 테스트하고 싶을 것입니다. 이러한 이유로 [<FontIcon icon="fas fa-gobe"/>대퍼](https://diagrid.io/blog/cloud-native-local-development)는 테스트컨테이너팀과 협력하여 쿠버네티스 클러스터 없이 로컬에서 대퍼를 활용할 수 있는 개발 환경을 제공하게 되었습니다.
