...
> .<VPIcon icon="fa-brands fa-java"/>BFS.java

::: tabs

@tab:active <VPIcon icon="fa-brands fa-java"/>BFS(1/3)
...
@tab <VPIcon icon="fa-brands fa-java"/>BFS(2/3)
...
@tab <VPIcon icon="fa-brands fa-java"/>BFS(3/3)
...
> .<VPIcon icon="fa-brands fa-java"/>DFS.java

::: tabs

@tab:active <VPIcon icon="fa-brands fa-java"/>DFS(1/3)
...
@tab <VPIcon icon="fa-brands fa-java"/>DFS(2/3)
...
@tab <VPIcon icon="fa-brands fa-java"/>DFS(3/3)
