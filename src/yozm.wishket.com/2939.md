...
![5개의 자격증이 모이면 Credly에 등록되는 [<FontIcon icon="fas fa-globe"/>Kubestronaut](https://credly.com/badges/31d3b041-71e9-4371-93be-6156f9c89397/public_url)<br/><출처: 리눅스 재단>](https://wishket.com/media/news/2939/image5.png)

Kubestronaut은 2024년 초, 쿠버네티스 자격증 5개를 묶어 하나로 부르기 위해 만든 프로그램입니다. 해당 자격 인증을 취득하면 여러 가지 [<FontIcon icon="fas fa-globe"/>혜택](https://cncf.io/training/kubestronaut/)을 제공합니다.
...
![쿠버콘 인도 2024에서 kubestronaut 들과 함께 찍은 사진<br/><출처: [<FontIcon icon="fas fa-globe"/>CNCF](https://flickr.com/photos/143247548@N03/54210940523/in/album-72177720322649179)>](https://wishket.com/media/news/2939/image1.png)

---

## Golden Kubestronaut

지난 2024년 말, 쿠버콘 인도에서 CNCF는 이렇게 잘 운영되던 Kubestronaut에 이어 다른 여러 가지 자격증을 더한 [Golden Kubestronaut (<FontIcon icon="fa-brands fa-linkedin"/>`goldenkubestronaut`)](https://linkedin.com/company/goldenkubestronaut/) 프로그램을 공개했습니다.
