...
![<출처: [<FontIcon icon="iconfont icon-gcp"/>구글](https://cloud.google.com/architecture/mlops-continuous-delivery-and-automation-pipelines-in-machine-learning)>](https://yozm.wishket.com/media/news/2805/8.png)
