...
I hope that other browser vendors follow suit here, as this solves a real problem developers have been struggling with, and [**setting `overflow: hidden` on `html` as a workaround ain’t exactly cutting it**](/blog.master.dev/scroll-locked-dialogs.md).
