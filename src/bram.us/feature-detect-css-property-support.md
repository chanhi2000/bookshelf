...
A detection with broader support is to use a [**Space Toggle**](/bram.us/the-future-of-css-higher-level-custom-properties-to-control-multiple-declarations.md#css-variables-affect-multiple-declarations--space-toggle-trick). One downside is that it requires JavaScript to register the toggler because of differences between browsers.
