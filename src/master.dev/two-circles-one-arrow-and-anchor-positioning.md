...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/two-circles-one-arrow-and-anchor-positioning.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/9033
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/two-circles-one-arrow-and-anchor-positioning/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/9033"/>

In a previous series of articles, we studied a classic use case of anchor positioning: [**Tooltips**](/master.dev/perfectly-pointed-tooltips-a-foundation.md). In this article, we will explore a less common use case that is a great example of the power of this new feature and modern CSS in general.
...
In this demo, I am relying on a trick I am detailing in a previous article that I highly recommend you read: [**How to Get the Width/Height of Any Element in Only CSS**](/master.dev/how-to-get-the-width-height-of-any-element-in-only-css.md).
...
```component VPCard
{
  "title": "Two Circles, One Arrow, and Anchor Positioning",
  "desc": "Drawing an line with arrows pointing to the center of two arbitrary elements measuring and displaying the distance between them doesn't seem like it would be possible in CSS alone... but... ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/two-circles-one-arrow-and-anchor-positioning.html",
  "logo": "https://master.dev/favicon.ico",
