...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/you-might-not-need-that-framework.html
prev: /programming/js/articles/README.md
date: 2024-09-27
isOriginal: false
author:
  - name: Maximiliano Firtman
    url: https://master.dev/blog/author/maximilianofirtman/
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/4037
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/you-might-not-need-that-framework/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/4037"/>
...
```component VPCard
{
  ...
  "link": "/master.dev/vanilla-javascript-reactivity.md",
  "logo": "https://master.dev/favicon.ico",
...
```component VPCard
{
  "title": "You Might Not Need that Framework",
  "desc": "There are big tradeoffs, naturally, but vanilla JavaScript is very powerful, usable everywhere, lightweight, and high-performance. Learn it and use it when it's the best choice.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/you-might-not-need-that-framework.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
