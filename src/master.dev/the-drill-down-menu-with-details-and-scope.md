...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/the-drill-down-menu-with-details-and-scope.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/9143
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/the-drill-down-menu-with-details-and-scope/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/9143"/>
...
```component VPCard
{
  "title": "The Drill-Down Menu with Details and @scope",
  "desc": "Even if you nest details elements, you can ensure only one level of them is open at a time, making a menu you can drill down (and up!) from.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/the-drill-down-menu-with-details-and-scope.html",
  "logo": "https://master.dev/favicon.ico",
