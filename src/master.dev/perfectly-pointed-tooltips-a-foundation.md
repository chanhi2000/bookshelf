...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/perfectly-pointed-tooltips-a-foundation.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/7514
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/perfectly-pointed-tooltips-a-foundation/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/7514"/>
...
Here is a demo taken from another [**article**](/master.dev/custom-range-slider-using-anchor-positioning-scroll-driven-animations.md) where the anchor is the thumb of a slider and the tooltip is an `<output>` element:
...
```component VPCard
{
  "title": "Perfectly Pointed Tooltips: A Foundation",
  "desc": "The Anchor Positioning API in CSS is very powerful. This is the beginning of a series where we understand it through the perfect use-case: tooltips.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/perfectly-pointed-tooltips-a-foundation.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
