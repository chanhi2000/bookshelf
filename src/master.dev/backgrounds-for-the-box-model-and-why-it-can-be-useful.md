...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/backgrounds-for-the-box-model-and-why-it-can-be-useful.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/3716
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/backgrounds-for-the-box-model-and-why-it-can-be-useful/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/3716"/>
...
```component VPCard
{
  "title": "Backgrounds for the Box Model (and why it can be useful)",
  "desc": "You can limit how far the background-image of an element applies by using background-clip. That means you can apply *different* backgrounds to, say, the padding and border.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/backgrounds-for-the-box-model-and-why-it-can-be-useful.html",
  "logo": "https://master.dev/favicon.ico",
