...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/masonry-and-reading-order.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/2579
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/masonry-and-reading-order/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/2579"/>
...
```component VPCard
{
  "title": "Masonry and reading order",
  "desc": "Two months back there was a bit of a hubbub about masonry layout in CSS with Jen at Apple making a case and Rachel at Google agreeing those use cases would be great, but should be based on display: masonry; not display: grid;. Then: nothing. Web standards just move at the pace that it moves […]",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/masonry-and-reading-order.html",
  "logo": "https://master.dev/favicon.ico",
