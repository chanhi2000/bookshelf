...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/simple-typographic-email-template.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/4210
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/simple-typographic-email-template/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/4210"/>
...
```component VPCard
{
  "title": "An HTML Email Template with Basic Typography and Dark/Light Modes",
  "desc": "You can keep it chill and just use HTML email to apply a nice typeface, reign in the line length, use real links, and honor dark mode.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/simple-typographic-email-template.html",
  "logo": "https://master.dev/favicon.ico",
