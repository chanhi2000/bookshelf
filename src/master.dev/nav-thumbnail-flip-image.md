...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/nav-thumbnail-flip-image.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/8684
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/nav-thumbnail-flip-image/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/8684"/>
...
The next step is to use a `grid` layout for it, [**limit the width of the grid’s one column**](/master.dev/blog/super-simple-full-bleed-breakout-styles.md), and middle-align this grid within the element:
...
```component VPCard
{
  "title": "Lessons Learned from Failed Demos: Pure CSS Nav Thumb Flip on Scroll",
  "desc": "A list of items with thumbnails that flip into place as needed. Can we ditch the JavaScript?",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/nav-thumbnail-flip-image.html",
  "logo": "https://master.dev/favicon.ico",
