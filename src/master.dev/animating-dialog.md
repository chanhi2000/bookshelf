...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/animating-dialog.html
...
<SiteInfo
  ...
  url="https://master.dev/blog/animating-dialog"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/2341"/>
...
```component VPCard
{
  "title": "Animating the Dialog Element",
  "desc": "It might seem like you could just set a transition on the opacity of the dialog element in CSS from 0 to 1, but it doesn't work. You'll need to learn about @starting-style, and the overlay and allow-discrete keywords.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/animating-dialog.html",
  "logo": "https://master.dev/favicon.ico",
