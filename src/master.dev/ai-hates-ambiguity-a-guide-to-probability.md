...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/ai-hates-ambiguity-a-guide-to-probability.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/8618
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/ai-hates-ambiguity-a-guide-to-probability/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/8618"/>
...
2. **The Format Negotiation (Output Constraints):** Just as [**the browser struggles**](/master.dev/the-browser-hates-surprises.md) when elements load out of order, the AI struggles when it mixes conversational filler with code. We need to force a strict structure. The fix here is to include extra information in our prompts, to the tune of: *Return only the code block. Do not add introductory text. Ensure the code is strictly typed TypeScript.*
...
```component VPCard
{
  "title": "AI Hates Ambiguity: A Guide to Probability",
  "desc": "The more effort you put in to what you put in, the higher quality you're going to get out.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/ai-hates-ambiguity-a-guide-to-probability.html",
  "logo": "https://master.dev/favicon.ico",
