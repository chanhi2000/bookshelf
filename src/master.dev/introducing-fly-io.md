...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/introducing-fly-io.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/4742
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/introducing-fly-io/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/4742"/>
...
```component VPCard
{
  "title": "Introducing Fly.io",
  "desc": "If it can go in a Docker, Fly can host it, and they'll help you with that. Adam Rackis takes a look at the platform and shows off all the things he likes about it.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/introducing-fly-io.html",
  "logo": "https://master.dev/favicon.ico",
