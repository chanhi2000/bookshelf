...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/obscuring-text-with-counter-style.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/9889
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/obscuring-text-with-counter-style/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/9889"/>
...
```component VPCard
{
  "title": "Obscuring Text with @counter-style",
  "desc": "@counter-style is useful for replacing the ::marker of lists easily, but it controls any markers-of-counters, so we can use it for more.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/obscuring-text-with-counter-style.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
