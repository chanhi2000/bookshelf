...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/adaptive-alerts-a-css-scroll-state-use-case.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/6397
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/adaptive-alerts-a-css-scroll-state-use-case/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/6397"/>
...
Implementing something like this is relatively easy with the recent CSS scroll-state queries ([<VPIcon icon="fas fa-globe"/>browser support](https://master.dev/blog/wp-admin/post.php?post=6397&action=edit)).
...
```component VPCard
{
  "title": "Adaptive Alerts (a CSS scroll-state Use Case)",
  "desc": "A single button, but it has two different behaviors in JavaScript depending on how far you’ve scrolled in an element (as determined by CSS!)",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/adaptive-alerts-a-css-scroll-state-use-case.html",
  "logo": "https://master.dev/favicon.ico",
