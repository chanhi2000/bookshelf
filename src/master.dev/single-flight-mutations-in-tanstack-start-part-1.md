...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/single-flight-mutations-in-tanstack-start-part-1.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/8334
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/single-flight-mutations-in-tanstack-start-part-1/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/8334"/>
...
```component VPCard
{
  "title": "Single Flight Mutations in TanStack Start: Part 1",
  "desc": "What if we could mutate data *and* get all the data back we need to properly update the UI in just one network round-trip?",
  "link": "/master.dev/single-flight-mutations-in-tanstack-start-part-1.md",
  "logo": "https://master.dev/favicon.ico",
...
```component VPCard
{
  ...
  "link": "/master.dev/single-flight-mutations-in-tanstack-start-part-2.md",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
...
In my [**post on TanStack Start**](/master.dev/introducing-tanstack-start.md), I included this image, which is how client-driven single-page applications (SPAs) almost always behave.
...
```component VPCard
{
  "title": "Single Flight Mutations in TanStack Start: Part 1",
  "desc": "What if we could mutate data *and* get all the data back we need to properly update the UI in just one network round-trip?",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/single-flight-mutations-in-tanstack-start-part-1.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
