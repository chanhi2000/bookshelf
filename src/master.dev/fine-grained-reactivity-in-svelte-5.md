...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/fine-grained-reactivity-in-svelte-5.html
prev: /programming/js-svelte/articles/README.md
date: 2024-08-14
isOriginal: false
author: Adam Rackis
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/3438
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/fine-grained-reactivity-in-svelte-5"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/3438"/>
...
```component VPCard
{
  ...
  "link": "/master.dev/introducing-svelte-5.md",
  "logo": "https://master.dev/favicon.ico",
...
```component VPCard
{
  ...
  "link": "/master.dev/snippets-in-svelte-5.md",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
...
```component VPCard
{
  "title": "Fine-Grained Reactivity in Svelte 5",
  "desc": "Svelte is already quite lightweight and fast, but Svelte 5 still overs big improvements in fine-grained reactivity, meaning re-rendering as absolutely little as possible. ",
  "link": "/master.dev/fine-grained-reactivity-in-svelte-5.md",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
...
If you closely read my [**first post**](/master.dev/introducing-svelte-5.md#state)on Svelte 5, you might recall that you can’t directly return reactive state from a function, since the state will be read and unwrapped right at the call-site, and won’t be reactive any longer. Normally you’d have to do this:
...
```component VPCard
{
  "title": "Fine-Grained Reactivity in Svelte 5",
  "desc": "Svelte is already quite lightweight and fast, but Svelte 5 still overs big improvements in fine-grained reactivity, meaning re-rendering as absolutely little as possible. ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/fine-grained-reactivity-in-svelte-5.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
