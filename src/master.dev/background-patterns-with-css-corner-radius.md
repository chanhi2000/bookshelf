...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/background-patterns-with-css-corner-radius.html
prev: /programming/css/articles/README.md
date: 2026-02-09
isOriginal: false
author:
  - name: Preethi Sam
    url: https://master.dev/blog/author/preethisam/
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/8505
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/background-patterns-with-css-corner-radius/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/8505"/>

The `corner-shape` property in CSS can do some neat designs. [**Things like vintage tickets, with corners trimmed inwards**](/master.dev/drawing-css-shapes-using-corner-shape.md), [<VPIcon icon="fas fa-globe"/>sci-fi corners](https://daverupert.com/2025/07/sci-fi-rectangles-with-corner-shape/), tags, and those types of designs are usually comes to mind when we think of the CSS property `corner-shape`.

There are a variety of nice primitive keywords we get with `corner-shape`, like `round` (the default), `bevel`, `scoop`, `squircle`, and [**the all-powerful `superellipse()`**](/master.dev/understanding-css-corner-shape-and-the-power-of-the-superellipse.md). It’s actually quite easy to create interesting shapes that can be used for more than corner decorations.
...
```component VPCard
{
  "title": "Background Patterns with CSS `corner-radius`",
  "desc": "You might need to know this someday: you can style a div, put the div into SVG, then put the SVG in to CSS and use it as a repeating background.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/background-patterns-with-css-corner-radius.html",
  "logo": "https://master.dev/favicon.ico",
