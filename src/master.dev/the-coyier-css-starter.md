...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/the-coyier-css-starter.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/7245
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/the-coyier-css-starter/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/7245"/>
...
3. **Use only logical properties.** It’s a [**net gain**](/master.dev/should-we-never-use-non-logical-properties.md).
...
The figure/figcaption stuff is [**from this whole journey**](/master.dev/the-figcaption-problem.md) and I think it makes sense broadly.
...
This also opts-in to [**`animate-to-auto`**](/master.dev/what-you-need-to-know-about-modern-css-2025-edition.md#animate-to-auto) which just rules and allows for smooth-scrolling, but only when the page is focused (so doesn’t do that when you’re using “find” in the browser itself to search the page.
...
```component VPCard
{
  "title": "The Coyier CSS Starter",
  "desc": "A fairly opinionated CSS starter by Chris, following a set of personal principals to guide what is in there and what isn't.  ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/the-coyier-css-starter.html",
  "logo": "https://master.dev/favicon.ico",
