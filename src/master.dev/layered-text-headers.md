...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/layered-text-headers.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/5448
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/layered-text-headers/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/5448"/>
...
```component VPCard
{
  "title": "Layered Text Headers",
  "desc": "Being able to control the `paint-order` in CSS means you can push the stroke behind the fill, fixing awkward issues with ruining letterform readability. ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/layered-text-headers.html",
  "logo": "https://master.dev/favicon.ico",
