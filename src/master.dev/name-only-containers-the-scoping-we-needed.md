...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/name-only-containers-the-scoping-we-needed.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/9223
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/name-only-containers-the-scoping-we-needed/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/9223"/>

I’ve done my time thinking about scope in CSS. I’ve done it my whole career, and did a presentation on it recently that [**I wrote up in full here**](/master.dev/scope-in-css.md). That was on the heels of [**`@scope` becoming a thing in CSS**](/master.dev/how-to-scope-css-now-that-its-baseline.md), which is, naturally, a part of the scope in CSS story.
...
[**I covered these**](/master.dev/scope-in-css.md) in my talk. They have their uses, but again: *niche*.
...
```component VPCard
{
  ...
  "link": "/master.dev/light-dom-only.md",
  "logo": "https://master.dev/favicon.ico",
...
```component VPCard
{
  ...
  "link": "/master.dev/architecture-through-component-colocation.md",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
...
```component VPCard
{
  "title": "Name-Only Containers: The Scoping We Needed",
  "desc": "If we give a `container-name` to the root of all our unique components, we can scope styles to them with a simple @container query.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/name-only-containers-the-scoping-we-needed.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
