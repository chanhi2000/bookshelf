...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/css-n-of-selectors-for-conditional-validation.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/9469
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/css-n-of-selectors-for-conditional-validation/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/9469"/>
...
```component VPCard
{
  "title": "CSS `n of` Selectors for Conditional Validation",
  "desc": ":nth-child supports the keyword `of` in the argument which can be super useful on it's own. Combo that with a :has() selector to do some pretty wild stuff!",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/css-n-of-selectors-for-conditional-validation.html",
  "logo": "https://master.dev/favicon.ico",
