...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/html-css-for-a-one-time-password-input.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/5067
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/html-css-for-a-one-time-password-input/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/5067"/>
...
```component VPCard
{
  "title": "HTML & CSS for a One-Time Password Input",
  "desc": "The typical approach for these inputs is using multiple HTML inputs, one for each character. But is that a good idea? ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/html-css-for-a-one-time-password-input.html",
  "logo": "https://master.dev/favicon.ico",
