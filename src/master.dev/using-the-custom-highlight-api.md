...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/using-the-custom-highlight-api.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/6686
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/using-the-custom-highlight-api/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/6686"/>
...
1. I’m glad I [**learned about `.firstChild`**](/master.dev/firstchild-can-be-white-space.md) the other day, and how it selects the `textNode` of otherwise childless text elements
...
```component VPCard
{
  "title": "Using the Custom Highlight API",
  "desc": "You can get your hands on ranges of text in JavaScript, then apply a named ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/using-the-custom-highlight-api.html",
  "logo": "https://master.dev/favicon.ico",
