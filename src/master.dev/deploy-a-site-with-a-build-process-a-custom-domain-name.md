...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/deploy-a-site-with-a-build-process-a-custom-domain-name.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/6028
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/deploy-a-site-with-a-build-process-a-custom-domain-name/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/6028"/>
...
```component VPCard
{
  "title": "Deploy a Site with a Build Process & a Custom Domain Name",
  "desc": "The last part of this series is taking our site that we've got in GitHub and addng an Astro build process to it, then mapping a domain we own to the Netlify-hosted site.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/deploy-a-site-with-a-build-process-a-custom-domain-name.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
