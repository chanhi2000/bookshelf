...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/pure-css-halftone-effect-in-3-declarations.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/4594
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/pure-css-halftone-effect-in-3-declarations/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/4594"/>
...
![The simplest possible halftone pattern](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/11/1c35b289ba9c002b.png?resize=900%2C368&ssl=1)
...
![the pattern and the map](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/11/8c3b7923f2d3f881.png?resize=720%2C440&ssl=1)
...
![HSL bicone slice showing the lightness axis<br/>([live demo (<VPIcon icon="fa-brands fa-codepen"/>`thebabydino`)](https://codepen.io/thebabydino/full/ZELeqVN))](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/11/76247481aa23bfc8.png?resize=720%2C620&ssl=1)
...
![blending two layers at a pixel level](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/11/blend_pixels.png?resize=999%2C561&ssl=1)
...
![our two gradient layers, blended](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/11/fec92f6bed95ff66.png?resize=720%2C240&ssl=1)
...
![darker dot vs. lighter dot](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/11/acf9b33d53e9759e.png?resize=720%2C358&ssl=1)
...
![8 possible RGB values where all channels are either zeroed or maxed out](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/11/0f7000a3388819f3.png?resize=1024%2C202&ssl=1)
...
![the result so far](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/11/509305e81f382281.png?resize=901%2C368&ssl=1)
...
![bigger dots, blurry edges](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/11/68e49afffb168fbf.png?resize=900%2C368&ssl=1)

The dot edges are now blurry, so we also increase the contrast value from`16`to let’s say`80`.

![increased contrast, jagged edges](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/11/ae3db55090272760.png?resize=900%2C368&ssl=1)
...
![tiny blur + contrast smoothing fix](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/11/13512b65def103c7.png?resize=900%2C368&ssl=1)
...
![real halftone dots pattern](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/11/ede0f7f9f78f8a37.png?resize=800%2C542&ssl=1)
...
![halftone ripples](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/11/77e86cea5d4e399c.png?resize=800%2C542&ssl=1)
...
![thinning lines](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/11/ff734f29576a22b2.png?resize=800%2C542&ssl=1)
...
![triangles](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/11/0b652054e1566c02.png?resize=800%2C542&ssl=1)
...
![fragments](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/11/67445d9e99cfbf3e.png?resize=800%2C542&ssl=1)
...
![rays, but with ugly edges](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/11/9a13d610e3cf9b1e.png?resize=800%2C542&ssl=1)

Using the tiny blur plus a contrast value that’s 2-3 times the blur tactic fixes the ray edges:

![smooth ray edges, but faded pattern edges](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/11/72904c5f8bde7582.png?resize=900%2C368&ssl=1)
...
![using a random image as it is for the map doesn’t work well](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/11/6d4acb5fd5471079.png?resize=800%2C542&ssl=1)
...
![using a fully desaturated map obtained via blending](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/11/43f69454ed0b1b46.png?resize=800%2C542&ssl=1)
...
![using a fully desaturared and brightened map via blending<br/>([live demo (<VPIcon icon="fa-brands fa-codepen"/>`thebabydino`)](https://codepen.io/thebabydino/pen/MWNMjGO))](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/11/e26625a9ee83b58f.png?resize=800%2C542&ssl=1)
...
![inverted halftone dots pattern<br/>([live demo (<VPIcon icon="fa-brands fa-codepen"/>`thebabydino`)](https://codepen.io/thebabydino/pen/YzmmaXp))](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/11/da3b0c684bccb94d.png?resize=800%2C600&ssl=1)
...
![card with halftone effect<br/>([live demo (<VPIcon icon="fa-brands fa-codepen"/>`thebabydino`)](https://codepen.io/thebabydino/pen/GRNKqRv))](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/11/6f1546f3d6c887ad.png?resize=800%2C540&ssl=1)
...
![the CodePen collection](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/11/14cc30f5f74044f0.png?resize=1024%2C781&ssl=1)
...
```component VPCard
{
  "title": "Pure CSS Halftone Effect in 3 Declarations",
  "desc": "A halftone is a pattern of dots that vary in size and spacing. It's a printing technique that you normally don't see, but blown up in size, is a cool aesthetic. This is a deep dive on how it can be done in CSS alone, starting quite simply! ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/pure-css-halftone-effect-in-3-declarations.html",
  "logo": "https://master.dev/favicon.ico",
