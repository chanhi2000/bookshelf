...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/single-flight-mutations-in-tanstack-start-part-2.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/8384
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/single-flight-mutations-in-tanstack-start-part-2/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/8384"/>

[**In part 1**](/master.dev/single-flight-mutations-in-tanstack-start-part-1.md), we talked about how single flight mutations allow you to update data, and re-fetch all the relevant updated data for the UI, all in just one roundtrip across the network.
...
If you’ve never touched TanStack’s middleware before and are feeling overwhelmed, my [**middleware post**](/master.dev/introducing-tanstack-start-middleware.md) might be a good introduction.
...
```component VPCard
{
  "title": "Single Flight Mutations in TanStack Start: Part 2",
  "desc": "This post introduces a middleware approach that allows efficient data refetching. The middleware enables the attachment of query keys and server functions, enhancing scalability and flexibility.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/single-flight-mutations-in-tanstack-start-part-2.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
