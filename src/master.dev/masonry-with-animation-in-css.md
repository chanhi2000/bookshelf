...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/masonry-with-animation-in-css.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/10445
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/masonry-with-animation-in-css/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/10445"/>
...
```component VPCard
{
  "title": "Masonry (with Animation) in CSS",
  "desc": "Masonry.js was famous for creating, uh, Masonry layouts. But it did something else, too: animate fluid grids. Here's a way to get that in native CSS as well as the layout.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/masonry-with-animation-in-css.html",
  "logo": "https://master.dev/favicon.ico",
