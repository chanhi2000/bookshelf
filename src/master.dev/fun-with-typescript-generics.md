...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/fun-with-typescript-generics.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/8524
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/fun-with-typescript-generics/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/8524"/>
...
```component VPCard
{
  "title": "Fun with TypeScript Generics",
  "desc": "Generics, combined with conditional types can make for an incredibly powerful combination. When you look at things the right way, you can ask very useful questions about your types that allow you to build the precise API you want.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/fun-with-typescript-generics.html",
  "logo": "https://master.dev/favicon.ico",
