...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/how-to-scope-css-now-that-its-baseline.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/8146
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/how-to-scope-css-now-that-its-baseline/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/8146"/>
...
```component VPCard
{
  "title": "How to @scope CSS Now That It’s Baseline",
  "desc": "There is a way to declare a scope on a specific selector, a specific selector *down to* another selector, or with no ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/how-to-scope-css-now-that-its-baseline.html",
  "logo": "https://master.dev/favicon.ico",
