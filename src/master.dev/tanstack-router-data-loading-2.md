...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/tanstack-router-data-loading-2.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/4492
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/tanstack-router-data-loading-2/"
...
```component VPCard
{
  "title": "Loading Data with TanStack Router: react-query",
  "desc": "TanStack Query, or react-query, simplifies client-side data fetching with features like caching, automatic re-fetching, and error handling. It integrates smoothly with TanStack Router, allowing efficient prefetching and loading states using hooks like useSuspenseQuery. ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/tanstack-router-data-loading-2.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
