...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/browser-support-tests-in-javascript-for-modern-web-features.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/2865
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/browser-support-tests-in-javascript-for-modern-web-features"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/2865"/>
...
```component VPCard
{
  "title": "Browser Support Tests in JavaScript for Modern Web Features",
  "desc": "Sometimes it's good to know when a browser feature is supported or not so you can do something. Perhaps load a polyfill or just choose a slightly different approach. This post looks at newish features in browsers and shows the test.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/browser-support-tests-in-javascript-for-modern-web-features.html",
  "logo": "https://master.dev/favicon.ico",
