...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/react-compiler-linting-just-got-a-rust-native-speedup-in-oxlint.html
prev: /programming/js-react/articles/README.md
date: 2026-08-17
isOriginal: false
author:
  - name: Andrew Patton
    url: https://master.dev/blog/author/andrewpatton/
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/10691
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/react-compiler-linting-just-got-a-rust-native-speedup-in-oxlint/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/10691"/>
...
```component VPCard
{
  "title": "React Compiler Linting Just Got a Rust-Native Speedup in Oxlint",
  "desc": "The React team made a big splash recently when it announced the release of the Rust rewrite of React Compiler and said that it would be the new canonical version of the compiler going forward. I’ve been on the React Compiler train to enable reliable performance on my AI website builder Outlyne for almost a […]",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/react-compiler-linting-just-got-a-rust-native-speedup-in-oxlint.html",
  "logo": "https://master.dev/favicon.ico",
