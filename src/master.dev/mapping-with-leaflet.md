...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/mapping-with-leaflet.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/5055
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/mapping-with-leaflet/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/5055"/>
...
![Big gray box, useless!](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/01/l1.png?resize=650%2C512&ssl=1)
...
```component VPCard
{
  "title": "Mapping with Leaflet",
  "desc": "Leaflet.js is a free open-source mapping library. We'll look at how to use it to create a basic map with location points of cats up for adoption. ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/mapping-with-leaflet.html",
  "logo": "https://master.dev/favicon.ico",
