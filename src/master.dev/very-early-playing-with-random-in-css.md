...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/very-early-playing-with-random-in-css.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/6931
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/very-early-playing-with-random-in-css/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/6931"/>
...
```component VPCard
{
  "title": "Very Early Playing with random() in CSS",
  "desc": "(Only Safari Technical Preview!) Awfully cool `random()` is coming in CSS. The design possibilities are quite cool. ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/very-early-playing-with-random-in-css.html",
  "logo": "https://master.dev/favicon.ico",
