...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/getting-started-with-cursor.html
prev: /tool/cursor/articles/README.md
date: 2025-09-08
isOriginal: false
author:
  - name: Steve Kinney
    url: https://master.dev/blog/author/stevekinney/
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/7062
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/getting-started-with-cursor/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/7062"/>
...
```component VPCard
{
  "title": "Getting Started with Cursor",
  "desc": "Cursor is an AI-focused VS Code fork. Here's Steve Kinney with a nice overview of what it offers and how to start getting help out of it right away.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/getting-started-with-cursor.html",
  "logo": "https://master.dev/favicon.ico",
