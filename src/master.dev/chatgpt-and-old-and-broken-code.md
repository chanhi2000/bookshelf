...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/chatgpt-and-old-and-broken-code.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/5808
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/chatgpt-and-old-and-broken-code/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/5808"/>
...
![screenshot of the code produced by ChatGPT](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/438759054-4ee31b92-e0c5-4551-8a5a-745be326e83f.png?resize=635%2C965&ssl=1)
...
![Visual representation of the three cases described above.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/439226155-3c23de1e-bdbf-4795-8d2b-5cf745aa1a9f.png?resize=1024%2C374&ssl=1)
...
![The text 'Loading...' in an in-between blue on top of a left to right, aqua to blue gradient. The contrast between the text and the background is poor. It could at most pass AA for large text (above 18pt or bold above 14pt) and AA for user interface components and graphical objects on the left end, but would fail WCAG 2.0 and 2.1 everywhere else.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/439339272-c6f54d56-4f55-4094-bcb7-d8c25760e568.png?resize=800%2C320&ssl=1)
...
![A strange hybrid animal with the body of an ostrich and the head and neck of a camel.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/438891078-ee838909-3cd9-404a-bc22-705e62217d63.png?resize=1024%2C683&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/439663969-ce0535bf-4441-4e9e-bbc2-3a401013ce25.png?resize=725%2C729&ssl=1)
...
```component VPCard
{
  "title": "ChatGPT and the proliferation of obsolete and broken solutions to problems we hadn’t had for over half a decade before its launch",
  "desc": "It was a lovely day on the internet when someone asked how to CSS animated gradient text like ChatGPT’s “Searching the web” and promptly got an answer saying “Have you tried asking ChatGPT? Here’s what it told me!” - well, maybe not these exact words, but at least it rhymes. Both the question and this […]",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/chatgpt-and-old-and-broken-code.html",
  "logo": "https://master.dev/favicon.ico",
