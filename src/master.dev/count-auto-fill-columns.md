...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/count-auto-fill-columns.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/6567
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/count-auto-fill-columns/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/6567"/>
...
![the result in non-supporting browsers: no number of columns can be computed](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/07/458856822-01b5ed8e-2dc6-42d4-86e4-a0bf73c184fe.png?resize=1024%2C512&ssl=1)
...
![basic trigonometry recap](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/07/458914425-90bc6a99-75b9-48c9-ab0d-3e7b48358589.png?resize=1024%2C527&ssl=1)
...
![using trigonometric functions to get around browser support gaps](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/07/458929259-01f2a7cf-dd36-4c3a-9230-d0f0e1dcd6ba.png?resize=1024%2C512&ssl=1)
...
![rounding error caught by Firefox DevTools](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/07/458947888-cb10b290-d1e2-4ea6-b918-64732facca70.png?resize=1024%2C689&ssl=1)
...
![A code snippet from a web developer's browser console showcasing CSS rules for items in a grid layout, including custom properties for styling.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/07/460213331-95aec4e4-3664-4112-97ea-750361218e3f.png?resize=1024%2C558&ssl=1)
...
```component VPCard
{
  "title": "Get the number of auto-fit/auto-fill columns in CSS",
  "desc": "The whole point of auto-fit and auto-fill is that you aren't saying how many columns to use. But if you knew how many the browser chose, you can make nice design decisions.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/count-auto-fill-columns.html",
  "logo": "https://master.dev/favicon.ico",
