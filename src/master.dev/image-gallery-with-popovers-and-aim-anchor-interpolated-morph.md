...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/image-gallery-with-popovers-and-aim-anchor-interpolated-morph.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/8857
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/image-gallery-with-popovers-and-aim-anchor-interpolated-morph/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/8857"/>
...
```component VPCard
{
  "title": "Image Gallery with Popovers and AIM (Anchor-Interpolated Morph)",
  "desc": "An image gallery is a nice example of AIM, where the larger version of an image can ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/image-gallery-with-popovers-and-aim-anchor-interpolated-morph.html",
  "logo": "https://master.dev/favicon.ico",
