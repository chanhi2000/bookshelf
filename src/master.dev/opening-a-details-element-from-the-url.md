...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/opening-a-details-element-from-the-url.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/7019
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/opening-a-details-element-from-the-url/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/7019"/>
...
```component VPCard
{
  "title": "Opening a Details Element from the URL",
  "desc": "If the #hash in the URL matches the ID of an element *inside* a  element, it'll open. No other fancy code required.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/opening-a-details-element-from-the-url.html",
  "logo": "https://master.dev/favicon.ico",
