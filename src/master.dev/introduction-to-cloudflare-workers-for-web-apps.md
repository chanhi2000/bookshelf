...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/introduction-to-cloudflare-workers-for-web-apps.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/10183
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/introduction-to-cloudflare-workers-for-web-apps/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/10183"/>
...
```component VPCard
{
  "title": "Introduction to Cloudflare Workers for Web Apps",
  "desc": "Maybe you don't need a traditional server to run a web app that needs a node server backend. Maybe the requests that need that can go to a cloud function on demand. ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/introduction-to-cloudflare-workers-for-web-apps.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
