...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/non-square-image-blur-extensions.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/7855
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/non-square-image-blur-extensions/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/7855"/>
...
![the result we’re aiming for](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/article_target_result.png?resize=1024%2C575&ssl=1)
...
![result after setting the `width`](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/base_0_size.png?resize=1024%2C740&ssl=1)
...
![result after setting the `aspect-ratio`](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/base_1_ratio.png?resize=1024%2C575&ssl=1)
...
![where we are at this point](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/base_2_alignment.png?resize=1024%2C575&ssl=1)
...
It’s a CSS feature I’ve [**talked about before**](/master.dev/grainy-gradients.md) as it allows us to apply a filter *only* to the `background` of an element, for example making a card’s gradient `background` grainy without affecting its text content.

![a card with a grainy gradient background](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/grainy_gradient.png?resize=1024%2C575&ssl=1)
...
![current support situation](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/base_3_support.png?resize=1024%2C576&ssl=1)
...
![the result we have so far in Safari](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/base_edge_issue.png?resize=1024%2C575&ssl=1)
...
![illustrating the mechanism of our problem](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/base_edge_issue_cause.png?resize=1024%2C575&ssl=1)
...
![how blurring works, illustrated with a `4px×4px` element and a `3×3` weight grid; the weights are multiplied with the alphas of the corresponding pixels and the linear combination is divided by the sum of all weights](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/base_edge_issue_blur_process.png?resize=1024%2C575&ssl=1)
...
![the correct simple blur extension (Safari only [live demo (<VPIcon icon="fa-brands fa-codepen"/>`thebabydino`)](https://codepen.io/thebabydino/pen/gbPZyKZ))](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/base_edge_issue_corrected.png?resize=1024%2C575&ssl=1)
...
![square `img` elements with `object-fit: contain`, tightly fit within their wrapper](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/base_made_cross_browser_outlines.png?resize=1024%2C575&ssl=1)
...
![a close look at the problem](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/base_tiny_problem.png?resize=1024%2C575&ssl=1)
...
![when `aspect-ratio` fails](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/xtra_base_layout_issue_an.png?resize=1024%2C575&ssl=1)
...
![the container fix](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/xtra_base_layout_issue_workaround_an.png?resize=1024%2C575&ssl=1)
...
![where we are: same visual result as before](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/xtra_before_fade.png?resize=1024%2C575&ssl=1)
...
![the problem with blurring elements, illustrated by the original demo](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/xtra_edge_issue_original_an.png?resize=1024%2C575&ssl=1)
...
![our pre-filter setup](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/xtra_method_1_base_setup_an.png?resize=1024%2C575&ssl=1)
...
![graphing how this `feComponentTransfer` works](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/xtra_method_1_graph.png?resize=1024%2C576&ssl=1)
...
![result without `edgeMode='duplicate'`](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/xtra_method_1_blur_no_edge_mode_an.png?resize=1024%2C575&ssl=1)
...
![result with `edgeMode='duplicate'`](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/xtra_method_1_blur_with_edge_mode_an.png?resize=1024%2C575&ssl=1)
...
![not quite the edge fade we wanted](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/xtra_method_1_cut_abruptly_an.png?resize=1024%2C575&ssl=1)
...
![just the masked image result](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/xtra_method_1_smooth_fade_an.png?resize=1024%2C575&ssl=1)
...
![graphing our `feComponentTransfer` options](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/xtra_method_1_graph_2.png?resize=1024%2C717&ssl=1)
...
![the final result ([live demo (<VPIcon icon="fa-brands fa-codepen"/>`thebabydino`)](https://codepen.io/thebabydino/pen/NPNqdLM/f6969d0428ca34f6812334de78a61fee), Safari only and may be buggy at certain viewport sizes)](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/xtra_method_1_smooth_overlay_an.png?resize=1024%2C575&ssl=1)
...
![our boxes](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/xtra_method_2_boxes.png?resize=1024%2C575&ssl=1)
...
![the sizing computation sequence, illustrated on the HTML structure as seen in DevTools](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/11/xtra_method_2_computation_sequence.png?resize=1024%2C575&ssl=1)
...
```component VPCard
{
  "title": "Non-Square Image Blur Extensions",
  "desc": "I recently came across this CodePen demo by Vivi Tseng, which creates the blur extension effect by placing a square div with a blur() beneath the img element and I couldn’t help but think a simpler solution should be possible with a single img element and minimal CSS. So let’s first take a look at […]",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/non-square-image-blur-extensions.html",
  "logo": "https://master.dev/favicon.ico",
