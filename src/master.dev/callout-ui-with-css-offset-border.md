...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/callout-ui-with-css-offset-border.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/9632
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/callout-ui-with-css-offset-border/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/9632"/>
...
```component VPCard
{
  "title": "Callout UI with CSS Offset & Border",
  "desc": "We look at designing callout UI elements using CSS, incorporating leader lines and text boxes. It details setting up the HTML structure, utilizing CSS properties like offset-path and borders.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/callout-ui-with-css-offset-border.html",
  "logo": "https://master.dev/favicon.ico",
