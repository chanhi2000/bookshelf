...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/the-path-of-least-resistance-part-2.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/6976
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/the-path-of-least-resistance-part-2/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/6976"/>
...
```component VPCard
{
  "title": "The `-path` of Least Resistance (Part 2)",
  "desc": "This time we're looking at offset-path (and friends), which can be used to create movement when animated and benefits from all the same fancy functions that we learned about with clip-path.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/the-path-of-least-resistance-part-2.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
