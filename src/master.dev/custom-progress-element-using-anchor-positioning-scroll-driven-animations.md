...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/custom-progress-element-using-anchor-positioning-scroll-driven-animations.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/4369
---
...
I highly recommend you read[**the previous article**](/master.dev/custom-range-slider-using-anchor-positioning-scroll-driven-animations.md)before this one. It’s not mandatory but I will be reusing many CSS tricks so this one will be easier to understand if you already know some of the tricks.
...
```component VPCard
{
  "title": "Custom Progress Element Using Anchor Positioning & Scroll-Driven Animations",
  "desc": "A single HTML `progress` element can have quite an elaborate design with custom colors, a tooltip showing the active %, and even an entrance animation. ",
  "link": "/master.dev/custom-progress-element-using-anchor-positioning-scroll-driven-animations.md",
  "logo": "https://master.dev/favicon.ico",
...
```component VPCard
{
  ...
  "link": "/master.dev/custom-progress-element-using-the-attr-function.md",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
...
If you are a bit lost, don’t worry. We are dealing with a new feature and new concepts so it requires a lot of practice to get used to them. For this reason, I invite you to read[**the previous article**](/master.dev/custom-range-slider-using-anchor-positioning-scroll-driven-animations.md)so you have more examples to study. I also went a bit fast here because I already explained a lot of stuff there (like the use of`timeline-scope`).
...
```component VPCard
{
  "title": "Custom Progress Element Using Anchor Positioning & Scroll-Driven Animations",
  "desc": "A single HTML `progress` element can have quite an elaborate design with custom colors, a tooltip showing the active %, and even an entrance animation. ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/custom-progress-element-using-anchor-positioning-scroll-driven-animations.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
