...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/performance-optimized-video-embeds-with-zero-javascript.html
prev: /programming/css/articles/README.md
date: 2026-02-02
isOriginal: false
author:
  - name: Stefan Bauer
    url: https://master.dev/blog/author/stefanbauer/
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/8431
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/performance-optimized-video-embeds-with-zero-javascript/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/8431"/>

Every embedded video comes with a real cost to page load performance. Each player loads extra resources, whether the user ever hits play or not, as Chris Coyier noted in his blog post on [**“YouTube Embeds are Bananas Heavy and it’s Fixable”**](/master.dev/youtube-embeds-are-bananas-heavy-and-its-fixable.md).
...
```component VPCard
{
  "title": "Performance-Optimized Video Embeds with Zero JavaScript",
  "desc": "Putting a YouTube video inside a closed details element means it won't load until that details element is opened. We can use that.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/performance-optimized-video-embeds-with-zero-javascript.html",
  "logo": "https://master.dev/favicon.ico",
