...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/lessons-learned-from-recreating-a-styled-dialog.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/5578
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/lessons-learned-from-recreating-a-styled-dialog/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/5578"/>
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/04/Screenshot-2025-04-14-at-8.20.15%E2%80%AFAM.png?resize=900%2C1024&ssl=1)
...
![This graphic convinces me dynamic viewport height units are a good idea.<br/>([<VPIcon icon="iconfont icon-webdev"/>source](https://web.dev/blog/viewport-units))](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/04/100dvh-adapts-itself-be-91c728b09836d_1920.png?resize=1024%2C576&ssl=1)
...
<ImageGallery paths="
  https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/04/Screenshot-2025-04-15-at-3.25.18%E2%80%AFPM-1.png?resize=1024%2C604&ssl=1
  https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/04/Screenshot-2025-04-15-at-3.25.27%E2%80%AFPM.png?resize=483%2C1024&ssl=1
"/>
---
...
Welllll, the above isn’t strictly true anymore as I [<VPIcon icon="fas fa-globe"/>learned from Curtis Wilcoxin the comments](https://master.dev/blog/lessons-learned-from-recreating-a-styled-dialog#comment-25883). We can actually use the `popover` syntax to make a button in HTML alone that will open the dialog. That will (sadly) only open the dialog in the non-modal state, but at least it’s a toggle without JavaScript! The good news is that the Invoker Commands API is actually all over this. It’s used like this:
...
```component VPCard
{
  ...
  "link": "/master.dev/whats-the-difference-between-htmls-dialog-element-and-popovers.md",
  "logo": "https://master.dev/favicon.ico",
...
```component VPCard
{
  "title": "Lessons Learned from Recreating a Styled Dialog",
  "desc": "Sometimes pretty simple HTML elements have a lot of things to consider and take care of, from interactivity, styling, accessibility, and more.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/lessons-learned-from-recreating-a-styled-dialog.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
