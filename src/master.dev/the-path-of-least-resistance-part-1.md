...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/the-path-of-least-resistance-part-1.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/6758
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/the-path-of-least-resistance-part-1/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/6758"/>
...
```component VPCard
{
  "title": "The `-path` of Least Resistance (Part 1)",
  "desc": "A deep dive into `clip-path` from Amit Sheen, a very powerful tool in shape creation on the web, particularly now with `shape()`.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/the-path-of-least-resistance-part-1.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
