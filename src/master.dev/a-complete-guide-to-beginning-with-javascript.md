...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/a-complete-guide-to-beginning-with-javascript.html
prev: /programming/js/articles/README.md
date: 2024-09-04
isOriginal: false
author: Cody Lindley
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/3539
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/a-complete-guide-to-beginning-with-javascript/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/3539"/>
...
```component VPCard
{
  "title": "A Complete Guide to Beginning with JavaScript",
  "desc": "This guide serves as an introduction to learning JavaScript, covering necessary prerequisite knowledge and addressing common obstacles. It highlights JavaScript’s origins, essential concepts, and practical applications across different environments.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/a-complete-guide-to-beginning-with-javascript.html",
  "logo": "https://master.dev/favicon.ico",
