...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/cloudflare-workers-and-hyperdrive-with-sveltekit.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/10517
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/cloudflare-workers-and-hyperdrive-with-sveltekit/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/10517"/>

Let’s get into web application setup for Cloudflare Workers on [<VPIcon icon="iconfont icon-svelte"/>SvelteKit](https://svelte.dev/docs/kit/introduction). I’ve written about Cloudflare [**where we introduced workers**](/master.dev/introduction-to-cloudflare-workers-for-web-apps.md), and then where we showed some of the one-off development considerations needed for [**getting Workers to work in TanStack Start**](/master.dev/cloudflare-workers-and-hyperdrive-with-tanstack-start.md).
...
```component VPCard
{
  "title": "Cloudflare Workers and Hyperdrive with SvelteKit",
  "desc": "In which Adam highlights the integration process and notes some challenges compared to the TanStack setup we covered shortly ago.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/cloudflare-workers-and-hyperdrive-with-sveltekit.html",
  "logo": "https://master.dev/favicon.ico",
