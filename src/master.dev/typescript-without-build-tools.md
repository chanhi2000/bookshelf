...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/typescript-without-build-tools.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/4407
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/typescript-without-build-tools/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/4407"/>
...
```component VPCard
{
  "title": "TypeScript without Build Tools",
  "desc": "You can build your own TypeScript build process, and you might want to if you need true type checking and compatibility with a wider ecosystem of tools. But lots of tools, including now Node itself, just accept TypeScript as if it were JavaScript. ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/typescript-without-build-tools.html",
  "logo": "https://master.dev/favicon.ico",
