...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/obsessing-over-smooth-radial-gradient-disc-edges.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/6737
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/obsessing-over-smooth-radial-gradient-disc-edges/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/6737"/>
...
![Screenshot. Shows a big reddish disc with slightly blurry edges.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/08/base_perc_big_blur_aspect_ratio_2.png?resize=960%2C480&ssl=1)
...
![Screenshot. Shows a small reddish disc with slightly jagged edges.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/08/base_perc_small_jagged.png?resize=966%2C160&ssl=1)
...
![Screenshot. Shows a big red disc with slightly blurry edges. The zoom level of 500% is also shown in the top right corner.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/08/base_px_zoom_in_aspect_ratio_2.png?resize=960%2C480&ssl=1)
...
![Screenshot. Shows a big red disc with slightly jagged edges. The zoom level of 25% is also shown in the top right corner.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/08/base_px_zoom_out_aspect_ratio_2.png?resize=960%2C480&ssl=1)
...
![Animated GIF. Shows how zooming from 25% to 500% doesn't affect the radial-gradient() disc edges anymore.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/08/smoo_zoom_test.gif?resize=800%2C800&ssl=1)
...
![Animated GIF. Same as before, only in Firefox this time, where zoom levels are different.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/08/zoom_levels_firefox.gif?resize=800%2C800&ssl=1)
...
![screenshot of a header component with both convex and concave roundings ([live demo (<VPIcon icon="fa-brands fa-codepen"/>`thebabydino`)](https://codepen.io/thebabydino/pen/azOgOKE/09e91c7726a4d5340e38735298ef7bd0))](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/08/header.png?resize=1024%2C303&ssl=1)
...
![the problem when using the fallback without the zoom/ device pixel ratio factor correction](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/08/zoom_mask_problem_no_fix_strip.png?resize=1024%2C318&ssl=1)
...
```component VPCard
{
  "title": "Obsessing Over Smooth radial-gradient() Disc Edges",
  "desc": "An underdog media query, resolution queries, comes to the rescue here in defining radial gradients that don't blur or get the jaggies.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/obsessing-over-smooth-radial-gradient-disc-edges.html",
  "logo": "https://master.dev/favicon.ico",
