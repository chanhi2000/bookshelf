...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/custom-progress-element-using-the-attr-function.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/5537
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/custom-progress-element-using-the-attr-function/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/5537"/>

In[**a previous article**](/master.dev/custom-progress-element-using-anchor-positioning-scroll-driven-animations.md), we combined two modern CSS features ([<VPIcon icon="fas fa-globe"/>anchor positioning](https://master.dev/blog/tag/anchor/) and [<VPIcon icon="fas fa-globe"/>scroll-driven animations](https://master.dev/blog/tag/scroll-driven-animations/)) to style the`<progress>`element without extra markup and create a cool component. Here’s that demo:
...
If we omit the tooltip and animation parts (explained in[**the previous article**](/master.dev/custom-progress-element-using-anchor-positioning-scroll-driven-animations.md)), the new code to get the value and use it to define the content of the tooltip and the color is **a lot easier**:
...
```component VPCard
{
  "title": "Custom progress element using the attr() function",
  "desc": "Now that we're starting to be able to apply types (like `number`) to values of attributes we pull of HTML elements in CSS, doing interesting things with  is easier.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/custom-progress-element-using-the-attr-function.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
