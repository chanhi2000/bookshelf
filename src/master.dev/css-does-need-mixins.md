...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/css-does-need-mixins.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/3002
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/css-does-need-mixins/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/3002"/>
...
```component VPCard
{
  "title": "Style Queries are Almost Like Mixins (But Mixins Would Be Better)",
  "desc": "Having a named block of styles to apply in CSS can be useful, and newfangled Style Queries are pretty close to that. We look at one use case here, how Sass did mixins better, and hope for a native solution. ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/css-does-need-mixins.html",
  "logo": "https://master.dev/favicon.ico",
