...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/sharing-a-variable-across-html-css-and-javascript.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/4908
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/sharing-a-variable-across-html-css-and-javascript/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/4908"/>
...
```component VPCard
{
  "title": "Sharing a Variable Across HTML, CSS, and JavaScript",
  "desc": "Set a variable in Pug, then create an inline script which sets that variable for using in JavaScript and use setProperty to pass it to CSS.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/sharing-a-variable-across-html-css-and-javascript.html",
  "logo": "https://master.dev/favicon.ico",
