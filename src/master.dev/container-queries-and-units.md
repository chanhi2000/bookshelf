...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/container-queries-and-units.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/282
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/container-queries-and-units/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/282"/>
...
```component VPCard
{
  "title": "Container Queries and Units",
  "desc": "Container queries are similar to media queries but allow you set styles based on a particular element’s current size, typically the width. This is super handy because you can write CSS in a way that gives flexibility to the layout! With @media queries, there’s a tight coupling of the styling of a component’s content and […]",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/container-queries-and-units.html",
  "logo": "https://master.dev/favicon.ico",
