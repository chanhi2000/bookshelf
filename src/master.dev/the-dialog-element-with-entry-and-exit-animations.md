...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/the-dialog-element-with-entry-and-exit-animations.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/3559
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/the-dialog-element-with-entry-and-exit-animations/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/3559"/>
...
```component VPCard
{
  "title": "The Dialog Element with Entry *and* Exit Animations",
  "desc": "Now that we're starting to see better support for @starting-style and the allow-discrete keyword, we've got a pretty straightforward way for defining *different* entry and exit states.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/the-dialog-element-with-entry-and-exit-animations.html",
  "logo": "https://master.dev/favicon.ico",
