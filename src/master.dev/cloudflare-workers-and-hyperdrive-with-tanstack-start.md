...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/cloudflare-workers-and-hyperdrive-with-tanstack-start.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/10270
---
...
<SiteInfo
  ...
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/10270"/>

Welcome to Part 2 of our series on using Cloudflare for Web Apps (and specifically TanStack Start). [**In Part 1**](/master.dev/introduction-to-cloudflare-workers-for-web-apps.md), we covered the absolute basics. We deployed a web app to Cloudflare, saw how our Wrangler file works, set up some secrets, and we saw Cloudflare generate typings to keep TypeScript happy.
...
```component VPCard
{
  ...
  "link": "/master.dev/introduction-to-cloudflare-workers-for-web-apps.md",
  "logo": "https://master.dev/favicon.ico",
...
```component VPCard
{
  "title": "Cloudflare Workers and Hyperdrive with TanStack Start",
  "desc": "In Part 2 of the series on using Cloudflare with Web Apps, the focus is on setting up a database and addressing key issues like performance and connection management.",
  "link": "/master.dev/cloudflare-workers-and-hyperdrive-with-tanstack-start.md",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
...
I love [<VPIcon icon="fas fa-globe"/>Drizzle](https://orm.drizzle.team/) and use it for all my projects. It’s an outstanding, unique ORM that’s essentially a thin TypeScript layer on top of SQL. I’ve written about it [**here**](/master.dev/introducing-drizzle.md) and [**here**](/master.dev/drizzle-database-migrations.md).
...
```component VPCard
{
  "title": "Cloudflare Workers and Hyperdrive with TanStack Start",
  "desc": "In Part 2 of the series on using Cloudflare with Web Apps, the focus is on setting up a database and addressing key issues like performance and connection management.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/cloudflare-workers-and-hyperdrive-with-tanstack-start.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
