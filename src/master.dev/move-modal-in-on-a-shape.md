...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/move-modal-in-on-a-shape.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/5917
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/move-modal-in-on-a-shape/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/5917"/>
...
[**I only just learned**](/master.dev/lessons-learned-from-recreating-a-styled-dialog.md#no-invokers-yes-invokers) you can open a modal (in the proper “modal” state) without any JavaScript using invokers.
...
```component VPCard
{
  "title": "Move Modal in on a… shape()",
  "desc": "Got an old ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/move-modal-in-on-a-shape.html",
  "logo": "https://master.dev/favicon.ico",
