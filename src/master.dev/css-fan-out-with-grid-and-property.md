...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/css-fan-out-with-grid-and-property.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/4128
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/css-fan-out-with-grid-and-property/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/4128"/>
...
```component VPCard
{
  "title": "CSS Fan Out with Grid and @property",
  "desc": "A “fan out” animation involves sequentially revealing items from a stack with bouncy effect. by using css grid, we save quite bit of fiddly positioning work.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/css-fan-out-with-grid-and-property.html",
  "logo": "https://master.dev/favicon.ico",
