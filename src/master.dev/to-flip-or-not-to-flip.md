...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/to-flip-or-not-to-flip.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/5890
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/to-flip-or-not-to-flip/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/5890"/>
...
```component VPCard
{
  "title": "Is there a Correct Answer? Flipping Layouts When Google Translate Swaps between a Left-to-Right Language and a Right-to-Left Language",
  "desc": "Google Translate doesn't change the `dir` of a site when translating from LTR to RTL... but you could.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/to-flip-or-not-to-flip.html",
  "logo": "https://master.dev/favicon.ico",
