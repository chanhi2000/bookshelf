...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/creating-flower-shapes-using-clip-path-shape.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/5824
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/creating-flower-shapes-using-clip-path-shape/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/5824"/>
...
In[**a previous article**](/master.dev/creating-flower-shapes-using-css-mask-trigonometric-functions.md), we used modern CSS features such as `mask`, trigonometric functions, and CSS variables to create flower-like shapes.

![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/8hogoSIf.png?resize=883%2C354&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/cxmPje61.png?resize=869%2C379&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/fRZEXPDg.png?resize=775%2C338&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/GI44EdNN.png?resize=491%2C294&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/MeAjhk0c.png?resize=438%2C289&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/F6iWJIUP.png?resize=926%2C344&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/0cXX5vtA.png?resize=648%2C399&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/Bd23aq9Z.png?resize=699%2C397&ssl=1)
...
```component VPCard
{
  "title": "Creating Flower Shapes using clip-path: shape()",
  "desc": "Use the `arc` command within the `shape()` function we can draw a line that follows a circle from one point to the next, controlling the direction.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/creating-flower-shapes-using-clip-path-shape.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
