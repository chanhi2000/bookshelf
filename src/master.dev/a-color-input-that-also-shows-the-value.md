...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/a-color-input-that-also-shows-the-value.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/5212
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/a-color-input-that-also-shows-the-value/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/5212"/>
...
The UI varies, but [**in all cases**](/master.dev/the-color-input-the-color-picker.md) **it doesn’t actually show you the color value you’ve picked when the picker is closed.** I think that’s… weird? What if the input is part of a form in which you actually have a valid color you want to put in yourself? Or copy the value out of?
...
```component VPCard
{
  "title": "A Color Input That Also Shows the Value",
  "desc": "For who-knows-what reason color inputs only show a color swatch, not a string representation of the color. Let's see if we can fix that.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/a-color-input-that-also-shows-the-value.html",
  "logo": "https://master.dev/favicon.ico",
