...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/the-simplest-way-to-deploy.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/5784
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/the-simplest-way-to-deploy/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/5784"/>
...
We’ve covered [**the very fastest way**](/master.dev/exactly-how-to-deploy-local-files-to-make-a-live-website.md) to get those files turned into a deployed website on the internet already, using [<VPIcon icon="fas fa-globe"/>Netlify’s tool](https://app.netlify.com/drop). That totally works, but we can take things a little further to make things easier on our future selves.
...
```component VPCard
{
  ...
  "link": "/master.dev/exactly-how-to-deploy-local-files-to-make-a-live-website.md",
  "logo": "https://master.dev/favicon.ico",
...
```component VPCard
{
  "title": "The Simplest Way to Deploy Your Own Updatable Portfolio Site",
  "desc": "For the true beginners out there! We'll put the files in a GitHub repo and connect it to Netlify to host it.",
  "link": "/master.dev/the-simplest-way-to-deploy.md",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/master.dev/deploy-a-site-with-a-build-process-a-custom-domain-name.md",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
...
Honestly, I’ve been using Git for a hot long while and I still use GUI apps like this ([**literally this**](/master.dev/tower-vs-github-desktop.md)) to work with Git as I prefer the visual nature of it. This is true of many of the talented developers I work with, who are are very capable of command line usage as well.
...
```component VPCard
{
  "title": "The Simplest Way to Deploy Your Own Updatable Portfolio Site",
  "desc": "For the true beginners out there! We'll put the files in a GitHub repo and connect it to Netlify to host it.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/the-simplest-way-to-deploy.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
