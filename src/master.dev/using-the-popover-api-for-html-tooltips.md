...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/using-the-popover-api-for-html-tooltips.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/2027
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/using-the-popover-api-for-html-tooltips/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/2027"/>
...
2. [**Footnotes Progressively Enhanced to Popovers**](/master.dev/footnotes-progressively-enhanced-to-popovers.md)
3. [**Popovers Work Pretty Nicely as Slide-Out Drawers**](/master.dev/popovers-work-pretty-nicely-as-slide-out-drawers.md)
...
```component VPCard
{
  "title": "Using the Popover API for HTML Tooltips",
  "desc": "We can *mostly* use HTML alone for this API. But here, we'll use CSS to style the ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/using-the-popover-api-for-html-tooltips.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
