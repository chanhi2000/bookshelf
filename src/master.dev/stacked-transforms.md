...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/stacked-transforms.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/6457
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/stacked-transforms/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/6457"/>
...
![Illustration depicting three rectangles with arrows indicating movement and rotation, labeled with numbers 1, 2, and 3, on a dotted background.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/07/Screenshot-2025-07-15-at-10.54.15%E2%80%AFAM.png?resize=1024%2C900&ssl=1)
...
What popped into my head was a computer language called [<VPIcon icon="fa-brands fa-wikipedia-w"/>Logo](https://en.wikipedia.org/wiki/Logo_(programming_language)) that I played with as a kid in elementary school. Just look at the main image from [<VPIcon icon="fa-brands fa-wikipedia-w"/>the Wikipedia page](https://en.wikipedia.org/wiki/Logo_(programming_language)). And the homepage of [<VPIcon icon="fas fa-file-pdf"/>the manual](https://master.dev/blog/wp-content/uploads/2025/07/lego-tc-logo-teaching-the-turtle_text.pdf) is very nostoligic for me.

![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/07/KochTurtleAnim.gif?resize=400%2C300&ssl=1)

![Cover of the LEGO TC logo book titled 'Teaching the Turtle,' featuring a blue and red LEGO robotic structure on a baseplate with a computer in the background.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/07/Screenshot-2025-07-15-at-12.44.50%E2%80%AFPM.png?resize=727%2C1024&ssl=1)
...
It’s not *just* `transform` that behave this way, I just found it a useful way to grok it. (Which is also why I had space-separated `filter` [**on the mind**](/master.dev/blur1px-blur1px.md).) For instance, if a `@keyframes` was adjusting opacity and we used `add` or `accumulate`, it would only ever *increase* an opacity value.
...
```component VPCard
{
  "title": "Stacked Transforms",
  "desc": "A look at what happens when you add a whole list of transforms to an element, and how that interacts with `animation-composition`. ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/stacked-transforms.html",
  "logo": "https://master.dev/favicon.ico",
