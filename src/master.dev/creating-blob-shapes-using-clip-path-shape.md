...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/creating-blob-shapes-using-clip-path-shape.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/5861
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/creating-blob-shapes-using-clip-path-shape/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/5861"/>

After [**the flower shapes**](/master.dev/creating-flower-shapes-using-clip-path-shape.md), let’s move to one of the coolest shapes: the **Blob**! Those distorted wiggly circles that were almost impossible to achieve using CSS. But now, they are possible using the new`shape()`function.

![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/blobs1.jpg?resize=808%2C361&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/points.png?resize=790%2C483&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/d.png?resize=624%2C359&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/random.png?resize=624%2C359&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/line.png?resize=812%2C399&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/bezier.png?resize=903%2C440&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/generator.png?resize=1024%2C390&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/05/two.png?resize=1024%2C354&ssl=1)
...
```component VPCard
{
  "title": "Creating Blob Shapes using clip-path: shape()",
  "desc": "Blobs! Gooey weird shapes you can fill with any background and even animate. ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/creating-blob-shapes-using-clip-path-shape.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
