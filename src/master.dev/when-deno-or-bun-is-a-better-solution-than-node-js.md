...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/when-deno-or-bun-is-a-better-solution-than-node-js.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/8954
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/when-deno-or-bun-is-a-better-solution-than-node-js/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/8954"/>
...
```component VPCard
{
  "title": "When Deno or Bun is a Better Solution than Node.js",
  "desc": "Node.js is the default, but should it be? Bun and Deno have come a long way in compatibility and there are reasons that can make them better choices depending on the project.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/when-deno-or-bun-is-a-better-solution-than-node-js.html",
  "logo": "https://master.dev/favicon.ico",
