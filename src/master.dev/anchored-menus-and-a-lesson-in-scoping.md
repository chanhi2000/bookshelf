...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/anchored-menus-and-a-lesson-in-scoping.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/8550
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/anchored-menus-and-a-lesson-in-scoping/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/8550"/>

I had this (bad) idea.

It’s related to [**popovers and anchor-positioned menus**](/master.dev/popover-context-menus-with-anchor-positioning.md). I love this pairing: with only HTML and CSS we can make a button that opens/closes anything we want. A tooltip or a menu is a wonderful use-case.
...
```component VPCard
{
  "title": "Anchored Menus and a Lesson in Scoping",
  "desc": "Turns out `anchor-scope` is pretty darn useful for button/menu setups that will appear multiple times on the same page.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/anchored-menus-and-a-lesson-in-scoping.html",
  "logo": "https://master.dev/favicon.ico",
