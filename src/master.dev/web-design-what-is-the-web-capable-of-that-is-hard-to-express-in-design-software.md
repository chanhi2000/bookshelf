...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/web-design-what-is-the-web-capable-of-that-is-hard-to-express-in-design-software.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/6030
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/web-design-what-is-the-web-capable-of-that-is-hard-to-express-in-design-software/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/6030"/>
...
What about translation? That’s a big one as [**sites are translated whether or not you deal with it**](/master.dev/to-flip-or-not-to-flip.md). Can languages that translate with generally more characters than the original language find enough room?
...
```component VPCard
{
  "title": "Web Design: What is the web capable of that is hard to express in design software?",
  "desc": "The web platform has a heaping helping of more design capability built into it than any design software does.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/web-design-what-is-the-web-capable-of-that-is-hard-to-express-in-design-software.html",
  "logo": "https://master.dev/favicon.ico",
