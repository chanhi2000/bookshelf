...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/web-monetization-is-still-inching-along-but-still-too-difficult.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/7838
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/web-monetization-is-still-inching-along-but-still-too-difficult/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/7838"/>
...
```component VPCard
{
  "title": "Web Monetization is Still Inching Along, But Still Too Difficult",
  "desc": "Just a simple link tag in HTML can point to an online wallet to take payments, and a JavaScript API to react to them. But it's (still) early days.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/web-monetization-is-still-inching-along-but-still-too-difficult.html",
  "logo": "https://master.dev/favicon.ico",
