...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/your-node-js-streams-arent-backpressuring-theyre-silently-eating-your-memory.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/9683
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/your-node-js-streams-arent-backpressuring-theyre-silently-eating-your-memory/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/9683"/>
...
```component VPCard
{
  "title": "Your Node.js Streams Aren’t Backpressuring. They’re Silently Eating Your Memory.",
  "desc": "Memory management in Node.js streaming applications can be quite complex. Streams don't inherently protect against memory exhaustion and we get into common pitfalls developers face.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/your-node-js-streams-arent-backpressuring-theyre-silently-eating-your-memory.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
