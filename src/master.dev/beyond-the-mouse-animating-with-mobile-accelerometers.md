...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/beyond-the-mouse-animating-with-mobile-accelerometers.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/8178
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/beyond-the-mouse-animating-with-mobile-accelerometers/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/8178"/>
...
```component VPCard
{
  ...
  "link": "/master.dev/the-deep-card-conundrum.md",
  "logo": "https://master.dev/favicon.ico",
...
Here is an example borrowed from [**my last article**](/master.dev/the-deep-card-conundrum.md). In this case, the phone’s angles are not only used to rotate the outer cube, but also to determine the inner perspective and its origin:
...
```component VPCard
{
  "title": "Beyond the Mouse: Animating with Mobile Accelerometers",
  "desc": "Mousing over an element and watching it tilt in 3D space is a beautiful and compelling effect. Let's bring it to mobile and use the phone itself rather than a cursor.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/beyond-the-mouse-animating-with-mobile-accelerometers.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
