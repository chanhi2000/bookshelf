...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/in-n-out-animations-popovers-part-2-3.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/9974
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/in-n-out-animations-popovers-part-2-3/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/9974"/>
...
Admittedly, popovers are fairly similar to dialogs (but certainly [**have important differences**](/master.dev/whats-the-difference-between-htmls-dialog-element-and-popovers.md)), and that is part of the point. We’re going to show off that our three-phase system we established in the first article transfers over to something else just fine.
...
Also, in [**Part 1**](/master.dev/in-n-out-animations-dialogs-part-1-3.md), the “on the way out” styles for the `<dialog>` have an issue with the `inset` property, so we set it explicitly to `inset: 0;` and that fixes Safari.
...
```component VPCard
{
  "title": "In-N-Out Animations: Popovers (Part 2/3)",
  "desc": "Using our 3, 2, 1 state system, we can make popovers animate on ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/in-n-out-animations-popovers-part-2-3.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
