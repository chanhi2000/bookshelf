...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/infinite-marquee-animation-using-modern-css.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/6673
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/infinite-marquee-animation-using-modern-css/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/6673"/>
...
To overcome the limitation of `path()`, we are going to use [**the new `shape()` function**](/master.dev/shape-a-new-powerful-drawing-syntax-in-css.md)! Here is a quote from [<VPIcon icon="fas fa-globe"/>the specification](https://drafts.csswg.org/css-shapes-1/#shape-function):
...
```component VPCard
{
  "title": "Infinite Marquee Animation using Modern CSS",
  "desc": "A row of logos that animate forever perfectly and don't have any duplicated HTML or JavaScript at all is quite a trick. Thanks modern CSS! ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/infinite-marquee-animation-using-modern-css.html",
  "logo": "https://master.dev/favicon.ico",
