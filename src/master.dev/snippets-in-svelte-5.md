...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/snippets-in-svelte-5.html
prev: /programming/js-svelte/articles/README.md
date: 2024-08-07
isOriginal: false
author: Adam Rackis
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/3341
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/snippets-in-svelte-5"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/3341"/>

This post is the second in a 3-part series on Svelte 5. [**Part one**](/master.dev/introducing-svelte-5.md)was a basic introduction, covering nuts and bolts features like state, props, and effects. This post is all about snippets, an exciting new feature that allows for content reuse, and more importantly, injecting content into components you render.
...
```component VPCard
{
  "title": "Snippets in Svelte 5",
  "desc": "Out with slots, in with snippets.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/snippets-in-svelte-5.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
