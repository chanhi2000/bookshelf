...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/how-to-control-infinite-css-animations-part-2-of-2.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/9604
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/how-to-control-infinite-css-animations-part-2-of-2/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/9604"/>
...
```component VPCard
{
  ...
  "link": "/master.dev/how-to-control-infinite-css-animations-part-1-of-2.md",
  "logo": "https://master.dev/favicon.ico",
...
```component VPCard
{
  "title": "How to Control Infinite CSS Animations (Part 2 of 2)",
  "desc": "This time we get into very smooth starts and stops for infinite animations using CSS. One of the tricks is layering on a transition on top of an animation.",
  "link": "/master.dev/how-to-control-infinite-css-animations-part-2-of-2.md",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
...
That said, we can still find other alternatives to achieve the same effect. Here is an example using [**the infinite marquee animation**](/master.dev/infinite-marquee-animation-using-modern-css.md). Hover to start the animation
...
```component VPCard
{
  "title": "How to Control Infinite CSS Animations (Part 2 of 2)",
  "desc": "This time we get into very smooth starts and stops for infinite animations using CSS. One of the tricks is layering on a transition on top of an animation.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/how-to-control-infinite-css-animations-part-2-of-2.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
