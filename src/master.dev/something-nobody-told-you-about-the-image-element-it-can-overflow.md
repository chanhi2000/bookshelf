...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/something-nobody-told-you-about-the-image-element-it-can-overflow.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/10580
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/something-nobody-told-you-about-the-image-element-it-can-overflow/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/10580"/>
...
The `animation-composition: add` allows me to animate each axis individually and have an additive effect of both. You can learn more about it here: “[**How to Control Infinite CSS Animations**](/master.dev/how-to-control-infinite-css-animations-part-1-of-2.md)”

Let’s end with some fancy decoration [**powered by `corner-shape`**](/master.dev/drawing-css-shapes-using-corner-shape.md) (Chrome-only for now).
...
```component VPCard
{
  "title": "Something Nobody Told You About The Image Element (It Can Overflow!)",
  "desc": "You normally don't think of images as overflowing themselves, nor can you put anything else inside to make it overflow, but actually...",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/something-nobody-told-you-about-the-image-element-it-can-overflow.html",
  "logo": "https://master.dev/favicon.ico",
