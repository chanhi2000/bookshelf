...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/creating-flower-shapes-using-css-mask-trigonometric-functions.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/1021
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/creating-flower-shapes-using-css-mask-trigonometric-functions/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/1021"/>
...
```component VPCard
{
  ...
  "link": "/master.dev/creating-flower-shapes-using-clip-path-shape.md",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```

1. [**Creating Wavy Circles with Fancy Animations in CSS**](/master.dev/creating-wavy-circles-with-fancy-animations.md)
...
```component VPCard
{
  ...
  "link": "/master.dev/creating-blob-shapes-using-clip-path-shape.md",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
...
![four flower-like shapes with purple to pink gradients. two of them have petals and two of them have spikes. two of them are filled and two of them are outlined.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/02/emMTHfAN.png?resize=749%2C448&ssl=1)
...
![final shape showing it is built from one large circle and many smaller ones.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/02/JrgVmGSG.png?resize=775%2C338&ssl=1)
...
![geometry of the circles showing the radius comparisons.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/02/s_8902C59F87FE310188B36E4009897C666C3E33E25BC1C2DF285794D452BA158A_1708953029181_image.png?resize=587%2C425&ssl=1)
...
![spiky flower shape with purple to orange coloring](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/02/s_8902C59F87FE310188B36E4009897C666C3E33E25BC1C2DF285794D452BA158A_1708960190302_image.png?resize=411%2C404&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/02/AzkwW2ZD.png?resize=611%2C487&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/02/s_8902C59F87FE310188B36E4009897C666C3E33E25BC1C2DF285794D452BA158A_1708987376830_image.png?resize=824%2C364&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/02/s_8902C59F87FE310188B36E4009897C666C3E33E25BC1C2DF285794D452BA158A_1708986701525_image.png?resize=564%2C447&ssl=1)

And for the second one:

![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/02/s_8902C59F87FE310188B36E4009897C666C3E33E25BC1C2DF285794D452BA158A_1708986728215_image.png?resize=564%2C447&ssl=1)
...
![blob like shape, sort of like a gear with smoothed over cogs.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/02/s_8902C59F87FE310188B36E4009897C666C3E33E25BC1C2DF285794D452BA158A_1709024827938_image.png?resize=749%2C448&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/02/image.png?resize=1001%2C486&ssl=1)

Here is [the code of my implementation(<VPIcon icon="fa-brands fa-codepen"/>`t_afif`)](https://codepen.io/t_afif/pen/JjVPjWZ/687389c54821a0763e97bb22cbdc6481) but make a try before checking it so you can compare your method with mine. Take the time to study this last example because it will be the starting point of [**our second article**](/master.dev/creating-wavy-circles-with-fancy-animations.md).
...
2. [**Creating Wavy Circles with Fancy Animations in CSS**](/master.dev/creating-wavy-circles-with-fancy-animations.md)
...
```component VPCard
{
  "title": "Creating Flower Shapes using CSS Mask & Trigonometric Functions",
  "desc": "Creating unusual shapes is always a fun exercise and a good way to practice your CSS skills. One might argue that SVG is better for this job, but nowadays we have a lot of new CSS tricks that allow us to create shapes with a clean and optimized code. Through this two-article series, we will […]",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/creating-flower-shapes-using-css-mask-trigonometric-functions.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
