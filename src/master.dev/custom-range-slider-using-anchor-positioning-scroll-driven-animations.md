...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/custom-range-slider-using-anchor-positioning-scroll-driven-animations.html
prev: /programming/css/articles/README.md
date: 2024-08-21
isOriginal: false
author: Temani Afif
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/3569
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/custom-range-slider-using-anchor-positioning-scroll-driven-animations"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/3569"/>
...
```component VPCard
{
  "title": "Custom Range Slider Using Anchor Positioning & Scroll-Driven Animations",
  "desc": "We'll make some extremely stylized range sliders with simple semantic HTML and some very fresh CSS. You might be surprised how custom these things can get these days.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/custom-range-slider-using-anchor-positioning-scroll-driven-animations.html",
  "logo": "https://master.dev/favicon.ico",
