...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/tanstack-router-data-loading-1.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/4465
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/tanstack-router-data-loading-1/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/4465"/>
...
```component VPCard
{
  ...
  "link": "/master.dev/introducing-tanstack-router.md",
  "logo": "https://master.dev/favicon.ico",
...
```component VPCard
{
  "title": "Loading Data with TanStack Router: Getting Going",
  "desc": "TanStack Router is one of the most exciting projects in the web development ecosystem right now, and it doesn’t get nearly enough attention. It’s a fully fledged client-side application framework that supports advanced routing, nested layouts, and hooks for loading data. Best of all, it does all of this with deep type safety. This post […]",
  "link": "/master.dev/tanstack-router-data-loading-1.md",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/master.dev/tanstack-router-data-loading-2.md",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
...
```component VPCard
{
  "title": "Loading Data with TanStack Router: Getting Going",
  "desc": "TanStack Router is one of the most exciting projects in the web development ecosystem right now, and it doesn’t get nearly enough attention. It’s a fully fledged client-side application framework that supports advanced routing, nested layouts, and hooks for loading data. Best of all, it does all of this with deep type safety. This post […]",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/tanstack-router-data-loading-1.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
