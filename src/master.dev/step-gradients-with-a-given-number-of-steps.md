...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/step-gradients-with-a-given-number-of-steps.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/6338
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/step-gradients-with-a-given-number-of-steps/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/6338"/>

Let’s say we want some stepped gradients like the ones below, with a certain number of steps.

![Desired_linear_result screenshot. Shows a bunch of linear gradients in 10 steps from left to right.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/06/455796945-49b0fd56-3360-4508-a35c-f28bd195b4b0.png?resize=1024%2C767&ssl=1)
...
![what happens when we change one end step from DevTools](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/06/458248325-2acac3da-a0e4-49b5-a1e8-02da911521c3.png?resize=1024%2C543&ssl=1)
...
![our initial gradient](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/06/455271022-11851c25-7c8b-40e3-b088-a648afcc10a8-1.png?resize=1024%2C137&ssl=1)
...
![a black to red stepped gradient with 2 steps, before and after applying the step `filter`](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/06/455810629-f253f4f3-6564-407c-89f8-722340e50c0d.png?resize=840%2C604&ssl=1)
...
![a black to red stepped gradient with 3 steps, before and after applying the step `filter`](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/06/455810668-c93bd651-e9d5-4381-842f-1b2bc09c955a.png?resize=840%2C604&ssl=1)
...
![a black to red stepped gradient with 4 steps, before and after applying the step `filter`](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/06/455811396-c37b7633-eab8-4dc9-957b-0642d60b0410.png?resize=840%2C604&ssl=1)
...
![our example gradient, initial and with a 5 step filter applied](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/06/455822110-9fe8edc0-7b78-4e50-a190-b0dc7254d08e.png?resize=840%2C427&ssl=1)
...
![the step edges are jagged in Chrome for the steps created on the RGB channels, but not on the alpha channel ([live test (<VPIcon icon="fa-brands fa-codepen"/>`thebabydino`)](https://codepen.io/thebabydino/pen/dPojqGY))](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/06/455843768-66471c4c-7bb3-42aa-bb2c-1ad6b52073ab.png?resize=900%2C725&ssl=1)
...
![Screenshot of a 2·5 = 10 step gradient. Shows the filter input (the initial left to right, black to red and then back to black gradient) and output (the filtered gradient, in 5 + 5 steps). On top of these gradients, we also have the boundary lines for the intervals the [0%, 100%] interval of the red channel progression (which coincides with the first half of the input gradient) is split into. This simple linear gradient reflection results in a doubling of the middle red step.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/06/456574288-af19cbac-fafd-4334-ae07-ff0fbd9acf29.png?resize=1024%2C364&ssl=1)
...
![by default, backgrounds cover the entire `border-box`, but start from the top left corner of the `padding-box`](https://i0.wp.com/master.dev/blog/wp-content/uploads/2025/06/456658499-d7fd70ab-3c68-453f-a5fd-a17d380546cb.png?resize=626%2C562&ssl=1)
...
Finally, we could make the gradients grainy. But the approach discussed in [**a previous article**](/master.dev/grainy-gradients.md) is likely not what we’re going for.
...
This is the path taken by the sunburst demo below, which was created taking inspiration from the heading image of [**an earlier post here**](/master.dev/css-bursts-with-conic-gradients.md):
...
```component VPCard
{
  "title": "Step Gradients with a Given Number of Steps",
  "desc": "A deep dive into producing an interpolated ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/step-gradients-with-a-given-number-of-steps.html",
  "logo": "https://master.dev/favicon.ico",
