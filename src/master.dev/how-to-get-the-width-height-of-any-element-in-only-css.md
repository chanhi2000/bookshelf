...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/how-to-get-the-width-height-of-any-element-in-only-css.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/3119
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/how-to-get-the-width-height-of-any-element-in-only-css/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/3119"/>
...
```component VPCard
{
  ...
  "link": "/master.dev/custom-range-slider-using-anchor-positioning-scroll-driven-animations.md",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
...
```component VPCard
{
  "title": "How to Get the Width/Height of Any Element in Only CSS",
  "desc": "Unlike JavaScript, there is no simple built-in method in CSS to access an element's width and height. But using some (call it hacky) modern CSS techniques, we can get our hands on the number and even use it.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/how-to-get-the-width-height-of-any-element-in-only-css.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```