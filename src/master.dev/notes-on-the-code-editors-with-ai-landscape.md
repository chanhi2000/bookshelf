...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/notes-on-the-code-editors-with-ai-landscape.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/5080
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/notes-on-the-code-editors-with-ai-landscape/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/5080"/>
...
```component VPCard
{
  "title": "Notes on the Code Editors with AI Landscape",
  "desc": "There are A LOT of options these days for getting AI help right in your code editor. What seemed to begin with plugins has morphed into a lot of VS Code forks.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/notes-on-the-code-editors-with-ai-landscape.html",
  "logo": "https://master.dev/favicon.ico",
