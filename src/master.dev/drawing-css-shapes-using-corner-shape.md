...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/drawing-css-shapes-using-corner-shape.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/6235
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/drawing-css-shapes-using-corner-shape/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/6235"/>

We recently got [<VPIcon icon="fas fa-globe"/>the new`shape()`function](https://master.dev/blog/tag/shape/) for`clip-path`which is a game changer for creating CSS shape. Another cool feature is on the way and will soon be available: `corner-shape`.
...
```component VPCard
{
  "title": "Drawing CSS Shapes using corner-shape",
  "desc": "After you've got a `border-radius`, you can control the shape of the corner with `corner-shape`, which unlocks a simpler and more powerful way to make shapes compared to `clip-path()`.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/drawing-css-shapes-using-corner-shape.html",
  "logo": "https://master.dev/favicon.ico",
