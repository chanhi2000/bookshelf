...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/how-to-create-a-css-only-elastic-text-effect.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/8537
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/how-to-create-a-css-only-elastic-text-effect/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/8537"/>
...
Unfortunately, using SVG is not ideal because you can only create static pixel-based paths that cannot be controlled with CSS. Instead, we are going to rely on [**the new `shape()` function**](/master.dev/shape-a-new-powerful-drawing-syntax-in-css.md), which allows us to define complex shapes (including curves) that we can easily control using CSS.
...
```component VPCard
{
  "title": "How to Create a CSS-only Elastic Text Effect",
  "desc": "What can we say except BOINNNGGG BOINNGGGGGG. ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/how-to-create-a-css-only-elastic-text-effect.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
