...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/should-we-never-use-non-logical-properties.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/6658
---
...
```component VPCard
{
  "title": "Should we NEVER use non-logical properties?",
  "desc": "Best bet: just always use them. More nuanced take: there is a few situations where using the physical property is still releavant.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/should-we-never-use-non-logical-properties.html",
  "logo": "https://master.dev/favicon.ico",
