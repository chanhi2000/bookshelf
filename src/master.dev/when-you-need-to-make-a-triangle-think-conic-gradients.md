...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/when-you-need-to-make-a-triangle-think-conic-gradients.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/10485
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/when-you-need-to-make-a-triangle-think-conic-gradients/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/10485"/>
...
```component VPCard
{
  "title": "When You Need To Make a Triangle, Think Conic Gradients",
  "desc": "Certainly it isn't the *only* way, but you've got a lot of angular control with conic-gradient() and it's fun to work with.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/when-you-need-to-make-a-triangle-think-conic-gradients.html",
  "logo": "https://master.dev/favicon.ico",
