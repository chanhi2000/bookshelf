...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/tweaking-one-set-of-colors-for-light-dark-modes.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/4579
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/tweaking-one-set-of-colors-for-light-dark-modes/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/4579"/>
...
```component VPCard
{
  "title": "Tweaking One Set of Colors for Light/Dark Modes",
  "desc": "A CSS Custom Property can be used to tweak colors darker when shown on light and lighter when shown on dark, making them pop in both cases. ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/tweaking-one-set-of-colors-for-light-dark-modes.html",
  "logo": "https://master.dev/favicon.ico",
