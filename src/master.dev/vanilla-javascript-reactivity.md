...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/vanilla-javascript-reactivity.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/40
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/vanilla-javascript-reactivity/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/40"/>
...
1. [**Writing a TodoMVC App with Modern Vanilla JavaScript**](/master.dev/vanilla-javascript-todomvc.md)
...
3. [**Patterns for Memory Efficient DOM Manipulation with Modern Vanilla JavaScript**](/master.dev/patterns-for-memory-efficient-dom-manipulation.md)
...
See examples of other approaches in the [Vanilla TodoMVC repo (<VPIcon icon="iconfont icon-github"/>`1Marc/modern-todomvc-vanillajs`)](https://github.com/1Marc/modern-todomvc-vanillajs) and associated [**Vanilla TodoMVC article**](/master.dev/vanilla-javascript-todomvc.md).
...
```component VPCard
{
  "title": "Patterns for Reactivity with Modern Vanilla JavaScript",
  "desc": "“Reactivity” is how systems react to changes in data. There are many types of reactivity, but for this article, reactivity is when data changes, you do things.",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/vanilla-javascript-reactivity.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
