...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/whats-the-difference-between-htmls-dialog-element-and-popovers.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/4069
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/whats-the-difference-between-htmls-dialog-element-and-popovers/"
  logo="https://master.dev/favicon.ico"
  preview="https://master.dev/blog/wp-json/social-image-generator/v1/image/4069"/>
...
![Accessibility tree with a hidden dialog and popover in it.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/09/Screenshot-2024-09-30-at-11.32.24%E2%80%AFAM.png?resize=762%2C248&ssl=1)

![When dialog is open, it’s a part of the accessibility tree.](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/09/Screenshot-2024-09-30-at-11.33.48%E2%80%AFAM.png?resize=1024%2C346&ssl=1)
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/09/Screenshot-2024-09-30-at-10.28.22%E2%80%AFAM.png?resize=776%2C408&ssl=1)

They are essentially `position: fixed;` and `margin: auto;` which centers them in the viewport. This is a probably a smart default for dialogs. In my opinion, popovers are usually begging for [<VPIcon icon="fa-brands fa-firefox" />anchor positioning](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_anchor_positioning) to open the popover near where the element that opened it is, but they [**work nicely as slide-out drawers**](/master.dev/popovers-work-pretty-nicely-as-slide-out-drawers.md) as well, particularly on mobile.
...
![](https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/09/CleanShot-2024-09-30-at-11.35.04%402x.png?resize=1024%2C255&ssl=1)
...
```
<ImageGallery paths="
  https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/09/Screenshot-2024-09-30-at-10.31.04%E2%80%AFAM.png?resize=890%2C342&ssl=1
  https://i0.wp.com/master.dev/blog/wp-content/uploads/2024/09/Screenshot-2024-09-30-at-10.30.56%E2%80%AFAM.png?resize=826%2C392&ssl=1
" />
...
Both dialogs and popovers can have multiple open at once. The most recent one to be opened will be the one that is most “on top” and will close the first via soft dismiss or the ESC key. (Also [**see the CloseWatcher API**](/master.dev/closewatcher.md)).
...
Popovers likely have more use cases than dialogs. Any time you [**need a tooltip**](/master.dev/using-the-popover-api-for-html-tooltips.md) or to provide more contextual information that has good reason not to be visible by default, a popover is a good choice.
...
This is all very cutting edge right now, so browser support is spotty, but both of these elements [**can be animated both on the way in and out**](/master.dev/the-dialog-element-with-entry-and-exit-animations.md).
...
```component VPCard
{
  "title": "What’s the Difference Between HTML’s Dialog Element and Popovers?",
  "desc": "They are pretty similar in both look and functionality, but are have some important differences, slightly different APIs, and functionality. The use cases are also a bit different, so let's have a look!",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/whats-the-difference-between-htmls-dialog-element-and-popovers.html",
  "logo": "https://master.dev/favicon.ico",
