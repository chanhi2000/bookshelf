...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/master.dev/building-a-blog-in-tanstack-part-1-of-2.html
...
cover: https://master.dev/blog/wp-json/social-image-generator/v1/image/9303
---
...
<SiteInfo
  ...
  url="https://master.dev/blog/building-a-blog-in-tanstack-part-1-of-2/"
...
I previously [**blogged about CSS counters**](/master.dev/css-counters-in-action.md), and of course, the complete code for this sample blog [is on GitHub (<VPIcon icon="iconfont icon-github"/>`arackaf/tanstack-blog-blog-post`)](https://github.com/arackaf/tanstack-blog-blog-post).
...
```component VPCard
{
  "title": "Building a Blog in TanStack (Part 1 of 2)",
  "desc": "A site building framework like TanStack Start can be used to make a server-side rendered blog, no problemo. ",
  "link": "https://chanhi2000.github.io/bookshelf/master.dev/building-a-blog-in-tanstack-part-1-of-2.html",
  "logo": "https://master.dev/favicon.ico",
  "background": "rgba(188,75,52,0.2)"
}
```
