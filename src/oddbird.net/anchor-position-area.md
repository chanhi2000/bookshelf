...
description: "Article(s) > Better Anchor Positioning with position-area"
...
head:
  - - meta:
    - property: og:title
      content: "Article(s) > Better Anchor Positioning with position-area"
    - property: og:description
      content: "Better Anchor Positioning with position-area"
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/oddbird.net/anchor-position-area.html
...
<SiteInfo
  name="Better Anchor Positioning with position-area"
  desc="It's not just a shorthand for anchor()"
  url="https://oddbird.net/2025/02/25/anchor-position-area/"
  logo="https://oddbird.net/safari-pinned-tab.svg"
  preview="https://oddbird.net/assets/images/blog/2025/anchor-grid-1600w.jpeg"/>
...
Check out our [**Winging It**](/oddbird.net/wingingit/README.md) conversations about design, frontend, and backend development.
...
[<VPIcon icon="fas fa-globe"/>Anchor-tool.com](https://anchor-tool.com/) is a fantastic tool for exploring the different values for positioning an element within that grid.

![A screenshot of anchor-tool.com, demonstrating an element positioned with position-area: top span-left.](https://oddbird.net/assets/images/blog/2025/anchor-tool-com-480w.jpeg)
...
![A 9-space grid, like a tic-tac-toe board, with an Anchor in the center square, and a square within the top left square for a new containing block.](https://oddbird.net/assets/images/blog/2025/anchor-area-containing-block-480w.jpeg)
...
<CodePen
  user="jamessw"
  slug-hash="XJrLzWa"
  title="position-area shift - absolute"
  :default-tab="['css','result']"
  :theme="dark"/>
...
<CodePen
  user="jamessw"
  slug-hash="ByBgbQa"
  title="position-area shift - fixed"
  :default-tab="['css','result']"
  :theme="dark"/>
...
The [<VPIcon icon="fas fa-globe"/>Anchor Positioning Polyfill](https://anchor-polyfill.netlify.app/) does not yet support `position-area`. This article was written as part of our exploration into the spec, and if you would like to sponsor further development, please [<VPIcon icon="iconfont icon-oddbird"/>get in touch](https://oddbird.net/contact/)!
...
```component VPCard
{
  "title": "Better Anchor Positioning with position-area",
  "desc": "It's not just a shorthand for anchor()",
  "link": "https://chanhi2000.github.io/bookshelf/oddbird.net/anchor-position-area.html",
  "logo": "https://oddbird.net/safari-pinned-tab.svg",
