...
<template>
  <div class="baseline-icon">
    <!-- limited -->
    <svg v-if="support==='limited'" viewBox="0 0 36 20">
    ...
    <!-- widely -->
    <svg v-if="support==='widely'" viewBox="0 0 36 20">
    ...
    <!-- newly -->
    <svg v-if="support==='newly'" viewBox="0 0 36 20">
    ...
    <!-- no_data -->
    <svg v-if="support==='no_data'" viewBox="0 0 36 20">
