...
Ready to make your mark on the open-source world? Head to the [<VPIcon icon="fa-brands fa-youtube"/>freeCodeCamp.org YouTube channel](https://youtu.be/mklEhT_RLos) to start your open-source journey today (2.5-hour watch).
