...
- **Take courses:** Study [<VPIcon icon="fa-brands fa-free-code-camp"/>cloud computing platforms](https://freecodecamp.org/news/search?query=aws) like AWS, Google Cloud, or Microsoft Azure. Learning about distributed systems and IaC tools like [Terraform](/freecodecamp.org/learn-terraform-and-aws-by-building-a-dev-environment.md) and Ansible will also be beneficial.
