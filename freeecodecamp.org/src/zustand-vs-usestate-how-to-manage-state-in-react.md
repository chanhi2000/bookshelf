...
For more information on the `useState()` hook, [<VPIcon icon="fa-brands fa-free-code-camp"/>you can check out this tutorial](https://freecodecamp.org/news/usestate-hook-3-different-examples/). It will provide you with detailed insights and examples related to `useState()` in React. <!-- TODO: 작성 (/freecodecamp.org/usestate-hook-3-different-examples/.md) -->
...
- Can lead to [<VPIcon icon="fa-brands fa-free-code-camp"/>prop drilling](https://freecodecamp.org/news/avoid-prop-drilling-in-react/) in deeply nested components which can cause confusion if you don't understand prop drilling. <!-- TODO: 작성 (/freecodecamp.org/avoid-prop-drilling-in-react.md) -->
