...
My book Pro SwiftUI goes into a lot more detail on custom layouts, including SwiftUI code for masonry layouts, equal width stacks, relative stacks, layout caches, custom animations, and more. Find out more [<VPIcon icon="fas fa-globe"/>here](https://hackingwithswift.com/store/pro-swiftui).
