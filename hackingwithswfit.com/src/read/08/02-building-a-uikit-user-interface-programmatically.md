...
So, open <VPIcon icon="fa-brands fa-swift"/>`ViewController.swift` and add these five properties to the `ViewController` class:
...
Remember that you’re setting anchors as an array, so make sure you include a comma after each one.
