...
Now that data is being sent from JavaScript, data will be received in Swift. In <VPIcon icon="fa-brands fa-swift"/>`ActionViewController.swift`, replace the `// do stuff!` comment with this:
