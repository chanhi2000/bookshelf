...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/hackingwithswift.com/swift/5.5/global-actors.html
isOriginal: false
author:
  - name: Paul Hudson
...
[SE-0316 (<VPIcon icon="iconfont icon-github"/>`apple/swift-evolution`)](https://github.com/apple/swift-evolution/blob/main/proposals/0316-global-actors.md) allows global state to be isolated from data races by using actors.
