...
[SE-0279 (<VPIcon icon="iconfont icon-github"/>`apple/swift-evolution`)](https://github.com/apple/swift-evolution/blob/master/proposals/0279-multiple-trailing-closures.md) introduced multiple trailing closures, making for a simpler way to call a function with several closures.
