...
Fortunately Swift 5.4 [resolves this (<VPIcon icon="iconfont icon-github"/>`apple/swift`)](https://github.com/apple/swift/blob/main/test/Sema/diag_variable_used_in_initial.swift) and allows us to use the more natural naming.
