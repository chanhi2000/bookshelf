...
It’s worth adding that Swift 5.4 extends the result builder system to [<VPIcon icon="fa-brands fa-swift"/>support attributes being placed on stored properties](https://bugs.swift.org/browse/SR-13188), which automatically adjusts the implicit memberwise initializer for structs to apply the result builder.
...
If you’d like to see more advanced, real-world examples of result builders in action, you should check out the [Awesome Function Builders repository on GitHub (<VPIcon icon="iconfont icon-github"/>`carson-katri/awesome-function-builders`)](https://github.com/carson-katri/awesome-function-builders).
