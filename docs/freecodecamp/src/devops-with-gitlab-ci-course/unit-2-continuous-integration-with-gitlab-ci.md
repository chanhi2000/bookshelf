...
head: 
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/fcc/devops-with-gitlab-ci-course/unit-2-continuous-integration-with-gitlab-ci.html
date: 2022-03-02
isOriginal: false
...
- [<VPIcon icon="iconfont icon-gitlab"/> `gitlab-course-public/devops-freecodecamp-gitlab-ci` (fork this)](https://gitlab.com/gitlab-course-public/devops-freecodecamp-gitlab-ci)
...
- for a Node.js project, the <VPIcon icon="fas fa-folder-open"/>`node_modules` folder contains all project dependencies
