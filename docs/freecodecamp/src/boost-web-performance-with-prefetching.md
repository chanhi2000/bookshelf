...
This solution is inspired by [<VPIcon icon="fa-brands fa-x-twitter"/>x.com](http://x.com) where, for the popover component, they fetch the data partially on the main page load and fetch the rest of the data when the component mounts.
...
You can use [vitejs](https://vitejs.dev/) (this is what I used) or [<VPIcon icon="fa-brands fa-react"/>create-react-app](https://create-react-app.dev/) to create your app. Paste the command below in your terminal:
