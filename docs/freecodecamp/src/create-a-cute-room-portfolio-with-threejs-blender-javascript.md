---
lang: en-US
title: "Create a Cute Room Portfolio with Three.js, Blender, JavaScript"
description: "Article(s) > Create a Cute Room Portfolio with Three.js, Blender, JavaScript"
...
head:
  - - meta:
    - property: og:title
      content: "Article(s) > Create a Cute Room Portfolio with Three.js, Blender, JavaScript"
    - property: og:description
      content: "Create a Cute Room Portfolio with Three.js, Blender, JavaScript"
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/freecodecamp.org/create-a-cute-room-portfolio-with-threejs-blender-javascript.html
...
<SiteInfo
  name="Create a Cute Room Portfolio with Three.js, Blender, JavaScript"
  desc="Learn how to use Three.js and Blender to design a stunning and interactive 3D portfolio! We just posted a course on the freeCodeCamp.org YouTube channel that will take you from the foundational concepts of 3D modeling in Blender to creating a fully f..."
  url="https://freecodecamp.org/news/create-a-cute-room-portfolio-with-threejs-blender-javascript"
  logo="https://cdn.freecodecamp.org/universal/favicons/favicon.ico"
  preview="https://cdn.hashnode.com/res/hashnode/image/upload/v1763546767762/f0471b3d-33da-4cec-9d70-f2dd795d687e.jpeg"/>
...
Watch the full course on [<VPIcon icon="fa-brands fa-youtube"/>the freeCodeCamp.org YouTube channel](https://youtu.be/tdsQwuyS6DQ) (9-hour watch).

<VidStack src="youtube/tdsQwuyS6DQ" />
...
```component VPCard
{
  "title": "Create a Cute Room Portfolio with Three.js, Blender, JavaScript",
  "desc": "Learn how to use Three.js and Blender to design a stunning and interactive 3D portfolio! We just posted a course on the freeCodeCamp.org YouTube channel that will take you from the foundational concepts of 3D modeling in Blender to creating a fully f...",
  "link": "https://chanhi2000.github.io/bookshelf/freecodecamp.org/create-a-cute-room-portfolio-with-threejs-blender-javascript.html",
  "logo": "https://cdn.freecodecamp.org/universal/favicons/favicon.ico",
