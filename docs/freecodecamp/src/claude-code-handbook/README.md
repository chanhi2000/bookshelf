...
description: "Article(s) > The Claude Code Handbook: A Professional Introduction to Building with AI-Assisted Development"
...
head:
  - - meta:
    - property: og:title
      content: "Article(s) > The Claude Code Handbook: A Professional Introduction to Building with AI-Assisted Development"
    - property: og:description
      content: "The Claude Code Handbook: A Professional Introduction to Building with AI-Assisted Development"
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/freecodecamp.org/claude-code-handbook/
...
cover: https://cdn.hashnode.com/uploads/covers/5e1e335a7a1d3fcc59028c64/f9a4a36f-875f-4937-b39b-13f41eab0a75.png
---
...
<SiteInfo
  name="The Claude Code Handbook: A Professional Introduction to Building with AI-Assisted Development"
  desc="”I have never enjoyed coding as much as I do today — because I no longer have to deal with the minutia.” — Boris Cherny, Head of Claude Code, Anthropic This handbook is a complete, professional intro"
  url="https://freecodecamp.org/news/claude-code-handbook"
  logo="https://cdn.freecodecamp.org/universal/favicons/favicon.ico"
  preview="https://cdn.hashnode.com/uploads/covers/5e1e335a7a1d3fcc59028c64/f9a4a36f-875f-4937-b39b-13f41eab0a75.png"/>
...
![Chapter 1 Header](https://picsum.photos/seed/chapter1/1200/400)
...
![Chapter 2 Header](https://picsum.photos/seed/chapter2/1200/400)
...
Three of Anthropic's co-founders co-authored the [<VPIcon icon="iconfont icon-arxiv"/>original scaling laws paper](https://arxiv.org/abs/2001.08361), one of the foundational documents of modern AI research. It describes mathematically how model capability scales with size and compute. These are people who understood the trajectory of AI capability before most of the industry had internalized it. Their choice to build an organization focused on safety reflects informed conviction, not just caution.
...
![Chapter 3 Header](https://picsum.photos/seed/chapter3/1200/400)
...
![Chapter 4 Header](https://picsum.photos/seed/chapter4/1200/400)
...
![Chapter 5 Header](https://picsum.photos/seed/chapter5/1200/400)
...
![Chapter 6 Header](https://picsum.photos/seed/chapter6/1200/400)
...
![Chapter 7 Header](https://picsum.photos/seed/chapter7/1200/400)
...
![Diff View of Proposed Edit](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774450372/nveiz5viekwzy0syue81.png)
...
![VS Code Extensions Search](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774450398/yfyweplqjhb8kp3j1ohp.jpg)

When installation completes, a Claude Code icon will appear in the VS Code toolbar. This opens the Claude Code panel.

![Claude Code Icon in Activity Bar](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774450364/zmtqp79kuujulnf5nohq.png)
...
![Empty Claude Code Side Panel](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774450369/lm22je4xc4dbzfw32z6o.png)
...
![Chapter 8 Header](https://picsum.photos/seed/chapter8/1200/400)
...
![Chapter 9 Header](https://picsum.photos/seed/chapter9/1200/400)
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393590/nhhwhgzaykgi1q2nfb2p.png)
...
![Claude Code with First Prompt](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774450366/t344t6vua9ttf6sfn3sq.png)
...
![Claude Code Plan Mode Output](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774450385/qhsdyrglgtex4ffd9sic.png)
...
![Generated index.html File visible](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774450376/repz9nmalciyupzxw4p2.gif)
...
![Chapter 10 Header](https://picsum.photos/seed/chapter10/1200/400)
...
@tab:active Underspecified

![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393596/srkxpcu3yws6bzdrw6vs.png)

```md
Build a task management app.
```

@tab Adequately specified:

![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393602/y6w7wajcdonsziuxl9d4.png)
...
![Underspecified vs Well-Specified Prompt](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774450389/zxcbnirpxy8mezetgqbt.png)
...
![Chapter 11 Header](https://picsum.photos/seed/chapter11/1200/400)
...
![Plan Mode Button in VS Code](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774450384/jnx8iaptfvqh5gzp3hjz.png)
...
![Example Plan Mode Detail](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774450374/sjhn2dk2tz2tdqouclte.png)
...
A <VPIcon icon="fa-brands fa-markdown"/>`PRD.md` file at the project root, readable by Claude Code at the start of each session, provides consistent context that persists across sessions. The quality of this document directly determines the quality of every subsequent build session.
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393607/bxif8vtof8hna3cppgmh.png)
...
![Chapter 12 Header](https://picsum.photos/seed/chapter12/1200/400)
...
![Diff View of Single Feature Change](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774450373/j2xawotofpz70wsumrvv.png)
...
![Chapter 13 Header](https://picsum.photos/seed/chapter13/1200/400)
...
2. It identifies meaningful directories (<VPIcon icon="fas fa-folder-open"/>`src/`, <VPIcon icon="fas fa-folder-open"/>`app/`, <VPIcon icon="fas fa-folder-open"/>`components/`, etc.) and reads those
...
Second, the CLAUDE.md file is read first, always. Because of this, your <VPIcon icon="fa-brands fa-markdown"/>`CLAUDE.md` is the most reliable place to encode conventions. It is the one piece of context Claude has before it reads anything else.

And finally, you can direct Claude's attention. In your prompts, you can name specific files: "Before implementing this feature, read <VPIcon icon="fas fa-folder-open"/>`src/auth/`<VPIcon icon="fa-brands fa-js"/>`middleware.js` and <VPIcon icon="fas fa-folder-open"/>`src/db/`<VPIcon icon="fa-brands fa-js"/>`schema.js`." Claude will read those files first, incorporate their content into its understanding, and apply that understanding to the task.
...
- The <VPIcon icon="fa-brands fa-markdown"/>`CLAUDE.md` file (if present)
...
![Chapter 14 Header](https://picsum.photos/seed/chapter14/1200/400)
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393613/nrgid48zdrowab0jqpmd.png)
...
When you ask Claude to "add email validation to the signup form," Claude reads <VPIcon icon="fas fa-folder-open"/>`components/`<VPIcon icon="fa-brands fa-react"/>`SignupForm.jsx` (the component), <VPIcon icon="fas fa-folder-open"/>`services/`<VPIcon icon="fa-brands fa-js"/>`auth.js` (the auth logic), and possibly <VPIcon icon="fas fa-folder-open"/>`utils/`<VPIcon icon="fa-brands fa-js"/>`validation.js` (shared validators). Three files. Focused change. Clean result.
...
When these layers are enforced, both in the file structure and in the <VPIcon icon="fa-brands fa-markdown"/>`CLAUDE.md` conventions, Claude Code respects them automatically. It knows that a feature touching the UI does not require changes to the data access layer. It knows that an email integration lives in one place and is called through a defined interface. Changes are targeted. Side effects are minimal. Reviews are coherent.

### How to Structure a New Project for Claude Code

When beginning a new project, spend time on the directory structure before asking Claude to write any code. Establish the structure, write the <VPIcon icon="fa-brands fa-markdown"/>`CLAUDE.md`, and then begin feature implementation.

A practical sequence:

![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393619/pmst7xkmdo0cqcbboluu.png)
...
A file named <VPIcon icon="fa-brands fa-js"/>`utils.js` tells Claude almost nothing about what is inside it. A file named <VPIcon icon="fa-brands fa-js"/>`validation.js`, <VPIcon icon="fa-brands fa-js"/>`dateFormatters.js`, or <VPIcon icon="fa-brands fa-js"/>`currencyUtils.js` tells Claude exactly where to look when it needs that functionality.

Enforce these naming standards in your <VPIcon icon="fa-brands fa-markdown"/>`CLAUDE.md`:

![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393625/phsjtcs30y4eqgbfcdxq.png)
...
With these rules in <VPIcon icon="fa-brands fa-markdown"/>`CLAUDE.md`, Claude will follow them consistently. Your code will be navigable, both by Claude in a session, and by developers (including yourself) returning to the project later.

### Defining Done in Your CLAUDE.md

One of the highest-value additions to any <VPIcon icon="fa-brands fa-markdown"/>`CLAUDE.md` is a clear definition of what "done" means for a feature. Developers use different standards. Claude Code should use yours:

![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393631/nzg0zgbr3klbc5f70akz.png)
...
![Chapter 15 Header](https://picsum.photos/seed/chapter15/1200/400)
...
![Plan Mode Button Location](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774450384/jnx8iaptfvqh5gzp3hjz.png)
...
![Permissions Mode Selector Toggle](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774450382/vr7dzinokvwf2devzxkq.png)
...
![Shift+Tab Shortcut for Plan Mode](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774450388/l6gv5xs5nvty5znotidf.png)

---

## Chapter 16: Context Windows and Session Management

![Chapter 16 Header](https://picsum.photos/seed/chapter16/1200/400)
...
![Context Usage Percentage Indicator](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774450370/v9gfdbzwt4pmkfgycecf.png)
...
##### <VPIcon icon="fa-brands fa-markdown"/>`CLAUDE.md` — Project conventions and architecture context
...
A well-maintained <VPIcon icon="fa-brands fa-markdown"/>`CLAUDE.md` contains:
...
- Layer rules (for example, "all database access goes through <VPIcon icon="fas fa-folder-open"/>`db/repos/` – no SQL in route files")
- Security requirements specific to this project
- Definition of done for a completed feature

##### <VPIcon icon="fa-brands fa-markdown"/>`PRD.md` — What is being built
...
##### <VPIcon icon="fa-brands fa-markdown"/>`README.md` — Current implementation status
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393637/cdmpj9cj5d4gvgkqxklc.png)
...
##### <VPIcon icon="fa-brands fa-markdown"/>`progress.md` — Session-level notes and decisions
...
Unlike the PRD (which is specification) and the README (which is completion status), <VPIcon icon="fa-brands fa-markdown"/>`progress.md` captures the reasoning behind decisions — the things that would otherwise exist only in the chat history of a session that has since ended.
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393643/mavsc0sqzvg4dv79onf3.png)
...
![Session Files in VS Code Sidebar](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774450386/p2inh8dukuomcei47llp.png)

#### How Claude Accesses Them

Claude Code reads <VPIcon icon="fa-brands fa-markdown"/>`CLAUDE.md` automatically. For the other files, you provide an explicit instruction at the start of the session:

![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393649/deng8wquqaiqmvovwlft.png)
...
The discipline of maintaining these files – updating them as features complete, adding to <VPIcon icon="fa-brands fa-markdown"/>`progress.md` when significant decisions are made – is the single most valuable habit you can build for multi-session projects. It costs minutes per session. It saves hours of reconstruction.

---

## Chapter 17: MCP Servers and External Integrations

![Chapter 17 Header](https://picsum.photos/seed/chapter17/1200/400)
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393655/dglv67rougyzxaepmxya.png)
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393661/dtgik1lgmw5yomvugasw.png)
...
Claude Code writes the configuration to <VPIcon icon="fas fa-folder-open"/>`~/.claude/`<VPIcon icon="iconfont icon-json"/>`mcp_settings.json` automatically. You do not need to edit this file manually.
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393666/mgg7egyuirhygugxldjp.png)
...
![MCP Command List Output](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774450378/gozp1kjn99oyqjz1r030.jpg)
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393672/cyzkqmolfgyniyov2lxr.png)
...
- "Open a pull request for the feature branch <VPIcon icon="fas fa-code-branch"/>`feature/auth-redesign` into <VPIcon icon="fas fa-code-branch"/>`main`. Title: 'Auth: JWT token refresh'. Description: summarize the changes you made in this session."
- "Review the open pull requests in this repository and tell me which ones have unresolved review comments."
- "Check the CI pipeline status for the last commit on <VPIcon icon="fas fa-code-branch"/>`main`."
- "Create a GitHub Issue for the validation bug I just described and assign it to me."

![GitHub MCP Action Executed](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774450380/oqnjdsya3z969sahcvea.png)
...
A practical example: "Go to our staging environment at staging.myapp.com, log in with the test credentials in <VPIcon icon="iconfont icon-dotenv"/>`.env`, create a new task, and verify it appears in the task list."
...
![Chapter 18 Header](https://picsum.photos/seed/chapter18/1200/400)
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393678/i696fqkwfgfdtdn7n91x.png)
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393685/m3vtzap5km1vanzg2dtp.png)
...
![Parallel Claude Code Sessions in VS Code](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774450381/vcbjireiujfwhbwzuzcx.png)
...
Say your main branch is <VPIcon icon="fas fa-code-branch"/>`main` and you want two agents working in parallel – one on the authentication feature and one on the notification system.

Step 1: create a worktree for each feature branch:

![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393691/oss4btljrgqkcgo9gqnp.png)
...
- `../my-project-auth/` – a full copy of the repository, checked out to <VPIcon icon="fas fa-code-branch"/>`feature/authentication`
- `../my-project-notifications/` – a full copy, checked out to <VPIcon icon="fas fa-code-branch"/>`feature/notifications`
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393696/ssh55mpqp8zboy9xt6vk.png)
...
![Chapter 19 Header](https://picsum.photos/seed/chapter19/1200/400)
...
The primary mechanism for persistent instructions is a file named <VPIcon icon="fa-brands fa-markdown"/>`CLAUDE.md` at the project root. Claude Code reads this file at the start of every session.

A well-written <VPIcon icon="fa-brands fa-markdown"/>`CLAUDE.md` contains:

![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393702/jivygbd7c53gsgp7tv6m.png)
...
![Chapter 20 Header](https://picsum.photos/seed/chapter20/1200/400)
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393708/dle78koktlf7ay7iipw7.png)
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393714/vf3ecksuqo7xeuyerojd.png)
...
![Chapter 21 Header](https://picsum.photos/seed/chapter21/1200/400)
...
![Chapter 22 Header](https://picsum.photos/seed/chapter22/1200/400)
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393720/wq8ropa2ea8eclynuxym.png)
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393726/djqbkd7bmtnj5kvekyo5.png)
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393732/tqywok5nqxlyq0cvkl9j.png)
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393739/gyjzmmlmvssxehfjbtxh.png)
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393745/jzsddps0lpge4ajgqa92.png)
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393752/zaufqz8wlevyxx5w3jn6.png)
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393758/ps1torwcxalytyefkn60.png)
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393765/beaxsh7tgrpbdxwitesg.png)
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393771/gxuynzrqdph12mptbd0u.png)
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393777/nhxfmsj2siaclpnpodk0.png)
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393784/hj4wwrqqms7wbfqnqioj.png)
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393790/hwg1og2omaaocrnryafz.png)

```md :collapsed-lines title="prompt"
...
![Chapter 23 Header](https://picsum.photos/seed/chapter23/1200/400)

The pace at which Claude Code's capabilities are evolving makes any description of "current" features provisional. What follows is an account of the frontier as of early 2026. ### Proactive Task Generation
...
![Chapter 24 Header](https://picsum.photos/seed/chapter24/1200/400)
...
![Chapter 25 Header](https://picsum.photos/seed/chapter25/1200/400)
...
**Day 3:** Use Plan Mode to discuss the project with Claude. Refine the plan until it reflects your intent accurately. Implement Feature 1. **Day 4:** Test Feature 1 until you are confident it works correctly. Implement Feature 2. **Day 5:** Refine the project. Ask Claude to review it against the original specification. Close any gaps.
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393797/dhcsxet25nhqszhkveh9.png)
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393802/dyprngdfillzhhp56gij.png)
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393808/zu6j4kuzge5bij6ihnge.png)
...
![Code Snippet](https://res.cloudinary.com/dc6qud7v9/image/upload/v1774393814/vsult5zqo2pgzj0now63.png)
...
<SiteInfo
  name="Claude"
  desc="Claude is Anthropic's AI, built for problem solvers. Tackle complex challenges, analyze data, write code, and think through your hardest work."
...
- ~~[<VPIcon icon="fas fa-globe"/>The Bitter Lesson](https://incompleteideas.net/IncIdeas/BitterLesson.html) — Rich Sutton. Essential reading for understanding why general models outperform specialized systems.~~

<SiteInfo
  name="A Philosophy of Software Design"
  desc="This book addresses the topic of software  how to decom…"
  url="https://goodreads.com/book/show/39996759-a-philosophy-of-software-design/"
  logo="https://goodreads.com/favicon.ico"
  preview="https://m.media-amazon.com/images/S/compressed.photo.goodreads.com/books/1531857377i/39996759.jpg"/>

```component VPCard
{
  "title": "Fundamentals of Software Architecture",
  "desc": "Companion site for the book Fundamentals of Software Architecture by Mark Richards and Neal Ford.",
  "link": "http://fundamentalsofsoftwarearchitecture.com/",
  "logo": "http://fundamentalsofsoftwarearchitecture.com/favicon.ico",
...
<SiteInfo
  ...
  desc="The Odin Project empowers aspiring web developers to learn together for free"
  url="https://theodinproject.com"
  logo="https://theodinproject.com/favicon-16x16.png"
  preview="https://theodinproject.com/assets/og-logo-2bdf3a30.png"/>

<SiteInfo
  name="freeCodeCamp.org"
  desc="Learn to Code — For Free"
  url="https://freecodecamp.org"
  logo="https://freecodecamp.org/favicon-32x32.png"
...
```component VPCard
{
  "title": "The Claude Code Handbook: A Professional Introduction to Building with AI-Assisted Development",
  "desc": "”I have never enjoyed coding as much as I do today — because I no longer have to deal with the minutia.” — Boris Cherny, Head of Claude Code, Anthropic This handbook is a complete, professional intro",
  "link": "https://chanhi2000.github.io/bookshelf/freecodecamp.org/claude-code-handbook/",
  "logo": "https://cdn.freecodecamp.org/universal/favicons/favicon.ico",
