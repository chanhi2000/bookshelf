...
- It will open a new popup containing your MongoDB atlas URI. Simply copy the string, put it into your <VPIcon icon="iconfont icon-doitenv" />`.env` file and use the password you created in step 14.
