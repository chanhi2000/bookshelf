...
![Notice that **`kitty.png`** and **<VPIcon icon="fa-brands fa-css3-alt"/>`style.css`** are in the same parent folder named **Background-project**](https://freecodecamp.org/news/content/images/2021/04/Frame-25--1--1.png)
