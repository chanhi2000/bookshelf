...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/fcc/build-a-multilingual-social-recipe-app-with-flutter-and-strapi/add-environment-variables.html
date: 2025-04-09
isOriginal: false
author:
  - name: Kevine Nzapdi
...
You will store configuration data such as API keys, environment-specific URLs (base URL, recipe endpoints, comments endpoints), and other sensitive or configurable data outside your codebase using the `flutter_dotenv` package you installed earlier. Create an <VPIcon icon="iconfont icon-doitenv" />`.env` file in your root directory and add your environment variables:
