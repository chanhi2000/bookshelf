---
lang: en-US
title: "How to Build Agentic AI Workflows"
description: "Article(s) > How to Build Agentic AI Workflows"
...
head:
  - - meta:
    - property: og:title
      content: "Article(s) > How to Build Agentic AI Workflows"
    - property: og:description
      content: "How to Build Agentic AI Workflows"
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/freecodecamp.org/how-to-build-agentic-ai-workflows.html
...
<SiteInfo
  name="How to Build Agentic AI Workflows"
  desc="Learn how to build agentic AI workflows. We just posted a course on the freeCodeCamp.org YouTube channel that provides a comprehensive overview of agentic AI, defining agents as software entities that use LLMs to perceive environments, make decisions..."
  url="https://freecodecamp.org/news/how-to-build-agentic-ai-workflows"
  logo="https://cdn.freecodecamp.org/universal/favicons/favicon.ico"
  preview="https://cdn.hashnode.com/res/hashnode/image/upload/v1767719466805/ea83b0f9-fdba-418b-b6a8-f6be955ecc53.png"/>
...
Watch the full course on [<VPIcon icon="fa-brands fa-youtube"/>the freeCodeCamp.org YouTube channel](https://youtu.be/tr5Fapv80Cw) (2-hour watch).

<VidStack src="youtube/tr5Fapv80Cw" />
...
```component VPCard
{
  "title": "How to Build Agentic AI Workflows",
  "desc": "Learn how to build agentic AI workflows. We just posted a course on the freeCodeCamp.org YouTube channel that provides a comprehensive overview of agentic AI, defining agents as software entities that use LLMs to perceive environments, make decisions...",
  "link": "https://chanhi2000.github.io/bookshelf/freecodecamp.org/how-to-build-agentic-ai-workflows.html",
  "logo": "https://cdn.freecodecamp.org/universal/favicons/favicon.ico",
