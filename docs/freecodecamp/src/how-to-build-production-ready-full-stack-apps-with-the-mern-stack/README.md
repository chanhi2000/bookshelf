...
#### <VPIcon icon="fas fa-folder-open"/>`server/middleware/`<VPIcon icon="fa-brands fa-js"/>`errorMiddleware.js`
...
#### <VPIcon icon="fas fa-folder-open"/>`client/src/components/`<VPIcon icon="fa-brands fa-js"/>`PrivateRoute.js`
