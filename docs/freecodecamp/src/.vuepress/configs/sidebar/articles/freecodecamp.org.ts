...
const GITTING_THINGS_DONE_BOOK: SidebarInfoSubgroupTemplate = { // 2024-01-09
...
const HOW_TO_SECURE_A_NEXTJS_AI_APPLICATION_DEPLOYED_ON_VERCEL: SidebarInfoSubgroupTemplate = { // 2024-08-20
  text: 'How to Secure a Next.js AI Application Deployed on Vercel',
  collapsible: true,
  icon: 'iconfont icon-nextjs',
  subPath: 'how-to-secure-a-nextjs-ai-application-deployed-on-vercel',
  children: [
    'README',
    // TODO: 페이지 작성
  ],
...
const BUILD_A_CUSTOM_AI_CHAT_APPLICATION_WITH_NEXTJS: SidebarInfoSubgroupTemplate = { // 2025-10-07
  text: "How to Build an AI Coding Agent with Python and Gemini",
  collapsible: true,
  icon: 'iconfont icon-nextjs',
...
const HOW_TO_BUILD_AN_ADAPTIVE_TIC_TAC_TOE_AI_WITH_REINFORCEMENT_LEARNING_IN_JAVASCRIPT: SidebarInfoSubgroupTemplate = { // 2025-10-08
...
const HOW_TO_CREATE_KUBERNETES_CLUSTER_AND_SECURITY_GROUPS_FOR_PODS_IN_AWS_HANDBOOK: SidebarInfoSubgroupTemplate = { // 2025-10-16
...
const HOW_TO_BUILD_END_TO_END_MACHINE_LEARNING_LINEAGE: SidebarInfoSubgroupTemplate = { // 2025-10-16
...
const HOW_TO_BUILD_SCALABLE_AND_PERFORMANT_FLUTTER_APPLICATIONS_A_HANDBOOK_FOR_DEVS: SidebarInfoSubgroupTemplate = { // 2025-10-23
...
const HOW_TO_BUILD_A_TO_DO_LIST_MCP_SERVER_USING_TYPESCRIPT: SidebarInfoSubgroupTemplate = { // 2025-10-23
...
const REACT_HANDBOOK_FOR_BEGINNERS_LEARN_JSX_HOOKS_RENDERING: SidebarInfoSubgroupTemplate = { // 2025-10-23
  text: "How to Build a To-Do List MCP Server Using TypeScript – with Auth, Database, and Billing",
  collapsible: true,
  icon: 'fa-brands fa-react',
...
const HOW_TO_USE_TO_DOCKER_WITH_NODEJS_HANDBOOK: SidebarInfoSubgroupTemplate = { // 2025-11-19
...
const HOW_TO_USE_NLP_TECHNIQUES_AND_TOOLS_IN_YOUR_PROJECTS_FULL_HANDBOOK: SidebarInfoSubgroupTemplate = { // 2025-11-22
...
const HOW_CLOSURES_WORK_IN_JAVASCRIPT_A_HANDBOOK_FOR_DEVELOPERS: SidebarInfoSubgroupTemplate = { // 2025-11-26
...
const DEPLOY_YOUR_OWN_COCKROACH_DB_INSTANCE_ON_KUBERNETES_FULL_BOOK_FOR_DEVS: SidebarInfoSubgroupTemplate = { // 2025-11-26
...
const THEMING_AND_CUSTOMIZATION_IN_FLUTTER_A_HANDBOOK_FOR_DEVELOPERS: SidebarInfoSubgroupTemplate = { // 2025-11-27
...
const THE_MATH_BEHIND_ARTIFICIAL_INTELLIGENCE_BOOK: SidebarInfoSubgroupTemplate = { // 2026-01-07
  text: "The Math Behind Artificial Intelligence: A Guide to AI Foundations [Full Book]",
  collapsible: true,
  icon: 'fas fa-square-root-variable',
  subPath: 'the-math-behind-artificial-intelligence-book',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const HOW_TO_BUILD_A_LOCAL_FIRST_CLI_FINANCIAL_TRACKER_WITH_RUST: SidebarInfoSubgroupTemplate = { // 2026-01-10
  text: "How to Build a Local-First CLI Financial Tracker with Rust [Full Handbook]",
  collapsible: true,
  icon: 'fa-brands fa-rust',
  subPath: 'how-to-build-a-local-first-cli-financial-tracker-with-rust',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const STOP_MANAGING_KAFKA_MANUALLY_A_GUIDE_TO_KAFKA_UI_AND_CRUISE_CONTROL: SidebarInfoSubgroupTemplate = { // 2026-01-15
  text: "Why You Should Stop Managing Kafka Manually – A Guide to Kafka UI and Cruise Control",
  collapsible: true,
  icon: 'fa-brands fa-docker',
  subPath: 'stop-managing-kafka-manually-a-guide-to-kafka-ui-and-cruise-control',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const BUILD_A_PAYROLL_SYSTEM_WITH_EXPRESS_AND_MONNIFY_USING_BACKGROUND_JOBS: SidebarInfoSubgroupTemplate = { // 2026-01-15
  text: "How to Build a Payroll System with Express and Monnify Using Background Jobs",
  collapsible: true,
  icon: 'iconfont icon-expressjs',
  subPath: 'build-a-payroll-system-with-express-and-monnify-using-background-jobs',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const HOW_TO_BUILD_AN_AI_POWERED_RAG_SEARCH_APPLICATION_WITH_NEXTJS_SUPABASE_AND_OPENAI: SidebarInfoSubgroupTemplate = { // 2026-01-28
  text: "How to Build an AI-Powered RAG Search Application with Next.js, Supabase, and OpenAI",
  collapsible: true,
  icon: 'iconfont icon-supabase',
  subPath: 'how-to-build-an-ai-powered-rag-search-application-with-nextjs-supabase-and-openai',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
}
const HOW_TO_GO_FROM_HELLO_WORLD_TO_BUILDING_REAL_WORLD_APPLICATIONS: SidebarInfoSubgroupTemplate = { // 2026-01-31
  text: "How to Go From Hello World to Building Real World Applications",
  collapsible: true,
  icon: 'iconfont icon-fastapi',
  subPath: 'how-to-go-from-hello-world-to-building-real-world-applications',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const HOW_TO_BUILD_A_PRODUCTION_READY_FEATURE_FLAG_SYSTEM_WITH_NEXTJS_AND_SUPABASE: SidebarInfoSubgroupTemplate = { // 2026-02-06
  text: "How to Build a Production-Ready Feature Flag System with Next.js and Supabase",
  collapsible: true,
  icon: 'iconfont icon-nextjs',
  subPath: 'how-to-build-a-production-ready-feature-flag-system-with-nextjs-and-supabase',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const HOW_TO_OPTIMIZE_PYSPARK_JOBS_HANDBOOK: SidebarInfoSubgroupTemplate = { // 2026-02-06
  text: "How to Build a Production-Ready Feature Flag System with Next.js and Supabase",
  collapsible: true,
  icon: 'iconfont icon-pyspark',
  subPath: 'how-to-optimize-pyspark-jobs-handbook',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const HOW_TO_BUILD_A_PRODUCTION_GRADE_DISTRIBUTED_CHATROOM_IN_GO_FULL_HANDBOOK: SidebarInfoSubgroupTemplate = { // 2026-02-14
  text: "How to Build a Production-Ready Feature Flag System with Next.js and Supabase",
  collapsible: true,
  icon: 'iconfont icon-pyspark',
  subPath: 'how-to-build-a-production-grade-distributed-chatroom-in-go-full-handbook',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const PRODUCT_LED_RESEARCH_A_PRACTICAL_GUIDE_FOR_RANDD_LEADERS_FULL_BOOK: SidebarInfoSubgroupTemplate = { // 2026-02-19
  text: "How to Build a Production-Ready Feature Flag System with Next.js and Supabase",
  collapsible: true,
  icon: 'fas fa-computer',
  subPath: 'product-led-research-a-practical-guide-for-randd-leaders-full-book',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const HOW_TO_BUILD_MCP_SERVERS_FOR_YOUR_INTERNAL_DATA: SidebarInfoSubgroupTemplate = { // 2026-03-05
  text: "How to Build MCP Servers for Your Internal Data",
  collapsible: true,
  icon: 'iconfont icon-typescript',
  subPath: 'how-to-build-mcp-servers-for-your-internal-data',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const BUILD_END_TO_END_ML_PLATFORM_LOCALLY_FROM_EXPERIMENT_TRACKING_TO_CICD: SidebarInfoSubgroupTemplate = { // 2026-03-18
  text: "How to Build an End-to-End ML Platform Locally: From Experiment Tracking to CI/CD",
  collapsible: true,
  icon: 'iconfont icon-fastapi',
  subPath: 'build-end-to-end-ml-platform-locally-from-experiment-tracking-to-cicd',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const HOW_TO_BUILD_A_PRODUCTION_READY_FLUTTER_CI_CD_PIPELINE_WITH_GITHUB_ACTIONS_QUALITY_GATES_ENVIRONMENTS_AND_STORE_DEPLOYMENT: SidebarInfoSubgroupTemplate = { // 2026-03-19
  text: "How to Build a Production-Ready Flutter CI/CD Pipeline with GitHub Actions: Quality Gates, Environments, and Store Deployment",
  collapsible: true,
  icon: 'fa-brands fa-dart-lang',
  subPath: 'how-to-build-a-production-ready-flutter-ci-cd-pipeline-with-github-actions-quality-gates-environments-and-store-deployment',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const HOW_TO_BUILD_YOUR_OWN_LANGUAGE_SPECIFIC_LLM_HANDBOOK: SidebarInfoSubgroupTemplate = { // 2026-04-25
  text: "The AI Governance Handbook: How to Build Responsible AI Systems That Actually Ship",
  collapsible: true,
  icon: 'fas fa-language',
  subPath: 'how-to-build-your-own-language-specific-llm-handbook',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const HOW_TO_BUILD_A_MARKET_RESEARCH_COPILOT_WITH_MCP_AND_PYTHON_HANDBOOK: SidebarInfoSubgroupTemplate = { // 2026-05-07
  text: "How to Build a Market Research Copilot with MCP and Python [Full Handbook]",
  collapsible: true,
  icon: 'iconfont icon-pandas',
  subPath: 'how-to-build-a-market-research-copilot-with-mcp-and-python-handbook',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const QURT_THE_REAL_TIME_OS_INSIDE_YOUR_PHONE_S_PROCESSOR_FULL_HANDBOOK: SidebarInfoSubgroupTemplate = { // 2026-05-07
  text: "QuRT: The Real-Time OS Inside Your Phone's Processor [Full Handbook]",
  collapsible: true,
  icon: 'iconfont icon-c',
  subPath: 'qurt-the-real-time-os-inside-your-phone-s-processor-full-handbook',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const HOW_TO_USE_SCONS_TO_BUILD_SOFTWARE_PROJECTS_FULL_HANDBOOK: SidebarInfoSubgroupTemplate = { // 2026-05-08
  text: "How to Use SCons to Build Software Projects [Full Handbook]",
  collapsible: true,
  icon: 'iconfont icon-c',
  subPath: 'how-to-use-scons-to-build-software-projects-full-handbook',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const SAAS_PAYMENT_FLOW_STRIPE_WEBHOOKS_EMAIL: SidebarInfoSubgroupTemplate = { // 2026-05-09
  text: "How to Build a Complete SaaS Payment Flow with Stripe, Webhooks, and Email Notifications",
  collapsible: true,
  icon: 'iconfont icon-c',
  subPath: 'saas-payment-flow-stripe-webhooks-email',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const LEARN_COMMAND_LINE_INTERFACE_CLI_DEVELOPMENT_WITH_DART_FROM_ZERO_TO_A_FULLY_PUBLISHED_DEVELOPER_TOOL: SidebarInfoSubgroupTemplate = { // 2026-05-09
  text: "Learn Command Line Interface (CLI) Development with Dart: From Zero to a Fully Published Developer Tool",
  collapsible: true,
  icon: 'fa-brands fa-dart-lang',
  subPath: 'learn-command-line-interface-cli-development-with-dart-from-zero-to-a-fully-published-developer-tool',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const THE_CODEX_HANDBOOK_A_PRACTICAL_GUIDE_TO_OPENAI_S_CODING_PLATFORM: SidebarInfoSubgroupTemplate = { // 2026-05-09
  text: "The Codex Handbook: A Practical Guide to OpenAI's Coding Platform",
  collapsible: true,
  icon: 'iconfont icon-openai',
  subPath: 'the-codex-handbook-a-practical-guide-to-openai-s-coding-platform',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const HOW_TO_DEVELOP_CHROME_EXTENSIONS_USING_PLASMO_HANDBOOK: SidebarInfoSubgroupTemplate = { // 2026-05-12
  text: "How to Develop Chrome Extensions using Plasmo [Full Handbook]",
  collapsible: true,
  icon: 'fa-brands fa-chrome',
  subPath: 'how-to-develop-chrome-extensions-using-plasmo-handbook',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const HOW_TO_BUILD_PRODUCTION_READY_AI_FEATURES_WITH_FLUTTER_HANDBOOK_FOR_DEVS: SidebarInfoSubgroupTemplate = { // 2026-05-12
  text: "How to Build Production-Ready AI Features with Flutter [Full Handbook for Devs]",
  collapsible: true,
  icon: 'fa-brands fa-dart-lang',
  subPath: 'how-to-build-production-ready-ai-features-with-flutter-handbook-for-devs',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const HOW_TO_BUILD_SOFTWARE_FACTORY_WITH_CLAUDE_CODE: SidebarInfoSubgroupTemplate = { // 2026-05-22
  text: "How to Build a Software Factory with Claude Code: From Vibe Coding to Agentic Development",
  collapsible: true,
  icon: 'iconfont icon-claude',
  subPath: 'how-to-build-software-factory-with-claude-code',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const HOW_TO_USE_DART_CLOUD_FUNCTIONS_AND_THE_FIREBASE_ADMIN_SDK: SidebarInfoSubgroupTemplate = { // 2026-05-23
  text: "How to Build Production-Ready AI Features with Flutter [Full Handbook for Devs]",
  collapsible: true,
  icon: 'fa-brands fa-dart-lang',
  subPath: 'how-to-use-dart-cloud-functions-and-the-firebase-admin-sdk',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const HOW_TO_BUILD_AN_AI_POWERED_LOCAL_FIRST_CHROME_EXTENSION: SidebarInfoSubgroupTemplate = { // 2026-06-20
  text: "How to Build an AI-Powered, Local-First Chrome Extension That Turns Your Browsing History into an Intent Map",
  collapsible: true,
  icon: 'fa-brands fa-chrome',
  subPath: 'how-to-build-an-ai-powered-local-first-chrome-extension',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const HOW_TO_USE_DART_DOT_SHORTHANDS_HANDBOOK: SidebarInfoSubgroupTemplate = { // 2026-06-26
  text: "How to Use Dart Dot Shorthands: A Handbook for Devs",
  collapsible: true,
  icon: 'fa-brands fa-dart-lang',
  subPath: 'how-to-use-dart-dot-shorthands-handbook',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const HOW_TO_BUILD_YOUR_OWN_MCP_SERVER_AND_PUBLISH_YOUR_CHATGPT_APP: SidebarInfoSubgroupTemplate = { // 2026-07-10
  text: "How to Use Dart Dot Shorthands: A Handbook for Devs",
  collapsible: true,
  icon: 'iconfont icon-mcp',
  subPath: 'how-to-build-your-own-mcp-server-and-publish-your-chatgpt-app',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const REACT_NATIVE_LIVE_ACTIVITIES_HANDBOOK: SidebarInfoSubgroupTemplate = { // 2026-07-15
  text: "The React Native Live Activities Handbook: How to Build iOS Live Activities and Android 16 Live Updates",
  collapsible: true,
  icon: 'fa-brands fa-react',
  subPath: 'react-native-live-activities-handbook',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const REMOTE_PROCEDURE_CALLS_PROTOCOL_BUFFERS_AND_MODERN_DISTRIBUTED_SYSTEMS_COMMUNICATION: SidebarInfoSubgroupTemplate = { // 2026-07-23
  text: "From RPC to gRPC: Understanding Remote Procedure Calls, Protocol Buffers, and Modern Distributed Systems Communication",
  collapsible: true,
  icon: 'fa-brands fa-dart-lang',
  subPath: 'remote-procedure-calls-protocol-buffers-and-modern-distributed-systems-communication',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const THE_ETL_PIPELINE_HANDBOOK_HOW_TO_BUILD_A_PRODUCTION_GRADE_PIPELINE_IN_PYTHON: SidebarInfoSubgroupTemplate = { // 2026-07-28
  text: "The ETL Pipeline Handbook: How to Build a Production-Grade Pipeline in Python",
  collapsible: true,
  icon: 'iconfont icon-pandas',
  subPath: 'the-etl-pipeline-handbook-how-to-build-a-production-grade-pipeline-in-python',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const HOW_TO_BUILD_A_PRODUCTION_READY_DEVSECOPS_PLATFORM_FROM_HOMELAB_TO_AWS_FULL_BOOK: SidebarInfoSubgroupTemplate = { // 2026-07-28
  text: "How to Build a Production-Ready DevSecOps Platform from Homelab to AWS [Full Book]",
  collapsible: true,
  icon: 'iconfont icon-k8s',
  subPath: 'how-to-build-a-production-ready-devsecops-platform-from-homelab-to-aws-full-book',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const CSRF_FROM_SCRATCH_BROWSER_MECHANICS_ATTACKS_AND_SPRING_SECURITY_IMPLEMENTATION_HANDBOOK: SidebarInfoSubgroupTemplate = { // 2026-08-07
  text: "CSRF from Scratch: Browser Mechanics, Attacks, and Spring Security Implementation [Full Handbook]",
  collapsible: true,
  icon: 'iconfont icon-spring',
  subPath: 'csrf-from-scratch--mechanics-attacks-and-spring-security-implementation-handbook',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const HOW_TO_TEST_AI_FEATURES_IN_FLUTTER_FULL_HANDBOOK: SidebarInfoSubgroupTemplate = { // 2026-08-08
  text: "How to Test AI Features in Flutter [Full Handbook]",
  collapsible: true,
  icon: 'fa-brands fa-dart-lang',
  subPath: 'how-to-test-ai-features-in-flutter-full-handbook',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const AI_EVALUATION_ENGINEERING_BUILD_A_PRODUCTION_GRADE_LLM_EVALUATION_PLATFORM_HANDBOOK: SidebarInfoSubgroupTemplate = { // 2026-08-11
  text: "AI Evaluation Engineering: Build a Production-Grade LLM Evaluation Platform from Scratch [Full Handbook]",
  collapsible: true,
  icon: 'iconfont icon-fastapi',
  subPath: 'ai-evaluation-engineering-build-a-production-grade-llm-evaluation-platform-handbook',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const BUILD_A_MULTI_AGENT_TRADING_RESEARCH_SYSTEM_WITH_LANGCHAIN_DEEP_AGENTS_HANDBOOK: SidebarInfoSubgroupTemplate = { // 2026-08-15
  ...
  collapsible: true,
  icon: 'iconfont icon-pandas',
  subPath: 'build-a-multi-agent-trading-research-system-with-langchain-deep-agents-handbook',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const HOW_TO_BUILD_A_BASIC_DISCORD_BOT_WITH_PYTHON: SidebarInfoSubgroupTemplate = { // 2026-08-15
  text: "How to Build a Basic Discord Storytelling, Chat, and Mental Wellness Bot with Python",
  collapsible: true,
  icon: 'iconfont icon-pandas',
  subPath: 'how-to-build-a-basic-discord-bot-with-python',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const UNDERSTANDING_DATA_MANAGEMENT_WITH_A_REAL_WORLD_USE_CASE_BOOK: SidebarInfoSubgroupTemplate = { // 2026-08-26
  text: "From Data to Value: Understanding Data Management Through a Real World Use Case [Full Book]",
  collapsible: true,
  icon: 'fas fa-database',
  subPath: 'understanding-data-management-with-a-real-world-use-case-book',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const BUILD_A_MARKET_TIME_MACHINE_REPLAY_TRADING_SESSIONS_WITH_PYTHON_AND_WEBSOCKETS: SidebarInfoSubgroupTemplate = { // 2026-08-27
  text: "Build a Market Time Machine: Replay Trading Sessions with Python and WebSockets",
  collapsible: true,
  icon: 'iconfont icon-fastapi',
  subPath: 'build-a-market-time-machine-replay-trading-sessions-with-python-and-websockets',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const BUILD_AN_AI_ANALYSIS_AGENT: SidebarInfoSubgroupTemplate = { // 2026-09-02
  text: "How to Build an AI File Analysis Agent with Python",
  collapsible: true,
  icon: 'iconfont icon-openai',
  subPath: 'build-an-ai-analysis-agent',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const HOW_TO_USE_SKILLS_IN_AGENTIC_FLUTTER_DEVELOPMENT_A_HANDBOOK_FOR_DEVS: SidebarInfoSubgroupTemplate = { // 2026-09-03
  text: "How to Build an AI File Analysis Agent with Python",
  collapsible: true,
  icon: 'fa-brands fa-dart-lang',
  subPath: 'how-to-use-skills-in-agentic-flutter-development-a-handbook-for-devs',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const THE_DESIGN_PATTERNS_HANDBOOK_LEARN_POPULAR_DESIGN_PATTERNS_WITH_C_CODE_EXAMPLES: SidebarInfoSubgroupTemplate = { // 2026-09-08
  text: "The Design Patterns Handbook: Learn Popular Design Patterns with C# Code Examples",
  collapsible: true,
  icon: 'fas fa-pen-ruler',
  subPath: 'the-design-patterns-handbook-learn-popular-design-patterns-with-c-code-examples',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const HOW_TO_USE_GRADIO_WITH_PYTHON_BEGINNER_TO_ADVANCED_BOOK: SidebarInfoSubgroupTemplate = { // 2026-09-10
  text: "The Design Patterns Handbook: Learn Popular Design Patterns with C# Code Examples",
  collapsible: true,
  icon: 'iconfont icon-gradio',
  subPath: 'how-to-use-gradio-with-python-beginner-to-advanced-book',
  children: [
    'README',
    // TODO: 페이지 생성
  ]
...
const Y2026: SidebarYeargroupTemplate = {
  ...
  children: [
    ...
    "what-a-machine-learning-model-is-and-how-to-make-one", // 2026-09-10
    ...
    "learn-python-interactively", // 2026-09-08
    ...
    "using-discord-with-a-screen-reader", // 2026-09-05
    ...
    "how-opentelemetry-works", // 2026-09-04
    ...
    "understanding-the-cap-theorem-consistency-availability-and-partition-tolerance-in-system-design", // 2026-09-02
    "learn-excel-formulas-and-functions", // 2026-09-02
    "bloom-filters-explained", // 2026-09-01
    ...
    "learn-the-ai-sdlc-the-complete-guide-to-building-agent-skills", // 2026-08-31
    ...
    "from-mixtral-to-kimi-k3-how-mixture-of-experts-models-evolved", // 2026-08-28
    ...
    "build-ai-agents-apis-and-full-stack-apps-with-meta-muse-code-muse-spark", // 2026-08-2
    "stop-building-ai-slop-build-high-end-web-apps-with-ai", // 2026-08-27
    "the-paper-that-created-modern-ai-the-story-behind-the-transformer", // 2026-08-27
    "how-to-tell-if-search-console-impressions-are-human-or-machine", // 2026-08-27
    BUILD_A_MARKET_TIME_MACHINE_REPLAY_TRADING_SESSIONS_WITH_PYTHON_AND_WEBSOCKETS, // 2026-08-27
    ...
    UNDERSTANDING_DATA_MANAGEMENT_WITH_A_REAL_WORLD_USE_CASE_BOOK, // 2026-08-26
    "what-happens-to-a-medical-image-before-and-after-a-model-sees-it", // 2026-08-25
    "how-to-build-referral-aware-split-payment-flows-in-django", // 2026-08-25
    "mobile-background-execution-ios-background-modes-android-workmanager-and-background-services-in-dart", // 2026-08-25
    "how-to-test-conversational-ai-practical-guide-for-qa-engineers", // 2026-08-24
    "how-to-build-type-safe-apis-with-hono-and-zod", // 2026-08-24
    ...
    "build-pdf-filter-studio-javascript", // 2026-08-13
    ...
    "doubly-robust-estimation-for-llm-product-experiments", // 2026-08-11
    "how-to-get-your-side-project-seen-and-gain-paying-users", // 2026-08-11
    AI_EVALUATION_ENGINEERING_BUILD_A_PRODUCTION_GRADE_LLM_EVALUATION_PLATFORM_HANDBOOK, // 2026-08-11
    ...
    "how-to-harden-github-actions-permissions", // 2026-08-07
    "build-pdf-color-inverter-tool-javascript", // 2026-08-07
    CSRF_FROM_SCRATCH_BROWSER_MECHANICS_ATTACKS_AND_SPRING_SECURITY_IMPLEMENTATION_HANDBOOK, // 2026-08-07
    ...
    "bluetooth-low-energy-in-flutter-a-handbook-for-devs", // 2026-08-06
    "how-to-fix-the-dual-write-problem-in-node-js-with-the-outbox-pattern", // 2026-08-06
    "claude-code-full-course", // 2026-08-05
    "how-gps-works-in-wearables-and-why-it-kills-your-battery", // 2026-08-05
    ...
    "why-your-quantum-circuit-works-in-a-simulator-but-fails-on-real-hardware-full-handbook", // 2026-08-04
    "how-to-build-landing-page-nextjs-shadcn", // 2026-08-04
    "what-happens-during-a-production-deployment", // 2026-08-04
    "what-is-agentic-ai-from-chatbot-to-co-worker", // 2026-08-01
    ...
    "instrumental-variables-for-llm-routing-in-python", // 2026-07-29
    "build-ai-applications-that-switch-models-automatically", // 2026-07-29
    "make-your-antigravity-agent-skills-configurable-without-forking-them", // 2026-07-29
    "oauth-2-0-guide-for-backend-developers", // 2026-07-29
    "prompt-vs-loop-engineering-a-guide-for-developers", // 2026-07-29
    "master-3d-printing-additive-manufacturing", // 2026-07-29
    "the-internet-s-longest-running-joke-a-field-guide-to-the-april-fools-rfcs", // 2026-07-29
    "a-guide-to-modern-react-form-architecture-tanstack-form-zod-shadcn", // 2026-07-29
    "how-to-build-an-automated-workload-model-for-peak-readiness", // 2026-07-28
    HOW_TO_BUILD_A_PRODUCTION_READY_DEVSECOPS_PLATFORM_FROM_HOMELAB_TO_AWS_FULL_BOOK, // 2026-07-28
    THE_ETL_PIPELINE_HANDBOOK_HOW_TO_BUILD_A_PRODUCTION_GRADE_PIPELINE_IN_PYTHON, // 2026-07-28
    "how-to-build-a-real-time-object-detection-and-tracking-pipeline-with-ros-2-and-yolov11", // 2026-07-25
    "how-to-diagnose-production-bugs-when-you-can-t-reproduce-them-locally", // 2026-07-25
    "build-pdf-blur-tool-javascript", // 2026-07-25
    "how-to-use-prompt-engineering-and-context-engineering-for-ai-agents", // 2026-07-25
    "what-to-do-if-you-ve-outgrown-your-cron-job-scheduler", // 2026-07-25
    "how-to-build-ai-agent-function-calling-nodejs-gemini", // 2026-07-25
    "the-new-agency-stack-how-dev-shops-use-claude-cursor-and-copilot-in-production", // 2026-07-25
    "firestore-data-modeling-guide-embedded-documents-vs-referencing-with-a-blog-case-study", // 2026-07-25
    "build-bulletproof-apis-using-typescript-in-express", // 2026-07-24
    "how-clients-and-servers-communicate-handbook-http-rest-websockets-graphql-grpc-protobuf", // 2026-07-24
    "counterfactual-meta-learners-for-llm-prompt-decisions", // 2026-07-24
    "multi-agent-coding-deployment-with-trae-ide", // 2026-07-23
    "claude-certified-architect-foundations-prep-for-anthropic-s-new-certification-exam", // 2026-07-23
    // "how-an-apple-engineer-pranked-billion-dollar-lawyers-and-won", // 2026-07-23
    "how-to-run-an-ai-extractability-audit", // 2026-07-23
    "how-to-build-kubernetes-networking-without-kubernetes-do-what-the-cni-does-by-hand", // 2026-07-23
    "how-programmatic-advertising-works", // 2026-07-23
    REMOTE_PROCEDURE_CALLS_PROTOCOL_BUFFERS_AND_MODERN_DISTRIBUTED_SYSTEMS_COMMUNICATION, // 2026-07-23
    "what-is-hyde-how-to-improve-rag-with-hypothetical-documents", // 2026-07-23
    "how-to-make-a-static-html-page-editable-in-the-browser-with-vanilla-javascript", // 2026-07-23
    "how-to-trace-and-monitor-ai-agents-with-langsmith", // 2026-07-23
    "how-to-train-a-tumor-segmentation-model-on-ultrasound-data-with-monai", // 2026-07-23
    "build-a-reusable-date-time-picker-in-react-with-shadcn-ui", // 2026-07-23
    "how-to-build-an-ai-feature-with-gemini-a-practical-guide-to-prompt-engineering-for-developers", // 2026-07-23
    "how-to-evaluate-ai-code-quality-a-practical-guide-for-engineers", // 2026-07-23
    "relaxation-and-its-role-in-vision-the-1977-phd-thesis-that-helped-shape-modern-ai-research", // 2026-07-22
    "how-to-serve-a-multi-user-ai-agent-with-fastapi-and-streamlit", // 2026-07-21
    "how-to-use-apple-s-foundation-models-in-a-web-app-with-a-macos-companion", // 2026-07-21
    "optimize-enterprise-app-performance-with-t-sql-query-tuning-and-indexing-strategies", // 2026-07-21
    "build-pdf-signature-tool-javascript", // 2026-07-21
    "how-to-build-a-multi-tenant-saas-api-with-nodejs-rbac-and-audit-logging", // 2026-07-21
    "hrv-data-is-everywhere-here-s-what-it-actually-means", // 2026-07-21
    "that-s-embarrassing-why-frontier-ai-still-makes-things-up-and-what-to-do-about-it", // 2026-07-21
    "from-manufacturing-to-microservices-universal-lessons-about-reliability", // 2026-07-20
    "how-to-manage-secrets-securely-with-azure-key-vault-in-node-js", // 2026-07-20
    "how-to-evaluate-ai-agents-with-an-llm-as-a-judge-harness-in-python", // 2026-07-18
    "how-to-create-accessible-modals-and-pop-ups-using-html-css-and-minimal-javascript", // 2026-07-18
    "build-pdf-redaction-tool-javascript", // 2026-07-18
    "how-to-build-an-internal-developer-platform-a-complete-guide-to-backstage-argocd-and-crossplane", // 2026-07-18
    ...
    "the-observer-design-pattern-handbook-event-driven-architecture-domain-driven-design-in-dart", // 2026-07-17
    "a-beginner-s-guide-to-python-hands-on-projects-to-get-you-coding", // 2026-07-16
    "intro-to-shaders-javascript-and-p5-js-course-for-beginners", // 2026-07-16
    "master-full-stack-mobile-development-with-react-native", // 2026-07-16
    "understanding-dijkstra-s-algorithm", // 2026-07-16
    "how-to-fix-common-web-application-security-vulnerabilities-in-node-js", // 2026-07-16
    "why-it-worked-on-my-machine-still-happens-in-2026", // 2026-07-16
    "harness-engineering-ai-native-company", // 2026-07-16
    "how-to-build-rag-chatbot-nodejs-gemini-pgvector", // 2026-07-16
    "regression-models-for-causal-inference-on-ai-features", // 2026-07-16
    "ai-paper-review-deep-unsupervised-learning-using-nonequilibrium-thermodynamics", // 2026-07-16
    "how-to-build-your-first-multi-agent-ai-system-in-python-and-langgraph", // 2026-07-15
    "containerize-a-node-js-app-with-docker-and-deploy-with-github-actions", // 2026-07-15
    "a-deep-dive-into-gabeldorsche-the-bluetooth-stack-android-rebuilt-on-purpose", // 2026-07-15
    "how-to-analyze-insider-transactions-with-python-a-ceo-buying-case-study", // 2026-07-15
    REACT_NATIVE_LIVE_ACTIVITIES_HANDBOOK, // 2026-07-15
    "cnns-rnns-and-transformers-explained-a-mental-model-for-key-deep-learning-concepts", // 2026-07-14
    "how-to-build-and-schedule-local-ai-assistants-for-daily-tasks", // 2026-07-14
    "how-to-integrate-ai-agents-in-net-environments-for-faster-development", // 2026-07-13
    "how-to-build-a-shadcn-sheet-component-in-react-cart-and-filter-panel-examples", // 2026-07-13
    "build-pdf-image-extractor-javascript", // 2026-07-13
    "uplift-modeling-for-personalized-ai-rollouts-in-python", // 2026-07-10
    "how-to-turn-a-postman-collection-into-a-maintainable-pytest-suite", // 2026-07-10
    "how-an-lms-software-helps-technical-teams-upskill-faster", // 2026-07-10
    HOW_TO_BUILD_YOUR_OWN_MCP_SERVER_AND_PUBLISH_YOUR_CHATGPT_APP, // 2026-07-10
    "role-based-access-control-nodejs-rest-api-jwt", // 2026-07-09
    "build-your-own-healthcare-ai-assistant-with-medgemma-ollama-and-open-webui", // 2026-07-09
    "how-mcp-is-changing-wordpress-development", // 2026-07-09
    "build-an-mcp-server-with-fastmcp-for-local-ai-agent", // 2026-07-09
    "ai-paper-review-self-consistency-improves-chain-of-thought-reasoning-in-language-models", // 2026-07-09
    "how-to-fix-app-jank-profiling-flutter-apps-with-devtools", // 2026-07-09
    "level-up-your-react-skills-with-typescript", // 2026-07-08
    "why-does-the-internet-keep-breaking-a-deep-dive-into-aws-us-east-1", // 2026-07-08
    "implement-zero-trust-workload-identity-in-kubernetes-with-spiffe-spire-and-cilium", // 2026-07-08
    "how-to-build-your-own-local-ai-agent-with-tool-calling-and-memory", // 2026-07-08
    "build-pdf-ocr-to-text-converter-javascript", // 2026-07-08
    "how-to-build-production-ready-card-components-with-shadcn-ui", // 2026-07-08
    "ai-agents-for-beginners", // 2026-07-07
    "the-heroku-nostalgia-trap-why-easy-deploys-arent-the-only-answer", // 2026-07-07
    ...
    "export-a-claude-conversation-as-pdf-complete-guide", // 2026-07-06
    "how-to-build-a-dark-mode-toggle-without-javascript", // 2026-07-06
    "top-ai-productivity-tools-for-developers-and-professionals", // 2026-07-04
    "build-pdf-analyzer-javascript", // 2026-07-04
    "shopify-ajax-cart-drawer", // 2026-07-03
    "build-a-private-rag-qa-ai-agent-for-your-documents-using-langchain", // 2026-07-03
    "codex-vs-claude-code-which-ai-coding-assistant-to-choose", // 2026-07-03
    "stop-early-without-p-hacking-using-msprt-and-sequential-testing-in-python", // 2026-07-03
    "mastering-javascript-dates-and-times", // 2026-07-02
    "defend-your-js-app-against-unsafe-data-with-typescript-guard-utilities", // 2026-07-02
    "the-cloud-pentesting-problem-why-traditional-security-models-stop-working-at-scale", // 2026-07-02
    "build-pdf-margin-tool-javascript", // 2026-07-02
    "what-is-a-json-schema", // 2026-07-02
    ...
    "my-team-s-experience-moving-from-aws-to-a-paas", // 2026-07-01
    "how-to-use-the-screen-reader-that-s-built-into-your-iphone", // 2026-07-01
    "command-line-basics-for-beginners", // 2026-07-01
    "switchback-experiments-for-ai-platform-features-in-python", // 2026-07-01
    "why-different-wearables-report-different-heart-rates", // 2026-06-30
    "build-pdf-resizer-javascript", // 2026-06-30
    "how-to-write-your-first-quantum-circuit-in-python-a-beginner-s-step-by-step-guide", // 2026-06-30
    "build-an-ai-agent-that-runs-its-own-llm-experiments-with-autoresearch", // 2026-06-29
    "how-bloom-filters-work-build-one-from-scratch-python", // 2026-06-29
    "how-to-use-claude-code-to-build-flutter-apps-faster-best-practices", // 2026-06-29
    "build-a-personal-ai-web-research-agent-with-ollama-and-qwen", // 2026-06-27
    "how-to-choose-the-right-tunneling-tool", // 2026-06-27
    "scaling-your-ai-models-with-micro-ddp", // 2026-06-26
    "why-computers-can-t-count-money", // 2026-06-26
    "build-an-ai-agent-in-telegram-with-vercel-cursor-composio", // 2026-06-26
    "how-to-build-a-reliable-sse-client-in-typescript", // 2026-06-26
    "advanced-dart-learn-async-programming-with-streams-isolates-event-loop", // 2026-06-2
    "how-i-became-brazils-first-visually-impaired-cybersecurity-graduate", // 2026-06-26
    HOW_TO_USE_DART_DOT_SHORTHANDS_HANDBOOK, // 2026-06-26
    "how-to-stop-your-ai-coding-agent-from-writing-outdated-code-with-modern-web-guidance", // 2026-06-25
    "how-to-insert-images-in-google-sheets", // 2026-06-25
    "how-to-build-a-browser-based-pdf-reverse-tool-javascript", // 2026-06-25
    "how-to-build-secure-by-default-node-js-apis", // 2026-06-25
    "how-to-build-production-grade-ai-guardrails-for-enterprise-applications-a-practical-guide", // 2026-06-25
    "how-to-build-an-animated-badge-component-with-shadcn-ui", // 2026-06-25
    "how-to-find-stock-specific-moves-in-the-s-p-500-with-python", // 2026-06-25
    "how-to-structure-large-flutter-applications-for-scalable-and-maintainable-growth", // 2026-06-24
    "how-to-teach-a-small-llm-to-suggest-k12-creative-project-ideas", // 2026-06-24
    "how-to-build-a-durable-autoscaling-ai-agent-with-temporal-composio-keda-and-kubernetes", // 2026-06-24
    "how-enterprise-teams-manage-infrastructure-at-scale-with-terraform", // 2026-06-24
    "from-llms-to-langchain-understanding-how-modern-ai-applications-actually-work", // 2026-06-24
    "how-flutter-renders-under-the-hood-buildcontext-and-element-tree-explained", // 2026-06-24
    "sleep-tracking-bluetooth-signals-and-emf-in-wearables", // 2026-06-24
    "learn-notion-workers", // 2026-06-23
    "what-to-do-when-reflection-won-t-fix-your-ai-agent-s-output", // 2026-06-23
    "how-to-build-a-scalable-design-system-in-a-monorepo", // 2026-06-23
    "how-to-turn-performance-audits-into-ai-fix-prompts-with-a-devtools-extension", // 2026-06-23
    "eks-cost-optimization-reduce-your-aws-bill-using-karpenter-and-rightsizing", // 2026-06-23
    "how-to-organize-and-maintain-azure-repositories-at-scale", // 2026-06-23
    "how-to-handle-errors-the-right-way-in-flutter-a-practical-guide-to-sealed-classes-records-and-result-types", // 2026-06-21
    "build-a-synthetic-dataset-for-ai-de-identification", // 2026-06-20
    "pure-headless-vs-hybrid-headless-cms-for-enterprise-content-management", // 2026-06-20
    HOW_TO_BUILD_AN_AI_POWERED_LOCAL_FIRST_CHROME_EXTENSION, // 2026-06-20
    "how-to-build-an-offline-ai-image-generator-in-node-js-with-qvac-and-socket-io", // 2026-06-1
    "how-wearables-track-the-menstrual-cycle-the-sensors-the-algorithms-and-the-accuracy-gap", // 2026-06-19
    "how-to-analyze-analyst-estimate-ranges-with-python", // 2026-06-19
    "how-to-handle-small-context-window-limits-in-rag-systems", // 2026-06-18
    "how-to-avoid-overusing-usecallback-and-usememo-in-react", // 2026-06-18
    "how-to-build-a-production-architecture-for-small-language-model-fleets", // 2026-06-18
    "how-to-schedule-jobs-in-postgresql-with-pg-cron", // 2026-06-18
    "how-to-use-dartexceptor-a-lighter-way-to-handle-errors-in-dart-3", // 2026-06-18
    "the-2026-finops-roadmap-from-cost-blind-engineer-to-cloud-financial-manager", // 2026-06-16
    "how-to-build-a-production-safe-agent-loop-from-exit-conditions-to-audit-trails", // 2026-06-16
    "ai-paper-review-chain-of-thought-prompting-elicits-reasoning-in-large-language-models", // 2026-06-16
    "build-a-self-healing-ci-cd-pipeline-with-ai", // 2026-06-15
    ...
    "tech-giants-wearable-data-race", // 2026-05-30
    ...
    "a-developers-guide-to-webmcp", // 2026-05-29
    ...
    "learn-figma-for-ui-ux-design", // 2026-05-29
    "what-to-do-when-your-customer-is-an-ai-agent", // 2026-05-29
    ...
    "build-ai-apps-in-the-browser-with-tensorflow-js-and-webgpu", // 2026-05-27
    ...
    "how-to-use-dart-cloud-functions-and-the-firebase-admin-sdk", // 2026-05-2
    "build-ai-image-de-identification-for-clinical-research", // 2026-05-23
    HOW_TO_BUILD_SOFTWARE_FACTORY_WITH_CLAUDE_CODE, // 2026-05-22
    "how-to-avoid-rebuilding-infrastructure-for-every-new-project", // 2026-05-22
    "how-to-use-github-search-like-a-pro", // 2026-05-22
    "learn-latex-in-41-hours", // 2026-05-22
    "think-like-the-javascript-engine", // 2026-05-21
    "how-to-encrypt-kubernetes-traffic", // 2026-05-21
    "migrate-from-asp-net-to-asp-net-core", // 2026-05-20
    "learn-to-build-automated-workflows-with-manus-ai", // 2026-05-20
    "how-to-protect-your-privacy-online-in-2026", // 2026-05-20
    "build-a-pdf-watermark-tool-in-javascript", // 2026-05-20
    ...
    "build-a-calculator-with-tkinter-in-python", // 2026-05-15
    "build-autonomous-agent-in-python-using-claude", // 2026-05-15
    "how-to-avoid-devops-mistakes", // 2026-05-15
    "claude-code-for-beginners", // 2026-05-14
    "aws-certified-cloud-practitioner-study-course-pass-the-exam-with-this-free-13-hour-course", // 2026-05-14
    "product-experimentation-with-synthetic-control-causal-inference-for-global-llm-rollouts-in-python", // 2026-05-12
    HOW_TO_BUILD_PRODUCTION_READY_AI_FEATURES_WITH_FLUTTER_HANDBOOK_FOR_DEVS, // 2026-05-12
    "pdf-to-image-converter", // 2026-05-12
    "how-to-build-optimal-ai-agents-that-actually-work-a-handbook-for-devs", // 2026-05-12
    HOW_TO_DEVELOP_CHROME_EXTENSIONS_USING_PLASMO_HANDBOOK, // 2026-05-12
    "why-your-simple-deploy-turned-into-a-week-of-infrastructure-work",  // 2026-05-12
    ...
    THE_CODEX_HANDBOOK_A_PRACTICAL_GUIDE_TO_OPENAI_S_CODING_PLATFORM, // 2026-05-09
    ...
    "how-to-convert-images-to-pdf-using-javascript", // 2026-05-09
    "the-rise-of-ai-agents-how-software-is-learning-to-act", // 2026-05-09
    SAAS_PAYMENT_FLOW_STRIPE_WEBHOOKS_EMAIL, // 2026-05-09
    "gen-ai-product-experimentation-with-regression-discontinuity-design", // 2026-05-08
    "how-to-build-a-live-options-database-in-python-a-complete-guide", // 2026-05-08
    "how-to-migrate-to-s3-native-state-locking-in-terraform", // 2026-05-08
    HOW_TO_USE_SCONS_TO_BUILD_SOFTWARE_PROJECTS_FULL_HANDBOOK, // 2026-05-08
    "how-to-run-open-source-llms-locally-and-in-the-cloud", // 2026-05-07
    ...
    "ai-paper-review-improving-language-understanding-by-generative-pre-training-gpt-1", // 2026-05-07
    ...
    "the-complete-soc-2-type-ii-implementation-guide-for-engineers", // 2026-05-06
    "mastering-the-javascript-event-loop", // 2026-05-06
    "data-science-insights-why-the-mean-lies-when-handling-messy-retail-data", // 2026-05-06
    "how-to-build-high-ranking-seo-landing-page", // 2026-05-06
    "how-to-query-data-in-dynamodb-using-net", // 2026-05-06
    ...
    "how-i-tested-malaysia-s-open-data-portals-with-plain-english", // 2026-04-24
    ...
    "from-metrics-to-meaning-how-paas-helps-developers-understand-production", // 2026-04-24
    ...
    "how-to-create-a-gpu-optimized-machine-image-with-hashicorp-packer-on-gcp", // 2026-04-23
    "3d-web-development-with-blender-and-three-js", // 2026-04-23
    ...
    "build-automatic-knowledge-graph-php-json-ld", // 2026-04-22
    "understanding-proxies-and-reverse-proxies-your-gateway-to-secure-networking", // 2026-04-22
    "the-evolution-of-nvidia-blackwell-gpu-memory-architecture", // 2026-04-21
    ...
    "how-to-build-microservices-based-rest-apis-for-healthcare-portals", // 2026-04-18
    ...
    "how-to-optimize-your-docker-build-cache", // 2026-03-19
    "build-19-web-dev-projects-using-html-css-javascript", // 2026-03-19
    ...
    "top-ngrok-alternatives-tunneling-tools", // 2026-03-18
    "full-stack-aws-react-lambda-dynamodb-tutorial", // 2026-03-18
    "build-an-ai-powered-research-automation-system-with-n8n-groq-and-academic-apis", // 2026-03-17
    ...
    "self-host-affine-windows", // 2026-03-13
    ...
    "how-to-use-websockets-from-python-to-fastapi", // 2026-03-12
    ...
    "how-to-build-an-autonomous-ai-agent-with-n8n-and-decapod", // 2026-03-12
    "how-to-build-a-serverless-rag-pipeline-on-aws-that-scales-to-zero", // 2026-03-12
    "ci-cd-in-production-with-jenkins", // 2026-03-12
    "how-to-use-flex-in-tailwind-css-and-justify-flex-items", // 2026-03-12
    "learn-how-to-fine-tune-llms-in-12-hours", // 2026-03-12
    "how-to-build-a-spam-email-detector-with-python-and-naive-bayes-classifier", // 2026-03-11
    ...
    "how-to-use-docker-compose-for-production-workloads", // 2026-03-06
    ...
    "understanding-escape-analysis-in-go", // 2026-02-13
    ...
    "build-a-production-ready-pipeline-with-docker-cicd-and-hostinger", // 2026-02-12
    ...
    "how-to-test-react-applications-with-vitest", // 2026-02-11
    "prepare-for-the-kubernetes-administrator-certification-and-pass-2026-update", // 2026-02-11
    "how-to-use-the-factory-pattern-in-python-a-practical-guide", // 2026-02-10
    "how-to-save-multiple-drafts-in-git-a-guide-to-using-stash", // 2026-02-10
    "python-resume-screening-system", // 2026-02-06
    "how-to-dockerize-your-application-and-deploy-it", // 2026-02-06
    ...
    "harvard-cs50-2026-free-computer-science-university-course", // 2026-02-06
    ...
    "how-tcp-turns-round-trip-time-and-jitter-into-packet-loss", // 2026-02-05
    "how-to-debug-react-state-updates-like-a-pro-without-polluting-production", // 2026-02-03
    ...
    "how-to-prioritize-as-a-product-manager", // 2026-01-30
    "how-to-use-the-builder-pattern-in-python-a-practical-guide-for-devs", // 2026-01-29
    "how-does-extended-bluetooth-advertising-work-in-aosp", // 2026-01-28
    "how-the-factory-and-abstract-factory-design-patterns-work-in-flutter", // 2026-01-28
    HOW_TO_BUILD_AN_AI_POWERED_RAG_SEARCH_APPLICATION_WITH_NEXTJS_SUPABASE_AND_OPENAI, // 2026-01-28
    "build-pipeline-parallelism-from-scratch", // 2026-01-28
    "learn-relational-database-design", // 2026-01-28
    "how-to-chat-with-your-pdf-using-retrieval-augmented-generation", // 2026-01-27
    "how-to-use-the-singleton-design-pattern-in-flutter-lazy-eager-and-factory-variations", // 2026-01-24
    ...
    "how-to-work-with-pdf-files-in-python-a-pypdf-guide", // 2026-01-24
    ...
    "unit-testing-in-go-a-beginners-guide", // 2026-01-13
...
const Y2025: SidebarYeargroupTemplate = {
  ...
  children: [
    ...
    "how-to-add-real-time-web-search-to-your-llm-using-tavily", // 2025-11-18
    ...
    "how-to-create-and-style-tables-with-vanilla-javascript", // 2025-10-2
    ...
    "common-pitfalls-to-avoid-when-analyzing-and-modeling-data", // 2025-10-14
    ...
    HOW_TO_BUILD_AN_ADAPTIVE_TIC_TAC_TOE_AI_WITH_REINFORCEMENT_LEARNING_IN_JAVASCRIPT, // 2025-10-08
    "docker-build-tutorial-learn-contexts-architecture-and-performance-optimization-techniques", // 2025-10-08
    BUILD_A_CUSTOM_AI_CHAT_APPLICATION_WITH_NEXTJS, // 2025-10-07
...
const Y2024: SidebarYeargroupTemplate = {
  ...
  children: [
    ...
    "how-to-create-software-architecture-diagrams-using-the-c4-model", // 2024-08-21
    "what-is-css-subgrid", // 2024-08-21
    "how-to-build-good-coding-habits", // 2024-08-21
    ...
    HOW_TO_SECURE_A_NEXTJS_AI_APPLICATION_DEPLOYED_ON_VERCEL, // 2024-08-19
    ...
    "how-to-match-parentheses-in-javascript-without-using-regex", // 2024-08-13
    ...
    "how-to-upgrade-node-and-jest-while-on-react-scripts-v4", // 2024-07-11
    "how-to-use-python-generators", // 2024-07-10
    "how-to-send-http-requests-using-javascript", // 2024-07-11
    ...
    "how-to-use-callback-functions-in-javascript", // 2024-07-04
    ...
    "how-to-change-background-color-with-javascript", // 2024-06-29
    ...
    "how-to-handle-keyerror-exceptions-in-python", // 2024-06-18
    ...
    "how-to-secure-your-django-app", // 2024-05-23
    ...
    "how-to-create-a-react-chatbot", // 2024-05-11
    ...
    "how-to-use-git-submodules", // 2024-05-08
    ...
    "how-to-use-defaultdict-python", // 2024-05-02
...
const Y2023: SidebarYeargroupTemplate = {
  ...
  children: [
    ...
    GITTING_THINGS_DONE_BOOK,  // 2023-01-09
...
const Y2020: SidebarYeargroupTemplate = {
  ...
  children: [
    ...
    "what-is-docker-used-for-a-docker-container-tutorial-for-beginners", // 2020-12-10
...
const Y2018: SidebarYeargroupTemplate = {
  ...
  children: [
    ...
    "how-to-make-responsiveness-super-simple-with-css-variables", // 2018-02-27
  ]
}
...
export const template: SidebarInfoTemplate = {
  ...
  linksMap: new Map([
    [
      ...
      "js-tensorflow", [
        // END: 2024js-tensorflow
        // END: 2025js-tensorflow
        "build-ai-apps-in-the-browser-with-tensorflow-js-and-webgpu", // 2026-05-27
        // END: 2026js-tensorflow
        // END: js-tensorflow
      ]], [
      "js-shopify", [
        "shopify-ajax-cart-drawer", // 2026-07-03
      ...
      "git", [
        ...
        GIT_REBASE_HANDBOOK, // 2023-07-03
        // END: 2023git
        GITTING_THINGS_DONE_BOOK, // 2024-01-09
        "guide-to-git-github-for-beginners-and-experienced-devs", // 2024-04-06
        "git-checkout-remote-branch-how-to-fetch-and-list-remote-branches", // 2024-05-01
        "how-to-use-git-submodules", // 2024-05-08
        "learn-git-in-detail-to-manage-your-code", // 2024-05-08
      ...
      "openai", [
        ...
        "ai-paper-review-chain-of-thought-prompting-elicits-reasoning-in-large-language-models", // 2026-06-16
        "build-a-self-healing-ci-cd-pipeline-with-ai", // 2026-06-15
        "codex-vs-claude-code-which-ai-coding-assistant-to-choose", // 2026-07-02
        "ai-paper-review-self-consistency-improves-chain-of-thought-reasoning-in-language-models", // 2026-07-09
        "build-ai-applications-that-switch-models-automatically", // 2026-07-29
        AI_EVALUATION_ENGINEERING_BUILD_A_PRODUCTION_GRADE_LLM_EVALUATION_PLATFORM_HANDBOOK, // 2026-08-11
        "how-to-scale-llm-inference-for-ai-agents-using-vllm", // 2026-08-18
      ...
      "coen", [
        "why-end-to-end-testing-is-important-for-your-team", // 2017-12-04
        // END: 2017
        "web-servers-explained-by-running-a-microbrewery", // 2018-04-26
        // END: 2018
        "sorting-algorithms-explained-with-examples-in-python-java-and-c", // 2019-12-05
        "search-algorithms-explained-with-examples-in-java-python-and-c", // 2019-12-14
        // END: 2019
