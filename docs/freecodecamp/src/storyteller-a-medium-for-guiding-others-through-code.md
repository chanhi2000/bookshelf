---
lang: en-US
title: "Storyteller: A Medium For Guiding Others Through Code"
description: "Article(s) > Storyteller: A Medium For Guiding Others Through Code"
...
head:
  - - meta:
    - property: og:title
      content: "Article(s) > Storyteller: A Medium For Guiding Others Through Code"
    - property: og:description
      content: "Storyteller: A Medium For Guiding Others Through Code"
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/freecodecamp.org/storyteller-a-medium-for-guiding-others-through-code.html
...
cover: https://cdn.hashnode.com/uploads/covers/5fc16e412cae9c5b190b6cdd/902c2299-ea98-4136-8ee8-36668f0c08ee.png
---
...
<SiteInfo
  name="Storyteller: A Medium For Guiding Others Through Code"
  desc="As a computer science instructor, I have long wished that there was a better way to guide others through my code. When I was first learning to program, I was a big fan of traditional programming books"
  url="https://freecodecamp.org/news/storyteller-a-medium-for-guiding-others-through-code"
  logo="https://cdn.freecodecamp.org/universal/favicons/favicon.ico"
  preview="https://cdn.hashnode.com/uploads/covers/5fc16e412cae9c5b190b6cdd/902c2299-ea98-4136-8ee8-36668f0c08ee.png"/>
...
```component VPCard
{
  "title": "2.10 *JES* Enlarging a Picture",
  "desc": "Storyteller: *JES* Enlarging a Picture",
...
```component VPCard
{
  "title": "8.8 Dynamic variables example",
  "desc": "Storyteller: Dynamic variables example",
  "link": "https://playbackpress.com/books/pybook/chapter/8/8/",
  "logo": "https://playbackpress.com/favicon.ico",
  "background": "rgba(59,76,98,0.2)"
}
```
...
I have created groups of these guided code walk-throughs to help me teach different topics to my students. These are all free and hosted on a website I created called [<VPIcon icon="fas fa-gobe"/>Playback Press](https://playbackpress.com/books). Here are some of the 'books' I have created so far:

```component VPCard
{
  "title": "PlaybackPress",
  "desc": "An Animated Introduction to Programming in C++ by Mark Mahoney",
  "link": "https://playbackpress.com/books/cppbook/",
  "logo": "https://playbackpress.com/favicon.ico",
  "background": "rgba(59,76,98,0.2)"
}
```
...
{
  "title": "PlaybackPress",
  "desc": "An Animated Introduction to Clojure by Mark Mahoney",
  "link": "https://playbackpress.com/books/cljbook/",
  "logo": "https://playbackpress.com/favicon.ico",
  "background": "rgba(59,76,98,0.2)"
}
```
...
{
  "title": "PlaybackPress",
  "desc": "Database Design and SQL for Beginners by Mark Mahoney",
  "link": "https://playbackpress.com/books/sqlbook/",
  "logo": "https://playbackpress.com/favicon.ico",
  "background": "rgba(59,76,98,0.2)"
}
```
...
::: info The Advantages of Code Playbacks:
...
Note: The AI features are available to registered users on [<VPIcon icon="fas fa-globe"/>Playback Press](https://playbackpress.com/books). Registration is free but logging in is required to access the AI tutor. If you want to see what this feels like, try one of the playbacks linked above and ask the AI a question about what you're seeing.
...
```component VPCard
{
  "title": "Storyteller: A Medium For Guiding Others Through Code",
  "desc": "As a computer science instructor, I have long wished that there was a better way to guide others through my code. When I was first learning to program, I was a big fan of traditional programming books",
  "link": "https://chanhi2000.github.io/bookshelf/freecodecamp.org/storyteller-a-medium-for-guiding-others-through-code.html",
  "logo": "https://cdn.freecodecamp.org/universal/favicons/favicon.ico",
