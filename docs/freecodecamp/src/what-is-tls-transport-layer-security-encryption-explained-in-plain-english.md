...
description: "Article(s) > What is TLS? Transport Layer Security Encryption Explained in Plain English"
...
head:
  - - meta:
    - property: og:title
      content: "Article(s) > What is TLS? Transport Layer Security Encryption Explained in Plain English"
    - property: og:description
      content: "What is TLS? Transport Layer Security Encryption Explained in Plain English"
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/freecodecamp.org/what-is-tls-transport-layer-security-encryption-explained-in-plain-english.html
...
cover: https://freecodecamp.org/news/content/images/2020/09/13466286-1BED-4E1F-A3BE-92A971BBF635.jpeg
---
...
<SiteInfo
  name="What is TLS? Transport Layer Security Encryption Explained in Plain English"
  desc="If you want to have a confidential conversation with someone you know, you might meet up in person and find a private place to talk.  But if you want to send data confidentially over the Internet, you might have a few more considerations to cover. TL..."
  url="https://freecodecamp.org/news/what-is-tls-transport-layer-security-encryption-explained-in-plain-english"
  logo="https://cdn.freecodecamp.org/universal/favicons/favicon.ico"
  preview="https://freecodecamp.org/news/content/images/2020/09/13466286-1BED-4E1F-A3BE-92A971BBF635.jpeg"/>
...
The "transport layer" part of TLS simply refers to host-to-host communication, such as how a client and a server interact, in the [<VPIcon icon="fa-brands fa-wikipedia-w"/>Internet protocol suite model](https://en.wikipedia.org/wiki/Internet_protocol_suite).
...
The basic process of a [<VPIcon icon="fa-brands fa-wikipedia-w"/>TLS handshake](https://en.wikipedia.org/wiki/Transport_Layer_Security#TLS_handshake) involves a client, such as your web browser, and a server, such as one hosting a website, establishing some ground rules for communication.
...
![Cartoon of a browser window and server saying hello, by author.](https://freecodecamp.org/news/content/images/2020/09/hello-hello.png)
...
Often, this process moves the exchange from [<VPIcon icon="fa-brands fa-wikipedia-w"/>asymmetric cryptography](https://en.wikipedia.org/wiki/Public-key_cryptography) to [<VPIcon icon="fa-brands fa-wikipedia-w"/>symmetric cryptography](https://en.wikipedia.org/wiki/Symmetric-key_algorithm) with varying levels of complexity. Let's explore these concepts at a general level and see why they matter to TLS.
...
![Small egg, big egg.](https://freecodecamp.org/news/content/images/2020/09/image.jpeg)
...
Digital certificates are provided and verified by trusted third parties known as [<VPIcon icon="fa-brands fa-wikipedia-w"/>Certificate Authorities (CA)](https://en.wikipedia.org/wiki/Certificate_authority), which are a whole other article in themselves.
...
![Wise person say: share your public key, but keep your shared keys private.](https://freecodecamp.org/news/content/images/2020/09/image-11.png)
...
The integrity of exchanged information is maintained by using a checksum. Messages exchanged using session keys have a [<VPIcon icon="fa-brands fa-wikipedia-w"/>message authentication code (MAC)](https://en.wikipedia.org/wiki/Message_authentication_code) attached. This is not the same thing as your device's [<VPIcon icon="fa-brands fa-wikipedia-w"/>MAC address](https://en.wikipedia.org/wiki/MAC_address). The MAC is generated and verified using the session key.
...
This is just a surface-level skim of the very complex cryptographic systems that help to keep your communications secure. For more depth on the topic, I recommend exploring cipher suites and the various [<VPIcon icon="fa-brands fa-wikipedia-w"/>supported algorithms](https://en.wikipedia.org/wiki/Cipher_suite#Supported_algorithms).
...
The [<VPIcon icon="fa-brands fa-wikipedia-w"/>HTTPS communication protocol](https://en.wikipedia.org/wiki/HTTPS) is encrypted using TLS. Every time you see that little lock icon in your URL bar, you're experiencing firsthand all the concepts you've just read about in this article.
...
```component VPCard
{
  "title": "What is TLS? Transport Layer Security Encryption Explained in Plain English",
  "desc": "If you want to have a confidential conversation with someone you know, you might meet up in person and find a private place to talk.  But if you want to send data confidentially over the Internet, you might have a few more considerations to cover. TL...",
  "link": "https://chanhi2000.github.io/bookshelf/freecodecamp.org/what-is-tls-transport-layer-security-encryption-explained-in-plain-english.html",
  "logo": "https://cdn.freecodecamp.org/universal/favicons/favicon.ico",
