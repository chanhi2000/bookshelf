...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/freecodecamp.org/how-to-become-an-open-source-maintainer.html
...
<SiteInfo
  ...
  desc="By BekahHW You might be wondering why you would want to become an open source maintainer.  Well, I can tell you from my own experience that you'll learn a lot, grow your network, and meet and collaborate with people you wouldn’t have the opportunity ..."
  url="https://freecodecamp.org/news/how-to-become-an-open-source-maintainer"
  logo="https://cdn.freecodecamp.org/universal/favicons/favicon.ico"
  preview="https://freecodecamp.org/news/content/images/2024/05/fcc_maintain.png"/>
...
It also helps you to get a deeper understanding of the open source ecosystem – which is increasingly important, as 90% of companies use open source according to the [<VPIcon icon="iconfont icon-github"/>2022 Octoverse report](https://octoverse.github.com/2022/).

You can see why others enjoy being a maintainer by checking out [this post from GitHub education (<VPIcon icon="fa-brands fa-x-twitter"/>`github`)](https://x.com/github/status/1788632936247611690).
...
An open source license gives legal permissions for others to use, distribute, and contribute to your project. [There are many different types of licenses](https://freecodecamp.org/news/permissive-and-protective-software-licenses/), and choosing the right one depends on your needs. The MIT license is a popular one on GitHub.
...
As an example, here's [freeCodeCamp's code of conduct](https://freecodecamp.org/news/code-of-conduct/).
...
If you're ready to take the next step and want a comprehensive course to help you navigate the journey, check out [<VPIcon icon="fas fa-globe"/>OpenSauced’s Introduction to Maintainer Course](https://oss.fyi/maintainer-course). This course will provide you with an in-depth understanding of what it means to be a maintainer, provide you with guides to make the experience good for you and your contributors, and walk you through how to get started today.
...
```component VPCard
{
  "title": "How to Become an Open Source Project Maintainer",
  "desc": "By BekahHW You might be wondering why you would want to become an open source maintainer.  Well, I can tell you from my own experience that you'll learn a lot, grow your network, and meet and collaborate with people you wouldn’t have the opportunity ...",
  "link": "https://chanhi2000.github.io/bookshelf/freecodecamp.org/how-to-become-an-open-source-maintainer.html",
  "logo": "https://cdn.freecodecamp.org/universal/favicons/favicon.ico",
