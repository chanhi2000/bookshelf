...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/fcc/generative-ai-handbook.html
...
Tools like DALL-E 2 and Midjourney allow artists to generate unique images from textual descriptions, while platforms like Riffusion create music based on user inputs ([<VPIcon icon="iconfont icon-arxiv"/>Vaswani et al., 2017](https://arxiv.org/abs/1706.03762); [<VPIcon icon="iconfont icon-arxiv"/>Goodfellow et al., 2014](https://arxiv.org/abs/1406.2661)). Soon we will have models that are able to create videos out of your text prompts.
...
Also, the regulatory landscape must evolve to address the unique challenges posed by GenAI, including intellectual property rights and data privacy ([<VPIcon icon="fas fa-globe"/>Cockburn et al., 2018](https://nber.org/papers/w24449)).
...
```component VPCard
{
  ...
  "link": "https://chanhi2000.github.io/bookshelf/fcc/generative-ai-handbook.html",
  "logo": "https://cdn.freecodecamp.org/universal/favicons/favicon.ico",
