...
- **RNN (Recurrent Neural Networks) and LSTM (Long Short Term Memory)**: Primarily used for sequential data - text and time series data. In 2017, they were surpassed by a neural network architecture called transformers in a paper called [<VPIcon icon="fas fa-globe"/>Attention is All You Need.](https://arxiv.org/abs/1706.03762)
