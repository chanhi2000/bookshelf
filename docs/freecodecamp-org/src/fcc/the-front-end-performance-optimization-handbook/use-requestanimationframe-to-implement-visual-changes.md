...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/fcc/the-front-end-performance-optimization-handbook/use-requestanimationframe-to-implement-visual-changes.html
date: 2025-05-07
isOriginal: false
author:
  - name: Gordan Tan
