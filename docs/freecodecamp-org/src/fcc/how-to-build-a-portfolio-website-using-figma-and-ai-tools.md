...
head:
  - - meta:
    - property: og:title
      content: "Article(s) > How to Build a Portfolio Website Using Figma and AI Tools – A Guide for Developers"
    - property: og:description
      content: "How to Build a Portfolio Website Using Figma and AI Tools – A Guide for Developers"
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/freecodecamp.org/how-to-build-a-portfolio-website-using-figma-and-ai-tools.html
...
cover: https://cdn.hashnode.com/res/hashnode/image/upload/v1763156337448/4d944077-b800-4bfd-bb70-645777eb00a2.png
---
...
<SiteInfo
  name="How to Build a Portfolio Website Using Figma and AI Tools – A Guide for Developers"
  desc="Ever since my article on How to Become a Full Stack Developer and Get a Job in 2025 went viral, I’ve received countless DMs, emails, and even WhatsApp messages from readers. People have been asking about everything from learning to code and mastering..."
  url="https://freecodecamp.org/news/how-to-build-a-portfolio-website-using-figma-and-ai-tools"
  logo="https://cdn.freecodecamp.org/universal/favicons/favicon.ico"
  preview="https://cdn.hashnode.com/res/hashnode/image/upload/v1763156337448/4d944077-b800-4bfd-bb70-645777eb00a2.png"/>

Ever since my article on [**How to Become a Full Stack Developer and Get a Job in 2025**](/freecodecamp.org/become-a-full-stack-developer-and-get-a-job/README.md) went viral, I’ve received countless DMs, emails, and even WhatsApp messages from readers. People have been asking about everything from learning to code and mastering system design to web design and how AI fits into modern development.
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1763135985349/8cb05eb4-7562-4845-992e-9829ebadf6a4.png)
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1762753167965/584a137e-6414-4ce6-ad1e-0408d040003f.png)
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1763135295720/87dfa444-1e80-45b2-8e57-7f88971a4742.png)
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1763135361258/41a8fdfe-d384-4039-8ab1-1a2499e58363.png)
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1763135522546/1ef82103-13b6-4e9e-b102-b1c8cc20d03f.png)
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1763134948092/1f98417c-5120-48ac-b302-84d5234a7b95.png)
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1763138419092/978156ba-dbb3-4a6e-bcb8-3a0c7ff66e0d.png)
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1763127453427/38bbbdef-270c-4157-8a2d-8fd8591426ea.png)
...
- [<VPIcon icon="fas fa-globe"/>V0](https://v0.dev) is A Vercel project focused on fast UI generation, integrated with Next.js workflows.
- [<VPIcon icon="fas fa-globe"/>Builder.io](https://Builder.io) is visual CMS with Figma integration and a visual editor that can export components for web apps.
- [<VPIcon icon="fas fa-globe"/>Kombai](https://kombai.com) is an IDE extension that converts selected Figma frames into React/NextJS/React Native code and offers repo-aware features.
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1761314891808/1e28092b-9011-476d-869d-08ce6b675766.png)

Now, at the agent panel, click on the “Let’s get started” button and sign up or log in with your credentials.

![](https://cdn.hashnode.com/res/hashnode/image/upload/v1762085091479/abb9f832-b66a-42f5-990c-0a070dc33fd9.png)
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1762935992593/08f6443d-4a62-42fc-8294-0c8f8000bef0.png)
...
![](https://cdn.hashnode.com/res/hashnode/image/upload/v1761456000444/a34b5abe-cb75-4634-b090-a53d1f4df026.png)

And here are the results:

![](https://cdn.hashnode.com/res/hashnode/image/upload/v1763136179145/eb51a1ca-7d63-4a16-ba80-80854d715066.png)

Now you have the full picture of both approaches and when to use each one.

Here is the live Project link - [<VPIcon icon="fas fa-globe"/>FCC FIGMA TO CODE](https://fcc-demo.netlify.app/)

Here is the GitHub link for the project code - [Github Code (<VPIcon icon="iconfont icon-github"/>`prankurpandeyy/fcc-demo-portfolio)`)](https://github.com/prankurpandeyy/fcc-demo-portfolio)
...
This matters because most visitors leave if a site takes more than 3 seconds to load. Tools like [<VPIcon icon="fas fa-globe"/>GTmetrix](https://gtmetrix.com) or Pingdom can help you track and improve page load speed by optimising images and reducing unnecessary scripts.
...
These metrics directly affect how users perceive your site and also impact SEO ranking. You can test them on [<VPIcon icon="fas fa-globe"/>PageSpeed Insights](https://pagespeed.web.dev)
.
...
::: tip Example email/direct message:
...
::: details 1. Is building a portfolio really important
...
::: details 2. Is it worth buying a domain name
...
::: details 3. Can I use AI or no-code tools to build my portfolio

You can, but if you’re a developer, you should try coding it yourself first. It’s a great way to showcase your creativity and technical control over design and logic. Here’s a [**simple and straightforward guide**](/freecodecamp.org/build-a-simple-portfolio-website-with-html-and-css.md) to help you get started with that.
...
::: details 4. How can I get AI tools for testing
...
::: details 5. I am just starting. What should I use: AI tools or the Manual Method
...
::: details 6. Which Platform should I use for hosting
...
- Follow me on **𝕏**: [Prankur's (<VPIcon icon="fa-brands fa-x-twitter"/>`prankurpandeyy`)](https://x.com/prankurpandeyy) **𝕏**
- Connect with me on LinkedIn: [Prankur's LinkedIn (<VPIcon icon="fa-brands fa-linkdedin"/>`prankurpandeyy`)](https://linkedin.com/in/prankurpandeyy)
- Follow me on GitHub: [Prankur’s GitHub (<VPIcon icon="iconfont icon-github"/>`prankurpandeyy`)](https://github.com/prankurpandeyy)
- View my Portfolio: [<VPIcon icon="fas fa-globe"/>Prankur's Portfolio](https://prankurpandeyy.is-a.dev/)
...
```component VPCard
{
  "title": "How to Build a Portfolio Website Using Figma and AI Tools – A Guide for Developers",
  "desc": "Ever since my article on How to Become a Full Stack Developer and Get a Job in 2025 went viral, I’ve received countless DMs, emails, and even WhatsApp messages from readers. People have been asking about everything from learning to code and mastering...",
  "link": "https://chanhi2000.github.io/bookshelf/freecodecamp.org/how-to-build-a-portfolio-website-using-figma-and-ai-tools.html",
  "logo": "https://cdn.freecodecamp.org/universal/favicons/favicon.ico",
