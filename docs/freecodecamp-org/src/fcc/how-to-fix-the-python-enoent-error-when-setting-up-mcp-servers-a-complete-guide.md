...
Replace <VPIcon icon="fas fa-folder-open"/>`/Users/yourusername/path/to/mcp-server/` with your actual path. You can get your precise path by running `pwd` in your MCP server directory.
