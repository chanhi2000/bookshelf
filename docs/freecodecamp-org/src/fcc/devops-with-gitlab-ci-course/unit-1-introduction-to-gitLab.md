...
head: 
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/fcc/devops-with-gitlab-ci-course/unit-1-introduction-to-gitLab.html
date: 2022-03-02
isOriginal: false
...
- [<VPIcon icon="fa-brands fa-youtube"/>Git for GitLab (Beginner's FULL COURSE)](https://youtu.be/4lxvVj7wlZw)
