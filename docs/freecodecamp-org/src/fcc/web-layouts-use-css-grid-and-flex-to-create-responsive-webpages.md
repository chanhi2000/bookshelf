...
head:
  - - meta:
    ...
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/fcc/web-layouts-use-css-grid-and-flex-to-create-responsive-webpages.html
...
::: info What We're Going To Build

![landing page design](https://freecodecamp.org/news/content/images/2022/10/homepage-2.png)

Check it out on Codepen [here (<VPIcon icon="fa-brands fa-codepen"/>`ophyboamah`)](https://codepen.io/ophyboamah/pen/KKRLoJr).
...
2. Within your project folder, create <VPIcon icon="fa-brands fa-html5"/>`index.html` and <VPIcon icon="fa-brands fa-css3-alt"/>`style.css` files.
3. Create an asset folder to store images.
4. Within your <VPIcon icon="fa-brands fa-html5"/>`index.html` file, create your HTML boilerplate and link your CSS file and font URL within the `<head>` tag.
...
![`flex-direction: row`](https://freecodecamp.org/news/content/images/2022/10/flexdirection.png)
...
![`flex-direction: column`](https://freecodecamp.org/news/content/images/2022/10/flexdirectioncolumn.png)
...
![Navbar content output](https://freecodecamp.org/news/content/images/2022/10/preflexx-1.png)
...
![Flex without alignment](https://freecodecamp.org/news/content/images/2022/10/displayflex.png)
...
![](https://freecodecamp.org/news/content/images/2022/10/align-items-1.png)
...
![Flex with center alignment](https://freecodecamp.org/news/content/images/2022/10/aligncenter.png)
...
![justify-content styles](https://freecodecamp.org/news/content/images/2022/10/justifycontentstyles.png)
...
![`justify-content` navbar output](https://freecodecamp.org/news/content/images/2022/10/justifycontent-2.png)
...
![Navbar with styles](https://freecodecamp.org/news/content/images/2022/10/justifyandstyles-1.png)
...
![](https://freecodecamp.org/news/content/images/2022/10/CSS-Grid.png)
...
![`display: grid`](https://freecodecamp.org/news/content/images/2022/10/displaygrid.png)
...
![Landing page final look](https://freecodecamp.org/news/content/images/2022/10/homepage-4.png)
...
::: info Full Project Code

This is the project we’ve built together in this article:

![](https://freecodecamp.org/news/content/images/2022/10/homepage-3.png)
...
```component VPCard
{
  "title": "Web Layouts - How to Use CSS Grid and Flex to Create a Responsive Web Page",
  "desc": "Your web layout is to your website what a floor plan is to a building. Without them, you’re just building castles in the air.  The first thing to do when you have a website or application to build or design is to decide on the layout. This is importa...",
  "link": "https://chanhi2000.github.io/bookshelf/fcc/web-layouts-use-css-grid-and-flex-to-create-responsive-webpages.html",
  "logo": "https://cdn.freecodecamp.org/universal/favicons/favicon.ico",
