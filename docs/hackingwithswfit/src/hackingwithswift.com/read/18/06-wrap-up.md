...
2. In project 1, add a call to `assert()` in the `viewDidLoad()` method of <VPIcon icon="fa-brands fa-swift"/>`DetailViewController.swift`, checking that `selectedImage` always has a value.
