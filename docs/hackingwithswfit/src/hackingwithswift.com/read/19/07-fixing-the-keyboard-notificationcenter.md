...
If you don't see a keyboard when you tap to edit, it probably means you have the Connect Hardware Keyboard setting turned on. Press <kbd>Shift</kbd>+<kbd>⌘</kbd>+<kbd>K</kbd> to disable the hardware keyboard and use the on-screen one.
