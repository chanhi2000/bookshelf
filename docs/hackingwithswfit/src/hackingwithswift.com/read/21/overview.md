...
description: "Article(s) > Project 21: Local Notifications"
category:
  - Swift
  - iOS
  - Article(s)
...
head:
  - - meta:
    - property: og:title
      content: "Article(s) > Project 21: Local Notifications"
    - property: og:description
      content: "Project 21: Local Notifications"
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/hackingwithswift.com/read/21/overview.html
prev: /hackingwithswift.com/read/20/04-wrap-up.md
isOriginal: false
---
...
```component VPCard
{
  ...
  "link": "https://hackingwithswift.com/read/21/overview", 
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(174,10,10,0.2)"
}
```
...
```component VPCard
{
  ...
  "desc": "Setting up",
  "link": "/hackingwithswift.com/read/21/01-setting-up.md",
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(174,10,10,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/hackingwithswift.com/read/21/02-scheduling-notifications-unusernotificationcenter-and-unnotificationrequest.md",
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(174,10,10,0.2)"
}
```
...
```component VPCard
{
  ...
  "link": "/hackingwithswift.com/read/21/03-acting-on-responses.md",
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(174,10,10,0.2)"
}
```
...
```component VPCard
{
  ...
  "desc": "Wrap up",
  "link": "/hackingwithswift.com/read/21/04-wrap-up.md",
  "logo": "https://hackingwithswift.com/favicon.svg",
  "background": "rgba(174,10,10,0.2)"
}
```
