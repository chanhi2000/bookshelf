...
If you haven't already downloaded the files for this project, please do so now from [GitHub (<VPIcon icon="iconfont icon-github"/>`twostraws/HackingWithSwift`)](https://github.com/twostraws/HackingWithSwift), then copy the mouse picture into your project.
