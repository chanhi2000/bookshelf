...
head:
  - - meta:
    ...
    - property: og:description
      content: "Setting up"
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/hackingwithswift.com/read/23/01-setting-up.html
isOriginal: false
---
...
You should also download the files for this project from [GitHub (<VPIcon icon="iconfont icon-github"/>`twostraws/HackingWithSwift`)](https://github.com/twostraws/HackingWithSwift), then copy its Content folder into your Xcode project.
