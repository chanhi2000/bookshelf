...
The easiest thing to do is copy that to a clipboard, open a Finder window, press <kbd>Shift</kbd>+<kbd>⌘</kbd>+<kbd>G</kbd>, and paste it into the box. Now delete the "file:/" from the start so that it reads "/Users/yourusername/.....", and "whistle.m4a" from the end, then press Return.
