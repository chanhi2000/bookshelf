---
lang: ko-KR
title: How to run tasks using SwiftUI’s task() modifier
description: Article(s) > How to run tasks using SwiftUI’s task() modifier
category:
  - Swift
  - Article(s)
tag: 
...
head:
  - - meta:
    - property: og:title
      content: Article(s) > How to run tasks using SwiftUI’s task() modifier
...
> [<VPIcon icon="fas fa-file-zipper"/>Download this as an Xcode project](https://hackingwithswift.com/files/projects/concurrency/how-to-run-tasks-using-swiftuis-task-modifier-1.zip)
...
> [<VPIcon icon="fas fa-file-zipper"/>Download this as an Xcode project](https://hackingwithswift.com/files/projects/concurrency/how-to-run-tasks-using-swiftuis-task-modifier-2.zip)
...
> [<VPIcon icon="fas fa-file-zipper"/>Download this as an Xcode project](https://hackingwithswift.com/files/projects/concurrency/how-to-run-tasks-using-swiftuis-task-modifier-3.zip)
