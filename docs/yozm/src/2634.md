...
![<출처: 리액트와 열쇠 이미지, [<VPIcon icon="fas fa-globe"/>maan-icons](https://flaticon.com/kr/authors/maan-icons)>](https://yozm.wishket.com/media/news/2634/%E1%84%89%E1%85%A1%E1%84%8C%E1%85%B5%E1%86%AB_1.png)
...
![<출처: [<VPIcon icon="fa-brands fa-react"/>react.dev](https://react.dev/learn/rendering-lists)>](https://yozm.wishket.com/media/news/2634/%E1%84%89%E1%85%A1%E1%84%8C%E1%85%B5%E1%86%AB_4.png)
...
가상 돔 객체는 트리 구조를 가지고 있습니다. 위에서 본 FiberNode가 해당 트리의 개별 노드입니다. 리액트 공식 문서에 따르면 두 개 트리를 비교할 때, [<VPIcon icon="fas fa-file-pdf"/>최첨단 알고리즘](https://grfia.dlsi.ua.es/ml/algorithms/references/editsurvey_bille.pdf)을 사용하더라도 n개의 엘리먼트에 대해 $\text{O}\left(n^3\right)$의 복잡도를 가진다고 합니다. 1000개의 엘리먼트를 그리기 위해서는 10억 번의 비교 연산을 진행해야 한다는 뜻이죠. 이는 굉장히 비싼 연산입니다. 따라서 다른 해결법이 필요했고, 리액트는 두 가지 가정을 도입합니다.
