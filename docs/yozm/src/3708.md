...
리플렉션은 다양한 이름으로 불리는 중요한 보편적 패턴입니다. 앤트로픽은 “[<VPIcon icon="iconfont icon-claude"/>Building Effective Agents”](https://anthropic.com/engineering/building-effective-agents)에서 이 패턴을 Evaluator-optimizer라고 부릅니다.
