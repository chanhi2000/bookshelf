...
![.<VPIcon icon="iconfont icon-select"/>`[Extensions]` 탭에서 `Google Java Format for VS Code`를 검색하여 설치해 줍니다.](https://yozm.wishket.com/media/news/2499/vscode-extension.png)
