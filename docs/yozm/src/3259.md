...
[^1]: ***컨텍스트 윈도우**: 언어 모델이 새로운 텍스트를 생성할 때 참조할 수 있는 전체 텍스트의 양과 생성하는 새로운 텍스트를 합친 것 <출처: [<VPIcon icon="iconfont icon-claude"/>앤트로픽](https://docs.anthropic.com/ko/docs/build-with-claude/context-windows)>
