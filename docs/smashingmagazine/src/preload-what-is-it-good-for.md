...
description: "Article(s) > Preload: What Is It Good For?"
...
head:
  - - meta:
    - property: og:title
      content: "Article(s) > Preload: What Is It Good For?"
    - property: og:description
      content: "Preload: What Is It Good For?"
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/smashingmagazine.com/preload-what-is-it-good-for.html
...
<SiteInfo
  name="Preload: What Is It Good For?"
  ...
  url="https://smashingmagazine.com/2016/02/preload-what-is-it-good-for/"
  logo="https://smashingmagazine.com/images/favicon/favicon.svg"
  preview="https://archive.smashing.media/assets/344dbf88-fdf9-42bb-adb4-46f01eedd629/7e836a24-66de-43df-af76-1dd15773359f/skeleton-500px-opt.png"/>

What is that preload? What does it do? And how can it help you? Preload gives developers the ability to define custom loading logic without suffering the performance penalty that script-based resource loaders incur. In human terms, it’s a way to tell a browser to start fetching a certain resource, because you as authors know that the browser is going to need that particular resource pretty soon.

**Preload** ([<VPIcon icon="fas fa-globe"/>spec](https://w3c.github.io/preload/)) is a new web standard aimed at improving performance and providing more granular loading control to web developers. It gives developers the ability to **define custom loading** logic without suffering the performance penalty that script-based resource loaders incur.

A few weeks ago, I [<VPIcon icon="fa-brands fa-google"/>shipped](https://groups.google.com/a/chromium.org/d/msg/blink-dev/_nu6HlbNQfo/XzaLNb1bBgAJ) preload support in Chrome Canary, and barring unexpected bugs it will hit Chrome stable in mid-April. But what is that preload thing? What does it do? And how can it help you?
...
- The browser can make sure that the request is subject to the right [<VPIcon icon="fas fa-globe"/>Content-Security-Policy](https://html5rocks.com/en/tutorials/security/content-security-policy/) directives, and doesn’t go out to the server if it shouldn’t.
...
(See the [<VPIcon icon="fas fa-globe"/>fetch spec](https://fetch.spec.whatwg.org/#concept-request-destination) for the full list.)
...
One more feature that comes along free with link tags is that they can be [<VPIcon icon="fas fa-globe"/>represented as HTTP headers](https://tools.ietf.org/html/rfc5988). That means that for most markup examples I showed above, you can have an HTTP response header that does exactly the same thing. (The only exception is the `onload`-related example. You cannot define an onload handler as part of an HTTP header.)
...
HTTP headers can come in handy when the person doing the optimization is not the same person who’s responsible for editing the markup. The prominent example is an **external optimization engine** that scans the content and optimizes it (full disclosure: [I work on one](https://akamai.com/us/en/resources/front-end-optimization-feo.jsp)).
...
<!-- [view raw](https://gist.github.com/yoavweiss/b1f798bb2be4e671107b/raw/d3b5df5af917c51babb1f59a4a2aadada127ece8/preload_feature_detection.js) [preload_feature_detection.js](https://gist.github.com/yoavweiss/b1f798bb2be4e671107b#file-preload_feature_detection-js) hosted with ❤ by [GitHub](https://github.com) -->
...
- [**Perceived Performance**](/smashingmagazine.com/why-performance-matters-the-perception-of-time.md)
- [**Getting Ready For HTTP/2**](/smashingmagazine.com/getting-ready-for-http2.md)
- [**Everything You Need To Know About AMP**](/smashingmagazine.com/everything-about-google-accelerated-mobile-pages.md)
- [**Progressive Enhancement**](/smashingmagazine.com/reimagining-single-page-applications-progressive-enhancement.md)
...
```component VPCard
{
  "title": "Preload: What Is It Good For?",
  "desc": "What is that preload? What does it do? And how can it help you? Preload gives developers the ability to define custom loading logic without suffering the performance penalty that script-based resource loaders incur. In human terms, it’s a way to tell a browser to start fetching a certain resource, because you as authors know that the browser is going to need that particular resource pretty soon.",
  "link": "https://chanhi2000.github.io/bookshelf/smashingmagazine.com/preload-what-is-it-good-for.html",
  "logo": "https://smashingmagazine.com/images/favicon/favicon.svg",
