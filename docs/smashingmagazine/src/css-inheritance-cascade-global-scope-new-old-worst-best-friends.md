...
description: "Article(s) > CSS Inheritance, The Cascade And Global Scope: Your New Old Worst Best Friends"
...
head:
  - - meta:
    - property: og:title
      content: "Article(s) > CSS Inheritance, The Cascade And Global Scope: Your New Old Worst Best Friends"
    - property: og:description
      content: "CSS Inheritance, The Cascade And Global Scope: Your New Old Worst Best Friends"
    - property: og:url
      content: https://chanhi2000.github.io/bookshelf/smashingmagazine.com/css-inheritance-cascade-global-scope-new-old-worst-best-friends.html
...
<SiteInfo
  name="CSS Inheritance, The Cascade And Global Scope: Your New Old Worst Best Friends"
  ...
  url="https://smashingmagazine.com/2016/11/css-inheritance-cascade-global-scope-new-old-worst-best-friends/"
  logo="https://smashingmagazine.com/images/favicon/favicon.svg"
  preview="https://archive.smashing.media/assets/344dbf88-fdf9-42bb-adb4-46f01eedd629/b468a3c3-2ca4-4eae-abc0-3e89ab57e204/rainbow-slinky-opt.png"/>

If you don’t want your design to look like it’s made out of unrelated things, this article is for you. There is already a technology, called CSS, which is designed specifically to solve this problem. Using CSS, you can propagate styles that cross the borders of your HTML components, ensuring a consistent design with minimal effort. Today, Heydon Pickering is going to revisit inheritance, the cascade and scope here with respect to modular interface design. He aims to show you how to leverage these features so that your CSS code becomes more concise and self-regulating, and your interface more easily extensible.

I’m big on [**modular design**](/smashingmagazine.com/designing-modular-ui-systems-via-style-guide-driven-development.md). I’ve long been sold on dividing websites into components, not pages, and amalgamating those components dynamically into interfaces. Flexibility, efficiency and maintainability abound.
...
To put it another way, the style of “atoms” that make up your interface “molecules” (to use [**atomic design**](/smashingmagazine.com/atomic-design-workflow.md) terminology) should be largely addressable using element selectors. Element selectors are low in [**specificity**](/smashingmagazine.com/css-specificity-things-you-should-know.md), so they won’t override any class-based styles you might incorporate later.
...
For example, the `input` element takes a `type` attribute, should you want to take advantage of it, and also [**attributes such as `aria-invalid`**](/smashingmagazine.com/the-wai-forward.md#aria-invalid) to describe state.
...
The use of the extremely low-specificity [<VPIcon icon="fas fa-globe"/>lobotomized owl selector](https://alistapart.com/article/axiomatic-css-and-lobotomized-owls) ensures that *any* elements (except the common exceptions) are spaced by one line. This means that there is default white space in all cases, and developers writing component flow content will have a reasonable starting point.
...
Achieving the same result with a methodology such as [<VPIcon icon="fas fa-globe"/>atomic CSS](https://acss.io/) would mean composing specific margin-related classes and applying them manually in each case, including for `first-child` exceptions handled implicitly by `* + *`:
...
[**CSS modules**](/css-tricks.com/css-modules-part-1-need.md) were recently conceived to remedy this scenario by programmatically generating unique class names tied to their local or component scope.
...
My tiny (93B minified) [flexbox-based grid system (<VPIcon icon="iconfont icon-github"/>`Heydon/fukol-grids`)](https://github.com/Heydon/fukol-grids) is essentially just a utility class like this one. It’s highly reusable, and because it employs `flex-basis`, no breakpoint intervention is needed. I just defer to flexbox’s wrapping algorithm.
...
![Fukol's distinctive logotype](https://archive.smashing.media/assets/344dbf88-fdf9-42bb-adb4-46f01eedd629/00e4c130-b5d5-450d-a718-a62647bee69b/logo-fukol.png)  
...
- [**Recovering Deleted Files From Your Git Working Tree**](/smashingmagazine.com/recovering-deleted-files-git-working-tree.md)
- [**How Marketing Changed OOP In JavaScript**](/smashingmagazine.com/marketing-changed-oop-javascript.md)
- [**A Few Ways CSS Is Easier To Write In 2023**](/smashingmagazine.com/few-ways-css-easier-write-2023.md)
- [**WordPress Playground: From 5-Minute Install To Instant Spin-Up**](/smashingmagazine.com/wordpress-playground-5-minute-install-instant-spin-up.md)
...
```component VPCard
{
  "title": "CSS Inheritance, The Cascade And Global Scope: Your New Old Worst Best Friends",
  "desc": "If you don’t want your design to look like it’s made out of unrelated things, this article is for you. There is already a technology, called CSS, which is designed specifically to solve this problem. Using CSS, you can propagate styles that cross the borders of your HTML components, ensuring a consistent design with minimal effort. Today, Heydon Pickering is going to revisit inheritance, the cascade and scope here with respect to modular interface design. He aims to show you how to leverage these features so that your CSS code becomes more concise and self-regulating, and your interface more easily extensible.",
  "link": "https://chanhi2000.github.io/bookshelf/smashingmagazine.com/css-inheritance-cascade-global-scope-new-old-worst-best-friends.html",
  "logo": "https://smashingmagazine.com/images/favicon/favicon.svg",
