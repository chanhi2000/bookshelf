...
That's everything for Interface Builder, so switch back to the standard editor, open <VPIcon icon="fa-brands fa-swift"/>`ActionViewController.swift` and add these two properties to your class:
