...
That's it for code, but make sure you create your layouts consistently - whether you use Auto Layout or not, you need to be careful to [<VPIcon icon="fa-brands fa-apple"/>follow Apple's instructions](https://developer.apple.com/library/ios/technotes/tn2154/_index.html).
