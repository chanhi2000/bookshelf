...
> [<VPIcon icon="fas fa-file-zipper"/>Download this as an Xcode project](https://hackingwithswift.com/files/projects/swiftui/how-to-detect-the-user-hovering-over-a-view-1.zip)
...
> [<VPIcon icon="fas fa-file-zipper"/>Download this as an Xcode project](https://hackingwithswift.com/files/projects/swiftui/how-to-detect-the-user-hovering-over-a-view-2.zip)
...
To try this out on the iPadOS simulator, go to the I/O menu and choose <VPIcon icon="iconfont icon-select"/>`[Input]` > `[Send Cursor to Device]`.
