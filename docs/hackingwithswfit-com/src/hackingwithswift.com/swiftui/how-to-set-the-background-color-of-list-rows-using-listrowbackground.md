...
> [<VPIcon icon="fas fa-file-zipper"/>Download this as an Xcode project](https://hackingwithswift.com/files/projects/swiftui/how-to-set-the-background-color-of-list-rows-using-listrowbackground-1.zip)
