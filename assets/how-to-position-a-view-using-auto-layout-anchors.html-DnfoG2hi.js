import{_ as c}from"./plugin-vue_export-helper-DlAUqK2U.js";import{aj as l,am as t,as as u,ao as a,at as n,au as s,ak as e,aq as h,ar as p}from"./app-DpiNAgkx.js";const w={},d={id:"frontmatter-title-관련",tabindex:"-1"},g={class:"header-anchor",href:"#frontmatter-title-관련"};function m(r,o){const i=h("VPCard");return p(),l("div",null,[t("h1",d,[t("a",g,[t("span",null,u(r.$frontmatter.title)+" 관련",1)])]),a(i,n(s({title:"UIKit - free Swift example code",desc:"Learn Swift coding for iOS with these free tutorials - learn Swift, iOS, and Xcode",link:"/hackingwithswift.com/example-code/uikit/README.md",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),o[0]||(o[0]=t("nav",{class:"table-of-contents"},[t("ul")],-1)),o[1]||(o[1]=t("hr",null,null,-1)),a(i,n(s({title:"How to position a view using Auto Layout anchors | UIKit - free Swift example code",desc:"How to position a view using Auto Layout anchors",link:"https://hackingwithswift.com/example-code/uikit/how-to-position-a-view-using-auto-layout-anchors",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),o[2]||(o[2]=t("blockquote",null,[t("p",null,"Available from iOS 9.0")],-1)),e(" TODO: 작성 "),e(`
