...
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Now, change this file by adding a new line, and also erasing the line before the last one:</p>`,3),Ve=e("img",{src:"https://freecodecamp.org/news/content/images/2023/12/testing_file_modified.png",alt:'Changes to <FontIcon icon="fas fa-file-lines"/>',tabindex:"0",loading:"lazy"},null,-1),Xe=e("code",null,"test.txt",-1),Ze=a(`<p>Observe the difference between the original version of the file and the version including your changes:</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">git</span> <span class="token function">diff</span> -- test.txt</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><figure><img src="https://freecodecamp.org/news/content/images/2023/12/testing_file_diff.png" alt="The output for " tabindex="0" loading="lazy"><figcaption>The output for <code>git diff -- test.txt</code></figcaption></figure>`,3),Ke=e("code",null,"-- test.txt",-1),Qe=e("code",null,"diff",-1),$e=e("code",null,"test.txt",-1),et=a(`<p>Store this diff into a patch file:</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">git</span> <span class="token function">diff</span> -- test.txt <span class="token operator">&gt;</span> new_patch.patch</span>
