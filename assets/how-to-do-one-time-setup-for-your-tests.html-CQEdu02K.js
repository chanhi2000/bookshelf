import{_ as c}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as l,f as t,av as p,au as s,aw as a,ax as i,b as o,r as m,o as h}from"./app-BQ88-Ybo.js";const u={},d={id:"frontmatter-title-관련",tabindex:"-1"},f={class:"header-anchor",href:"#frontmatter-title-관련"};function w(r,e){const n=m("VPCard");return h(),l("div",null,[t("h1",d,[t("a",f,[t("span",null,p(r.$frontmatter.title)+" 관련",1)])]),s(n,a(i({title:"Testing - free Swift example code",desc:"Learn Swift coding for iOS with these free tutorials – learn Swift, iOS, and Xcode",link:"/hackingwithswift.com/example-code/testing/README.md",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),e[0]||(e[0]=t("nav",{class:"table-of-contents"},[t("ul")],-1)),e[1]||(e[1]=t("hr",null,null,-1)),s(n,a(i({title:"How to do one-time setup for your tests | Testing - free Swift example code",desc:"How to do one-time setup for your tests",link:"https://hackingwithswift.com/example-code/testing/how-to-do-one-time-setup-for-your-tests",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),o(" TODO: 작성 "),o(` 
