import{_ as c}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as s,f as t,av as p,au as e,aw as i,ax as l,b as o,r as d,o as w}from"./app-BdFl9trH.js";const m={},h={id:"frontmatter-title-관련",tabindex:"-1"},u={class:"header-anchor",href:"#frontmatter-title-관련"};function g(r,n){const a=d("VPCard");return w(),s("div",null,[t("h1",h,[t("a",u,[t("span",null,p(r.$frontmatter.title)+" 관련",1)])]),e(a,i(l({title:"Location - free Swift example code",desc:"Learn Swift coding for iOS with these free tutorials – learn Swift, iOS, and Xcode",link:"/hackingwithswift.com/example-code/location/README.md",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),n[0]||(n[0]=t("nav",{class:"table-of-contents"},[t("ul")],-1)),n[1]||(n[1]=t("hr",null,null,-1)),e(a,i(l({title:"How to add a button to an MKMapView annotation | Location - free Swift example code",desc:"How to add a button to an MKMapView annotation",link:"https://hackingwithswift.com/example-code/location/how-to-add-a-button-to-an-mkmapview-annotation",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),n[2]||(n[2]=t("blockquote",null,[t("p",null,"Available from iOS 2.0")],-1)),o(" TODO: 작성 "),o(` 
