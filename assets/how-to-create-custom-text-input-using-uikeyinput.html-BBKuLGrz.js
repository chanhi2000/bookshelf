import{_ as c}from"./plugin-vue_export-helper-DlAUqK2U.js";import{aj as u,am as t,as as p,ao as i,at as a,au as s,ak as o,aq as l,ar as d}from"./app-J50hDzMj.js";const h={},m={id:"frontmatter-title-관련",tabindex:"-1"},g={class:"header-anchor",href:"#frontmatter-title-관련"};function w(r,e){const n=l("VPCard");return d(),u("div",null,[t("h1",m,[t("a",g,[t("span",null,p(r.$frontmatter.title)+" 관련",1)])]),i(n,a(s({title:"UIKit - free Swift example code",desc:"Learn Swift coding for iOS with these free tutorials – learn Swift, iOS, and Xcode",link:"/hackingwithswift.com/example-code/uikit/README.md",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),e[0]||(e[0]=t("nav",{class:"table-of-contents"},[t("ul")],-1)),e[1]||(e[1]=t("hr",null,null,-1)),i(n,a(s({title:"How to create custom text input using UIKeyInput | UIKit - free Swift example code",desc:"How to create custom text input using UIKeyInput",link:"https://hackingwithswift.com/example-code/uikit/how-to-create-custom-text-input-using-uikeyinput",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),e[2]||(e[2]=t("blockquote",null,[t("p",null,"Available from iOS 3.2")],-1)),o(" TODO: 작성 "),o(`
