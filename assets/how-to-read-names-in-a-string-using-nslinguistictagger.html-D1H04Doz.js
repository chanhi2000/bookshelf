import{_ as g}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c,f as t,av as l,au as a,aw as o,ax as s,b as n,r as m,o as u}from"./app-D4PYVeBp.js";const p={},h={id:"frontmatter-title-관련",tabindex:"-1"},d={class:"header-anchor",href:"#frontmatter-title-관련"};function w(r,e){const i=m("VPCard");return u(),c("div",null,[t("h1",h,[t("a",d,[t("span",null,l(r.$frontmatter.title)+" 관련",1)])]),a(i,o(s({title:"System - free Swift example code",desc:"Learn Swift coding for iOS with these free tutorials – learn Swift, iOS, and Xcode",link:"/hackingwithswift.com/example-code/system/README.md",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),e[0]||(e[0]=t("nav",{class:"table-of-contents"},[t("ul")],-1)),e[1]||(e[1]=t("hr",null,null,-1)),a(i,o(s({title:"How to read names in a string using NSLinguisticTagger | System - free Swift example code",desc:"How to read names in a string using NSLinguisticTagger",logo:"https://hackingwithswift.com/favicon.svg",link:"https://hackingwithswift.com/example-code/how-to-read-names-in-a-string-using-nslinguistictagger",background:"rgba(174,10,10,0.2)"})),null,16),e[2]||(e[2]=t("blockquote",null,[t("p",null,"Available from iOS 5.0")],-1)),n(" TODO: 작성 "),n(` 
