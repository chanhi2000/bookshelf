import{_ as c}from"./plugin-vue_export-helper-DlAUqK2U.js";import{aj as u,am as t,as as h,ao as a,at as i,au as s,ak as o,aq as l,ar as p}from"./app-BYoUe6Ce.js";const d={},m={id:"frontmatter-title-관련",tabindex:"-1"},f={class:"header-anchor",href:"#frontmatter-title-관련"};function g(r,e){const n=l("VPCard");return p(),u("div",null,[t("h1",m,[t("a",f,[t("span",null,h(r.$frontmatter.title)+" 관련",1)])]),a(n,i(s({title:"System - free Swift example code",desc:"Learn Swift coding for iOS with these free tutorials – learn Swift, iOS, and Xcode",link:"/hackingwithswift.com/example-code/system/README.md",logo:"https://hackingwithswift.com/favicon.svg",background:"rgba(174,10,10,0.2)"})),null,16),e[0]||(e[0]=t("nav",{class:"table-of-contents"},[t("ul")],-1)),e[1]||(e[1]=t("hr",null,null,-1)),a(n,i(s({title:"How to use Touch ID to authenticate users by fingerprint | System - free Swift example code",desc:"How to use Touch ID to authenticate users by fingerprint",logo:"https://hackingwithswift.com/favicon.svg",link:"https://hackingwithswift.com/example-code/how-to-use-touch-id-to-authenticate-users-by-fingerprint",background:"rgba(174,10,10,0.2)"})),null,16),e[2]||(e[2]=t("blockquote",null,[t("p",null,"Available from iOS 8.0")],-1)),o(" TODO: 작성 "),o(` 
